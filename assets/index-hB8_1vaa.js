...
void main() {
	...
	if ( coord.x >= 1.0 ) {
		...
		}`},th=class{constructor(){this.isPass=!0,this.enabled=!0,this.needsSwap=!0,this.clear=!1,this.renderToScreen=!1}setSize(){}render(){console.error(`THREE.Pass: .render() must be implemented in derived pass.`)}dispose(){}},nh=new oc(-1,1,1,-1,0,1),rh=new class extends Mr{constructor(){super(),this.setAttribute(`position`,new br([-1,3,0,-1,-1,0,3,-1,0],3)),this.setAttribute(`uv`,new br([0,2,0,0,2,0],2))}},ih=class{constructor(e){this._mesh=new W(rh,e)}dispose(){this._mesh.geometry.dispose()}render(e){e.render(this._mesh,nh)}get material(){return this._mesh.material}set material(e){this._mesh.material=e}},ah=class extends th{constructor(e,t=`tDiffuse`){super(),this.textureID=t,this.uniforms=null,this.material=null,e instanceof os?(this.uniforms=e.uniforms,this.material=e):e&&(this.uniforms=rs.clone(e.uniforms),this.material=new os({name:e.name===void 0?`unspecified`:e.name,defines:Object.assign({},e.defines),uniforms:this.uniforms,vertexShader:e.vertexShader,fragmentShader:e.fragmentShader})),this._fsQuad=new ih(this.material)}render(e,t,n){this.uniforms[this.textureID]&&(this.uniforms[this.textureID].value=n.texture),this._fsQuad.material=this.material,this.renderToScreen?(e.setRenderTarget(null),this._fsQuad.render(e)):(e.setRenderTarget(t),this.clear&&e.clear(e.autoClearColor,e.autoClearDepth,e.autoClearStencil),this._fsQuad.render(e))}dispose(){this.material.dispose(),this._fsQuad.dispose()}},oh=class extends th{constructor(e,t){super(),this.scene=e,this.camera=t,this.clear=!0,this.needsSwap=!1,this.inverse=!1}render(e,t,n){let r=e.getContext(),i=e.state;i.buffers.color.setMask(!1),i.buffers.depth.setMask(!1),i.buffers.color.setLocked(!0),i.buffers.depth.setLocked(!0);let a,o;this.inverse?(a=0,o=1):(a=1,o=0),i.buffers.stencil.setTest(!0),i.buffers.stencil.setOp(r.REPLACE,r.REPLACE,r.REPLACE),i.buffers.stencil.setFunc(r.ALWAYS,a,4294967295),i.buffers.stencil.setClear(o),i.buffers.stencil.setLocked(!0),e.setRenderTarget(n),this.clear&&e.clear(),e.render(this.scene,this.camera),e.setRenderTarget(t),this.clear&&e.clear(),e.render(this.scene,this.camera),i.buffers.color.setLocked(!1),i.buffers.depth.setLocked(!1),i.buffers.color.setMask(!0),i.buffers.depth.setMask(!0),i.buffers.stencil.setLocked(!1),i.buffers.stencil.setFunc(r.EQUAL,1,4294967295),i.buffers.stencil.setOp(r.KEEP,r.KEEP,r.KEEP),i.buffers.stencil.setLocked(!0)}},sh=class extends th{constructor(){super(),this.needsSwap=!1}render(e){e.state.buffers.stencil.setLocked(!1),e.state.buffers.stencil.setTest(!1)}},ch=class{constructor(e,t){if(this.renderer=e,this._pixelRatio=e.getPixelRatio(),t===void 0){let n=e.getSize(new R);this._width=n.width,this._height=n.height,t=new Qt(this._width*this._pixelRatio,this._height*this._pixelRatio,{type:_}),t.texture.name=`EffectComposer.rt1`}else this._width=t.width,this._height=t.height;this.renderTarget1=t,this.renderTarget2=t.clone(),this.renderTarget2.texture.name=`EffectComposer.rt2`,this.writeBuffer=this.renderTarget1,this.readBuffer=this.renderTarget2,this.renderToScreen=!0,this.passes=[],this.copyPass=new ah(eh),this.copyPass.material.blending=0,this.timer=new _c}swapBuffers(){let e=this.readBuffer;this.readBuffer=this.writeBuffer,this.writeBuffer=e}addPass(e){this.passes.push(e),e.setSize(this._width*this._pixelRatio,this._height*this._pixelRatio)}insertPass(e,t){this.passes.splice(t,0,e),e.setSize(this._width*this._pixelRatio,this._height*this._pixelRatio)}removePass(e){let t=this.passes.indexOf(e);t!==-1&&this.passes.splice(t,1)}isLastEnabledPass(e){for(let t=e+1;t<this.passes.length;t++)if(this.passes[t].enabled)return!1;return!0}render(e){this.timer.update(),e===void 0&&(e=this.timer.getDelta());let t=this.renderer.getRenderTarget(),n=!1;for(let t=0,r=this.passes.length;t<r;t++){let r=this.passes[t];if(r.enabled!==!1){if(r.renderToScreen=this.renderToScreen&&this.isLastEnabledPass(t),r.render(this.renderer,this.writeBuffer,this.readBuffer,e,n),r.needsSwap){if(n){let t=this.renderer.getContext(),n=this.renderer.state.buffers.stencil;n.setFunc(t.NOTEQUAL,1,4294967295),this.copyPass.render(this.renderer,this.writeBuffer,this.readBuffer,e),n.setFunc(t.EQUAL,1,4294967295)}this.swapBuffers()}oh!==void 0&&(r instanceof oh?n=!0:r instanceof sh&&(n=!1))}}this.renderer.setRenderTarget(t)}reset(e){if(e===void 0){let t=this.renderer.getSize(new R);this._pixelRatio=this.renderer.getPixelRatio(),this._width=t.width,this._height=t.height,e=this.renderTarget1.clone(),e.setSize(this._width*this._pixelRatio,this._height*this._pixelRatio)}this.renderTarget1.dispose(),this.renderTarget2.dispose(),this.renderTarget1=e,this.renderTarget2=e.clone(),this.writeBuffer=this.renderTarget1,this.readBuffer=this.renderTarget2}setSize(e,t){this._width=e,this._height=t;let n=this._width*this._pixelRatio,r=this._height*this._pixelRatio;this.renderTarget1.setSize(n,r),this.renderTarget2.setSize(n,r);for(let e=0;e<this.passes.length;e++)this.passes[e].setSize(n,r)}setPixelRatio(e){this._pixelRatio=e,this.setSize(this._width,this._height)}dispose(){this.renderTarget1.dispose(),this.renderTarget2.dispose(),this.copyPass.dispose()}},lh=class extends th{constructor(e,t,n=null,r=null,i=null){super(),this.scene=e,this.camera=t,this.overrideMaterial=n,this.clearColor=r,this.clearAlpha=i,this.clear=!0,this.clearDepth=!1,this.needsSwap=!1,this.isRenderPass=!0,this._oldClearColor=new U}render(e,t,n){let r=e.autoClear;e.autoClear=!1;let i,a;this.overrideMaterial!==null&&(a=this.scene.overrideMaterial,this.scene.overrideMaterial=this.overrideMaterial),this.clearColor!==null&&(e.getClearColor(this._oldClearColor),e.setClearColor(this.clearColor,e.getClearAlpha())),this.clearAlpha!==null&&(i=e.getClearAlpha(),e.setClearAlpha(this.clearAlpha)),this.clearDepth==1&&e.clearDepth(),e.setRenderTarget(this.renderToScreen?null:n),this.clear===!0&&e.clear(e.autoClearColor,e.autoClearDepth,e.autoClearStencil),e.render(this.scene,this.camera),this.clearColor!==null&&e.setClearColor(this._oldClearColor),this.clearAlpha!==null&&e.setClearAlpha(i),this.overrideMaterial!==null&&(this.scene.overrideMaterial=a),e.autoClear=r}},uh={name:`LuminosityHighPassShader`,uniforms:{tDiffuse:{value:null},luminosityThreshold:{value:1},smoothWidth:{value:1},defaultColor:{value:new U(0)},defaultOpacity:{value:0}},vertexShader:`
		...
		void main() {
			...
			gl_FragColor = mix( outputColor, texel, alpha );
				...
				}`})}};dh.BlurDirectionX=new R(1,0),dh.BlurDirectionY=new R(0,1);var fh={name:`OutputShader`,uniforms:{tDiffuse:{value:null},toneMappingExposure:{value:1}},vertexShader:`
		precision highp float;
		...
		}`},ph=class extends th{constructor(){super(),this.isOutputPass=!0,this.uniforms=rs.clone(fh.uniforms),this.material=new ss({name:fh.name,uniforms:this.uniforms,vertexShader:fh.vertexShader,fragmentShader:fh.fragmentShader}),this._fsQuad=new ih(this.material),this._outputColorSpace=null,this._toneMapping=null}render(e,t,n){this.uniforms.tDiffuse.value=n.texture,this.uniforms.toneMappingExposure.value=e.toneMappingExposure,(this._outputColorSpace!==e.outputColorSpace||this._toneMapping!==e.toneMapping)&&(this._outputColorSpace=e.outputColorSpace,this._toneMapping=e.toneMapping,this.material.defines={},V.getTransfer(this._outputColorSpace)===`srgb`&&(this.material.defines.SRGB_TRANSFER=``),this._toneMapping===1?this.material.defines.LINEAR_TONE_MAPPING=``:this._toneMapping===2?this.material.defines.REINHARD_TONE_MAPPING=``:this._toneMapping===3?this.material.defines.CINEON_TONE_MAPPING=``:this._toneMapping===4?this.material.defines.ACES_FILMIC_TONE_MAPPING=``:this._toneMapping===6?this.material.defines.AGX_TONE_MAPPING=``:this._toneMapping===7?this.material.defines.NEUTRAL_TONE_MAPPING=``:this._toneMapping===5&&(this.material.defines.CUSTOM_TONE_MAPPING=``),this.material.needsUpdate=!0),this.renderToScreen===!0?(e.setRenderTarget(null),this._fsQuad.render(e)):(e.setRenderTarget(t),this.clear&&e.clear(e.autoClearColor,e.autoClearDepth,e.autoClearStencil),this._fsQuad.render(e))}dispose(){this.material.dispose(),this._fsQuad.dispose()}},mh=null;function hh(){if(!q.bloom.enabled)return!1;mh=new ch(ef),mh.addPass(new lh(tf,af));let e=new dh(new R(innerWidth,innerHeight),q.bloom.strength,q.bloom.radius,q.bloom.threshold);return mh.addPass(e),mh.addPass(new ph),ef.info.autoReset=!1,!0}function gh(){mh?(ef.info.reset(),mh.render()):ef.render(tf,af)}function _h(e,t){mh&&mh.setSize(e,t)}var Z=new kn,vh=new kn;vh.position.y=.3,Z.add(vh);var yh=2829660,bh=5975171,xh=lf(yh),Sh=lf(8015659),Ch=lf(14264440),wh=new W(new Oa(.34,.4,.85,10),xh);wh.position.y=.55;var Th=new W(new Zo(.36,.06,8,18),lf(14701885));Th.rotation.x=Math.PI/2,Th.position.y=.42;var Eh=new W(new Xo(.34,16,12),Sh);Eh.position.y=1.32;var Dh=new W(new Xo(.36,16,12,0,Math.PI*2,0,Math.PI*.62),xh);Dh.position.y=1.33;var Oh=new W(new Xo(.24,12,10),Ch);Oh.scale.set(1,.85,.6),Oh.position.set(0,1.26,.22);var kh=new W(new Xo(.14,10,8),Ch);kh.position.set(0,1.19,.36);var Ah=new Xo(.045,8,8),jh=lf(1776151),Mh=new W(Ah,jh),Nh=new W(Ah,jh);Mh.position.set(-.09,1.31,.42),Nh.position.set(.09,1.31,.42);var Ph=new Xo(.11,10,8),Fh=new W(Ph,Sh),Ih=new W(Ph,Sh);Fh.position.set(-.36,1.36,.02),Ih.position.set(.36,1.36,.02);var Lh=new W(new Zo(.35,.035,6,20),lf(14701885));Lh.rotation.x=Math.PI/2,Lh.position.y=1.44;var Rh=new W(new Ea(.08,.45,.03),lf(14701885));Rh.position.set(.12,1.2,-.36),Rh.rotation.z=.3;var zh=new Oa(.08,.09,.6,8),Bh=new W(zh,xh),Vh=new W(zh,xh);Bh.position.set(-.42,.6,0),Vh.position.set(.42,.6,0);var Hh=new Xo(.09,8,8),Uh=new W(Hh,Sh),Wh=new W(Hh,Sh);Uh.position.set(-.42,.28,0),Wh.position.set(.42,.28,0);var Gh=[];for(let e=0;e<6;e++){let t=new W(new Xo(.075-e*.006,8,6),Sh);vh.add(t),Gh.push(t)}vh.add(wh,Th,Eh,Dh,Oh,kh,Mh,Nh,Fh,Ih,Lh,Rh,Bh,Vh,Uh,Wh);function Kh(e){let t=new kn;t.position.set(e*.15,.46,0);let n=new W(new Oa(.1,.11,.44,8),xh);n.position.y=-.22;let r=new W(new Ea(.17,.1,.28),Sh);return r.position.set(0,-.44,.05),t.add(n,r),Z.add(t),t}var qh=Kh(-1),Jh=Kh(1);Z.traverse(e=>{e.isMesh&&(e.castShadow=!0,e.receiveShadow=!0)}),tf.add(Z);function Yh(e){vh.position.y=e?.02:.3,vh.rotation.x=e?1.15:0,qh.rotation.z=e?-.35:0,Jh.rotation.z=e?.35:0}function Xh(e){qh.rotation.x=e?-.7:0,Jh.rotation.x=e?-.4:0,Bh.rotation.x=e?-1.5:0,Vh.rotation.x=e?-1.5:0}var Zh={};function Qh(){if(Zh.built)return;Zh.built=!0;let e=new kn,t=new W(new Oa(.62,.62,.04,16),lf(14268522));t.position.y=1.62;let n=new W(new ka(.42,.32,16),lf(13609301));n.position.y=1.78,e.add(t,n),vh.add(e),Zh.hat=e;let r=new kn,i=new W(new Oa(.1,.12,.22,8),lf(13214042)),a=new W(new Xo(.07,8,8),uf(16769126)),o=df(16765562,0,9);o.position.y=.3,r.add(i,a,o),r.position.set(.55,.22,.12),vh.add(r),Zh.lantern=r,Zh.lanternLight=o;let s=new W(new Zo(.55,.03,6,30),uf(13214042));s.rotation.x=Math.PI/2,s.position.y=.5,vh.add(s),Zh.charm=s}function $h(){Qh(),xh.color.set(Cf(`cloak`)?bh:yh),Zh.hat.visible=Cf(`hat`),Zh.lantern.visible=Cf(`lantern`),Zh.charm.visible=Cf(`charm`)}yf(_f.LOADOUT_CHANGED,$h);var eg=J(`pouch`),tg=J(`fragCount`);function ng(){tg.textContent=mf.fragments}function rg(e){e.classList.remove(`bump`),e.offsetWidth,e.classList.add(`bump`)}function ig(e){mf.fragments+=e,hf(),ng(),rg(eg)}ng();var ag=J(`toast`),og=0;function sg(e,t=2.2){ag.classList.remove(`echo`),ag.textContent=e,ag.style.opacity=1,og=t}function cg(e){og>0&&(og-=e,og<=0&&(ag.style.opacity=0))}var lg=document.createElement(`span`);lg.id=`orderTag`,lg.className=`none`,J(`counter`).appendChild(lg);function ug(e,t){if(t===0){lg.className=`none`,lg.textContent=``;return}lg.className=e?`kept`:`broken`,lg.textContent=e?`in order`:`order broken`}function dg(e,t=5){sg(e,t),ag.classList.add(`echo`)}J(`jumpBtn`).addEventListener(`pointerdown`,e=>{e.preventDefault(),xf(_f.JUMP)});var fg=e=>e+([`th`,`st`,`nd`,`rd`][(e%100-20)%10]||[`th`,`st`,`nd`,`rd`][e%100]||`th`);function pg(e){if(!new URLSearchParams(location.search).has(`stats`))return;let t=document.createElement(`div`);t.id=`stats`,document.body.appendChild(t);let n=0,r=performance.now(),i=999;(function a(){requestAnimationFrame(a),n++;let o=performance.now();if(o-r>=500){let a=Math.round(n*1e3/(o-r));a<i&&(i=a),n=0,r=o;let s=e.info.render;t.textContent=`${a} fps (low ${i})  ${s.calls} calls  ${(s.triangles/1e3).toFixed(1)}k tris`}})()}var mg=[16739179,16755021,16769126,9234842,6740456,7639036,14317554],hg=new Xo(.55,18,14),gg=[],_g=q.orbs.litAtOnce,vg=[];for(let e=0;e<_g;e++){let e=df(16777215,0,q.orbs.lightRange);e.visible=!1,tf.add(e),vg.push(e)}function yg(){let e=gg.filter(e=>!e.found).map(e=>({o:e,d:Math.hypot(e.x-Z.position.x,e.z-Z.position.z)})).sort((e,t)=>e.d-t.d).slice(0,_g);vg.forEach((t,n)=>{let r=e[n];r&&r.d<q.orbs.lightCutoff?(t.visible=!0,t.color.setHex(r.o.color),t.intensity=q.orbs.lightIntensity,t.position.set(r.o.x,r.o.mesh.position.y,r.o.z)):(t.visible=!1,t.intensity=0)})}for(let e=0;e<7;e++){let t=mg[e],n=new W(hg,lf(t,.6));n.add(new W(new Xo(.9,14,10),uf(t,.18)));let r=document.createElement(`canvas`);r.width=r.height=128;let i=r.getContext(`2d`);i.fillStyle=`#f6efdf`,i.beginPath(),i.arc(64,64,54,0,Math.PI*2),i.fill(),i.lineWidth=8,i.strokeStyle=Qd(t),i.stroke(),i.fillStyle=`#1b1a17`,i.font=`bold 72px Trebuchet MS, sans-serif`,i.textAlign=`center`,i.textBaseline=`middle`,i.fillText(String(e+1),64,68);let a=new Qr(new Rr({map:new Sa(r),transparent:!0}));a.position.y=1.35,a.scale.setScalar(.8),n.add(a),gg.push({x:0,z:0,mesh:n,color:t,found:!1,phase:Math.random()*6,n:e+1})}var bg=J(`counter`),xg=gg.map(e=>{let t=document.createElement(`i`);return t.textContent=e.n,t.style.setProperty(`--c`,Qd(e.color)),bg.appendChild(t),t});function Sg(){Y.found=0,Y.orderKept=!0;let e=q.orbs,t=e.outerRadius-e.innerRadius,n=[],r=0;for(;n.length<7&&r++<4e3;){let r=Math.random()*Math.PI*2,i=e.innerRadius+Math.random()*t,a=Math.cos(r)*i,o=Math.sin(r)*i;Math.hypot(a-Z.position.x,o-Z.position.z)<e.minDistanceFromPlayer||n.every(t=>Math.hypot(t.x-a,t.z-o)>=e.minSpacing)&&n.push({x:a,z:o})}for(;n.length<7;){let r=Math.random()*Math.PI*2,i=e.innerRadius+Math.random()*t;n.push({x:Math.cos(r)*i,z:Math.sin(r)*i})}for(let e=n.length-1;e>0;e--){let t=Math.random()*(e+1)|0;[n[e],n[t]]=[n[t],n[e]]}gg.forEach((e,t)=>{e.x=n[t].x,e.z=n[t].z,e.found=!1,e.mesh.position.set(e.x,hm(e.x,e.z)+1.1,e.z),tf.add(e.mesh),xg[t].classList.remove(`on`)}),ug(!0,0)}Sg();function Cg(e){e.n!==Y.found+1&&Y.orderKept?(Y.orderKept=!1,sg(`Order broken at ${e.n}. One wish.`)):Y.found<6&&sg(Y.orderKept?`Orb ${e.n} found, in order. ${Y.found+1} of 7`:`Orb ${e.n} found. ${Y.found+1} of 7`),e.found=!0,Y.found++,tf.remove(e.mesh),xg[gg.indexOf(e)].classList.add(`on`),navigator.vibrate&&navigator.vibrate(40),ug(Y.orderKept,Y.found),Y.found===7&&(sg(Y.orderKept?`All seven, in perfect order`:`All seven gathered`),xf(_f.ORBS_ALL_FOUND))}var wg=J(`stick`),Tg=J(`knob`),Eg={active:!1,id:null,cx:0,cy:0,x:0,y:0},Dg={active:!1,id:null,lastX:0,lastY:0},Og={},kg=55,Ag=new Map,jg={active:!1,candidate:!1,a:null,b:null,gap0:0,gap:0,dist0:0},Mg=(e,t)=>Math.hypot(e.x-t.x,e.y-t.y),Ng=()=>Eg.active?Math.hypot(Eg.x,Eg.y):0;function Pg(e){let t=q.camera;Y.camDist=Math.max(t.minDistance,Math.min(t.maxDistance,e))}var Fg=0;function Ig(){clearTimeout(Fg),Fg=setTimeout(()=>{mf.camDist=Y.camDist,hf()},250)}function Lg(){Eg.active=!1,Eg.x=Eg.y=0,wg.style.display=`none`}function Rg(){if(jg.active||jg.candidate)return;let e=[...Ag.keys()];e.length<2||(jg.candidate=!0,[jg.a,jg.b]=e,jg.gap0=Mg(Ag.get(jg.a),Ag.get(jg.b)))}function zg(e){jg.active=!0,jg.candidate=!1,Lg(),Dg.active=!1,jg.gap=e,jg.dist0=Y.camDist}function Bg(){let e=jg.active;jg.active=jg.candidate=!1,jg.a=jg.b=null,e&&Ig();let t=[...Ag.keys()];if(e&&t.length===1){let e=Ag.get(t[0]);Dg.active=!0,Dg.id=t[0],Dg.lastX=e.x,Dg.lastY=e.y}}function Vg(e){Ag.set(e.identifier,{x:e.clientX,y:e.clientY}),Rg(),e.clientX<innerWidth*.5&&!Eg.active?(Eg.active=!0,Eg.id=e.identifier,Eg.cx=e.clientX,Eg.cy=e.clientY,Eg.x=Eg.y=0,wg.style.display=`block`,wg.style.left=Eg.cx+`px`,wg.style.top=Eg.cy+`px`,Tg.style.transform=`translate(-50%,-50%)`):Dg.active||(Dg.active=!0,Dg.id=e.identifier,Dg.lastX=e.clientX,Dg.lastY=e.clientY)}function Hg(e){let t=Ag.get(e.identifier);if(t&&(t.x=e.clientX,t.y=e.clientY),(jg.active||jg.candidate)&&(e.identifier===jg.a||e.identifier===jg.b)){let e=Ag.get(jg.a),t=Ag.get(jg.b);if(e&&t){let n=Mg(e,t);if(jg.candidate){let e=q.camera;Math.abs(n-jg.gap0)>e.pinchThreshold&&Ng()<e.pinchJoyTolerance&&zg(n)}if(jg.active){n>1&&Pg(jg.dist0*(jg.gap/n));return}}}if(Eg.active&&e.identifier===Eg.id){let t=e.clientX-Eg.cx,n=e.clientY-Eg.cy,r=Math.hypot(t,n);r>kg&&(t*=kg/r,n*=kg/r),Eg.x=t/kg,Eg.y=n/kg,Tg.style.transform=`translate(calc(-50% + ${t}px), calc(-50% + ${n}px))`}else if(Dg.active&&e.identifier===Dg.id){let t=q.camera;Y.camYaw-=(e.clientX-Dg.lastX)*t.dragSensitivity;let n=(e.clientY-Dg.lastY)*t.dragSensitivityY*(t.invertY?-1:1);Y.camPitch=Math.max(t.pitchMin,Math.min(t.pitchMax,Y.camPitch+n)),Dg.lastX=e.clientX,Dg.lastY=e.clientY}}function Ug(e){Ag.delete(e.identifier),(jg.active||jg.candidate)&&(e.identifier===jg.a||e.identifier===jg.b)&&Bg(),Eg.active&&e.identifier===Eg.id&&(Eg.active=!1,Eg.x=Eg.y=0,wg.style.display=`none`),Dg.active&&e.identifier===Dg.id&&(Dg.active=!1)}$d.addEventListener(`touchstart`,e=>{e.preventDefault();for(let t of e.changedTouches)Vg(t)},{passive:!1}),$d.addEventListener(`touchmove`,e=>{e.preventDefault();for(let t of e.changedTouches)Hg(t)},{passive:!1}),$d.addEventListener(`touchend`,e=>{for(let t of e.changedTouches)Ug(t)}),$d.addEventListener(`touchcancel`,e=>{for(let t of e.changedTouches)Ug(t)}),$d.addEventListener(`wheel`,e=>{e.preventDefault(),Pg(Y.camDist*Math.exp(e.deltaY*q.camera.wheelStep)),Ig()},{passive:!1}),$d.addEventListener(`mousedown`,e=>Vg({clientX:e.clientX,clientY:e.clientY,identifier:`m`})),window.addEventListener(`mousemove`,e=>Hg({clientX:e.clientX,clientY:e.clientY,identifier:`m`})),window.addEventListener(`mouseup`,()=>Ug({identifier:`m`})),window.addEventListener(`keydown`,e=>{let t=e.key.toLowerCase();e.repeat||(t===`c`&&xf(_f.CRAWL_TOGGLE),t===`v`&&xf(_f.WHISTLE),t===` `&&xf(_f.JUMP)),t===` `&&e.preventDefault(),Og[t]=!0}),window.addEventListener(`keyup`,e=>Og[e.key.toLowerCase()]=!1);var Wg=[{name:`Bram the Woodcutter`,short:`Bram`,color:7048739,hat:5913886,skin:14264440,build:1.1,headwear:`cap`,prop:`axe`},{name:`Nell the Herbalist`,short:`Nell`,color:10181046,hat:16183263,skin:15845797,build:.92,headwear:`kerchief`,prop:`basket`},{name:`Pip the Courier`,short:`Pip`,color:4034505,hat:14701885,skin:15252368,build:.85,headwear:`cap`,prop:`satchel`},{name:`Marla Stonehand`,short:`Marla`,color:9071162,hat:8359053,skin:13209443,build:1.18,headwear:`none`,prop:`hammer`},{name:`Old Tarrow`,short:`Tarrow`,color:8359053,hat:1776151,skin:14465172,build:.95,headwear:`brim`,prop:`staff`,beard:!0},{name:`Sable the Fencer`,short:`Sable`,color:1776151,hat:13214042,skin:14264440,build:1,headwear:`none`,prop:`blade`},{name:`The Grey Pilgrim`,short:`the Pilgrim`,color:14277081,hat:2829660,skin:13607034,build:1.05,headwear:`hood`,prop:`staff`}],Gg={torso:new Oa(.3,.38,.8,10),head:new Xo(.28,14,12),arm:new Oa(.075,.085,.55,7),hand:new Xo(.085,7,6),leg:new Oa(.095,.105,.42,7),foot:new Ea(.16,.09,.26),eye:new Xo(.035,6,6),cap:new ka(.34,.3,8),brim:new Oa(.46,.46,.035,12),crown:new ka(.3,.34,10),hood:new Xo(.33,14,12,0,Math.PI*2,0,Math.PI*.6),kerchief:new Xo(.3,12,10,0,Math.PI*2,0,Math.PI*.45),handle:new Oa(.035,.035,.9,6),staff:new Oa(.04,.045,1.7,6),axeHead:new Ea(.07,.26,.3),hammer:new Ea(.2,.2,.3),blade:new Ea(.045,.95,.1),bag:new Ea(.3,.26,.16),basket:new Oa(.19,.15,.22,9),beard:new ka(.17,.34,8)},Kg=lf(1776151),qg=lf(7031338),Jg=lf(10134443),Yg=lf(13214042),Xg=lf(13609301),Zg=lf(4866104),Qg=lf(15263976),$g=lf(9071162),e_=lf(5913886),t_=lf(4034373);function n_(e){let t=new kn,n=lf(e.color),r=lf(e.skin),i=lf(e.hat),a=e.build,o=new W(Gg.torso,n);o.position.y=.86*a,o.scale.setScalar(a);let s=new W(Gg.head,r);if(s.position.y=1.48*a,t.add(o,s),[-1,1].forEach(e=>{let n=new W(Gg.eye,Kg);n.position.set(e*.1*a,1.52*a,.245*a),t.add(n)}),e.beard){let e=new W(Gg.beard,Qg);e.position.set(0,1.3*a,.16*a),e.rotation.x=Math.PI,t.add(e)}let c={arms:[],legs:[]};if([-1,1].forEach(e=>{let i=new kn;i.position.set(e*.38*a,1.16*a,0);let o=new W(Gg.arm,n);o.position.y=-.27;let s=new W(Gg.hand,r);s.position.y=-.56,i.add(o,s),t.add(i),c.arms.push(i);let l=new kn;l.position.set(e*.15*a,.46*a,0);let u=new W(Gg.leg,Zg);u.position.y=-.21;let d=new W(Gg.foot,qg);d.position.set(0,-.42,.05),l.add(u,d),t.add(l),c.legs.push(l)}),e.headwear===`cap`){let e=new W(Gg.cap,i);e.position.y=1.72*a,t.add(e)}else if(e.headwear===`brim`){let e=new W(Gg.brim,i);e.position.y=1.66*a;let n=new W(Gg.crown,i);n.position.y=1.82*a,t.add(e,n)}else if(e.headwear===`hood`){let e=new W(Gg.hood,i);e.position.y=1.5*a,t.add(e)}else if(e.headwear===`kerchief`){let e=new W(Gg.kerchief,i);e.position.y=1.5*a,t.add(e)}let l=.38*a,u=.72*a,d=.12;if(e.prop===`axe`){let e=new W(Gg.handle,qg);e.position.set(l,u,d),e.rotation.z=.25;let n=new W(Gg.axeHead,Jg);n.position.set(l+.16,u+.42,d),t.add(e,n)}else if(e.prop===`hammer`){let e=new W(Gg.handle,qg);e.position.set(l,u,d),e.rotation.z=.2;let n=new W(Gg.hammer,Jg);n.position.set(l+.13,u+.44,d),t.add(e,n)}else if(e.prop===`blade`){let e=new W(Gg.blade,Jg);e.position.set(l,u+.35,d),e.rotation.z=.12;let n=new W(Gg.hand,Yg);n.position.set(l,u-.1,d),t.add(e,n)}else if(e.prop===`staff`){let e=new W(Gg.staff,qg);e.position.set(l,u+.36,d),e.rotation.z=.06,t.add(e)}else if(e.prop===`satchel`){let e=new W(Gg.bag,$g);e.position.set(-.34*a,.8*a,.1),e.rotation.z=-.15;let n=new W(Gg.handle,e_);n.position.set(-.1*a,1.15*a,.05),n.rotation.z=Math.PI/2.6,t.add(e,n)}else if(e.prop===`basket`){let e=new W(Gg.basket,Xg);e.position.set(l,u,.1);let n=new W(Gg.hand,t_);n.position.set(l,u+.14,.1),n.scale.set(1.6,.7,1.6),t.add(e,n)}return t.traverse(e=>{e.isMesh&&(e.castShadow=!0,e.receiveShadow=!0)}),tf.add(t),{g:t,limbs:c}}var r_=Wg.map((e,t)=>{let{g:n,limbs:r}=n_(e);return{...e,g:n,limbs:r,tier:t+1,hx:0,hz:0,tx:0,tz:0,wait:0,cooldown:0,bob:Math.random()*6}}),i_=e=>q.duel.opponentBase+e*q.duel.opponentPerTier;function a_(){r_.forEach((e,t)=>{e.hx=gg[t].x,e.hz=gg[t].z;let n=q.wanderers,r=Math.random()*Math.PI*2,i=n.campRadiusMin+Math.random()*(n.campRadiusMax-n.campRadiusMin),a=e.hx+Math.cos(r)*i,o=e.hz+Math.sin(r)*i;e.g.position.set(a,hm(a,o),o),o_(e)})}function o_(e){let t=q.wanderers,n=Math.random()*Math.PI*2,r=Math.random()*t.roamRadius;e.tx=Math.max(-Xp+5,Math.min(Xp-5,e.hx+Math.cos(n)*r)),e.tz=Math.max(-Xp+5,Math.min(Xp-5,e.hz+Math.sin(n)*r)),e.wait=t.waitMin+Math.random()*(t.waitMax-t.waitMin)}a_();function s_(e,t){let n=t?Math.sin(e.bob):0;e.limbs.arms[0].rotation.x=n*.55,e.limbs.arms[1].rotation.x=-n*.55,e.limbs.legs[0].rotation.x=-n*.5,e.limbs.legs[1].rotation.x=n*.5}function c_(e){let t=q.wanderers,n=Cf(`bell`)?t.hearingWithBell:t.hearingRange;Y.crawling&&(n*=t.crawlHearingMultiplier),Y.whistleT>0&&(n=Math.max(n,t.whistleRange));for(let r of r_){r.cooldown=Math.max(0,r.cooldown-e);let i=Z.position.x-r.g.position.x,a=Z.position.z-r.g.position.z,o=Math.hypot(i,a),s=o<n&&r.cooldown===0&&!Y.ceremony;s&&(r.tx=Z.position.x,r.tz=Z.position.z,r.wait=0);let c=r.tx-r.g.position.x,l=r.tz-r.g.position.z,u=Math.hypot(c,l);if(u>.5){let n=s?t.huntSpeed:t.roamSpeed;r.g.position.x+=c/u*n*e,r.g.position.z+=l/u*n*e,r.g.rotation.y=Math.atan2(c,l),r.bob+=e*t.bobRate,r.g.position.y=hm(r.g.position.x,r.g.position.z)+Math.abs(Math.sin(r.bob))*.1,s_(r,!0)}else r.g.position.y=hm(r.g.position.x,r.g.position.z),r.wait-=e,r.wait<=0&&o_(r),s_(r,!1);Y.state===`play`&&s&&o<t.challengeRange&&xf(_f.DUEL_CHALLENGE,r)}}var l_={Bram:{challenge:`One orb. That is all I ever carried out of this valley. Let us see if your arms are better than mine were.`,theyWin:`Ha! Still in me somewhere. Go on — the rest of them are worse than me.`,theyLose:`Quick hands. I wish I had had them when it counted.`},Nell:{challenge:`The second is mine. Not that I wanted the others — there are better things growing out here than wishes.`,theyWin:`Patience beats hurry. Ask the moss, it has been here longer.`,theyLose:`Off you go, then. Mind the nettles down by the water.`},Pip:{challenge:`Third! Third, and I would have had the lot, only I grabbed them out of order like a fool. Come on, quickly.`,theyWin:`Too slow! Everyone is always too slow.`,theyLose:`Fine. You are quick. Do not be quick about the order, though. That is how you end up camped by the third.`},Marla:{challenge:`Four. Halfway, near enough. You will not rush me.`,theyWin:`Hands like stone. I did say.`,theyLose:`Hm. Good. Take it.`},Tarrow:{challenge:`The fifth. I have watched a great many people walk past me, and rather fewer walk back. Let us see which you are.`,theyWin:`No shame in it. I have lost at this spot more times than you have stood on it.`,theyLose:`Go on, then. And when it asks you — think before you speak.`},Sable:{challenge:`Six. Twice I stood here, and twice I turned around. You will do no better.`,theyWin:`As I thought. The sixth keeps its own.`,theyLose:`Again? Then go. Go and see what is past it, and come back and tell me.`},"the Pilgrim":{challenge:`I have been where you are going.`,theyWin:`Then you are not ready. Good.`,theyLose:`Go. Ask carefully.`}},u_={challenge:`A duel, then. Ten seconds.`,theyWin:`Better luck further out.`,theyLose:`Well fought.`};function d_(e){return l_[e]||u_}function f_(e,t){return t?e===0?`Seven orbs, gathered in perfect order. It has been a long while since anyone managed that. Speak three wishes.`:e<3?`In order again. You have the patience this valley asks for. Three wishes, then.`:e<7?`You keep returning, and you keep them in order. I know your step by now. Three wishes.`:`Again, and in order. I have granted you a great deal, seeker. Three wishes.`:e===0?`You have gathered all seven. They were not in order, and so there is one wish. Speak it.`:e<3?`All seven, though hurried. One wish.`:`Hurried again. You know what the order is worth, and still you rush. One wish.`}function p_(e,t){let n=`“${e}”`;return t<=0?`You asked for ${n} not long ago.`:t===1?`One gathering ago you asked for ${n}.`:`${t} gatherings ago you asked for ${n}.`}var m_=J(`duel`),h_=q.duel,Q={w:null,you:0,them:0,time:h_.seconds,ready:h_.countdown,waiting:!0,over:!1};function g_(e){Y.state=`duel`,Q.w=e,Q.you=0,Q.them=0,Q.time=h_.seconds,Q.ready=h_.countdown,Q.waiting=!0,Q.over=!1,Eg.active=!1,Eg.x=Eg.y=0,wg.style.display=`none`;let t=[`a gentle`,`an easy`,`a steady`,`a quick`,`a fast`,`a fierce`,`a blistering`][e.tier-1];J(`duelWho`).textContent=`“${d_(e.short).challenge}”`,J(`duelRules`).textContent=`${e.name} keeps camp by orb ${e.tier}, so expect ${t} pace. Ten seconds: tap to fill your bar before theirs.`,J(`resultSay`).textContent=``,J(`themName`).textContent=e.short,J(`duelPlay`).style.display=`block`,J(`duelResult`).style.display=`none`,J(`duelStart`).style.display=`inline-block`,J(`tapzone`).style.display=`none`,J(`tapzone`).textContent=`Get ready…`,__(),m_.classList.remove(`hidden`),navigator.vibrate&&navigator.vibrate(30)}J(`duelStart`).addEventListener(`click`,()=>{Q.waiting=!1,J(`duelStart`).style.display=`none`,J(`tapzone`).style.display=`flex`});function __(){J(`timer`).textContent=Q.waiting?h_.seconds.toFixed(1):Q.ready>0?String(Math.ceil(Q.ready)):Math.max(0,Q.time).toFixed(1);let e=Math.min(100,Q.you*100),t=Math.min(100,Q.them*100);J(`youBar`).style.width=e+`%`,J(`youPct`).textContent=Math.round(e)+`%`,J(`themBar`).style.width=t+`%`,J(`themPct`).textContent=Math.round(t)+`%`}function v_(){Y.state!==`duel`||Q.over||Q.waiting||Q.ready>0||(Q.you+=Cf(`grip`)?h_.tapValueWithGrip:h_.tapValue,navigator.vibrate&&navigator.vibrate(8),__(),Q.you>=1&&b_(!0))}J(`tapzone`).addEventListener(`touchstart`,e=>{e.preventDefault(),v_()},{passive:!1}),J(`tapzone`).addEventListener(`mousedown`,v_),window.addEventListener(`keydown`,e=>{e.code===`Space`&&v_()});function y_(e){if(!(Q.over||Q.waiting)){if(Q.ready>0){Q.ready-=e,Q.ready<=0&&(J(`tapzone`).textContent=`Tap!`,navigator.vibrate&&navigator.vibrate(25)),__();return}Q.time-=e,Q.them+=e*i_(Q.w.tier),__(),Q.them>=1?b_(!1):Q.time<=0&&b_(Q.you>Q.them)}}function b_(e){Q.over=!0;let t,n=Q.w.short;if(e){mf.wins++;let e=Math.random(),r=h_.lootBase+Q.w.tier+Math.floor(Math.random()*h_.lootVariance),i=e<h_.flawlessChance;t=i?r*h_.flawlessMultiplier:r,J(`resultBig`).textContent=i?`Flawless!`:`You win`,J(`resultSay`).textContent=`“${d_(Q.w.short).theyLose}”`,J(`resultLoot`).textContent=`${n} hands over ${t} fragments.`,navigator.vibrate&&navigator.vibrate([40,40,80])}else t=h_.consolation,J(`resultBig`).textContent=`Outpaced`,J(`resultSay`).textContent=`“${d_(Q.w.short).theyWin}”`,J(`resultLoot`).textContent=`${n} wins, but tosses you ${t} fragment for the effort.`;ig(t),Q.w.cooldown=q.wanderers.cooldown,o_(Q.w),setTimeout(()=>{J(`duelPlay`).style.display=`none`,J(`duelResult`).style.display=`block`},h_.resultDelay)}J(`duelDone`).addEventListener(`click`,()=>{m_.classList.add(`hidden`),Y.state=`play`}),yf(_f.DUEL_CHALLENGE,g_);function x_(e){return Zd.find(t=>t.id===e)}function S_(){let e=J(`shopItems`);e.innerHTML=``;for(let t of Zd){let n=document.createElement(`div`);n.className=`item`;let r=document.createElement(`div`);r.className=`row`;let i=document.createElement(`div`);i.className=`swatch`,i.style.background=Qd(t.color);let a=document.createElement(`div`);a.innerHTML=`<div class="name">${t.name}</div><div class="desc">${t.desc}</div>`,r.append(i,a),n.appendChild(r);let o=mf.items[t.id];if(o){let e=document.createElement(`span`);e.className=`owned`,e.textContent=o===`owned`?`Kept`:`Set down for you`,n.appendChild(e)}else{let e=document.createElement(`button`);e.textContent=`${t.cost} ◆`,e.disabled=mf.fragments<t.cost,e.addEventListener(`click`,()=>{mf.fragments-=t.cost,mf.items[t.id]=`bought`,hf(),ng(),S_(),xf(_f.ITEM_BOUGHT,t.id),sg(`${t.name} set down beside you`)}),n.appendChild(e)}e.appendChild(n)}}eg.addEventListener(`click`,()=>{Y.state===`play`&&(Y.state=`shop`,S_(),J(`shop`).classList.remove(`hidden`))}),J(`shopClose`).addEventListener(`click`,()=>{J(`shop`).classList.add(`hidden`),Y.state=`play`});var C_=[];function w_(e,t,n){let r=new kn;if(e===`item`){let n=x_(t),i=new W(new Ea(.7,.45,.5),lf(9071162)),a=new W(new Ea(.74,.18,.54),lf(n.color,.35));a.position.y=.32;let o=new W(new Ea(.12,.14,.06),lf(13214042));o.position.set(0,.22,.28),r.add(i,a,o,df(n.color,.9,6)),r.userData={kind:e,id:t}}else{let n=new W(new Ko(.42,0),lf(16771504,.9));n.add(new W(new Xo(.7,12,10),uf(16773320,.2))),n.add(df(16771504,1.2,8)),r.add(n),r.userData={kind:e,text:t}}let i=n===void 0?Math.random()*Math.PI*2:n,a=Z.position.x+Math.cos(i)*3.2,o=Z.position.z+Math.sin(i)*3.2;r.position.set(a,hm(a,o)+.7,o),tf.add(r),C_.push({g:r,kind:e,phase:Math.random()*6})}function T_(e,t){if(tf.remove(e.g),C_.splice(t,1),e.kind===`item`){let t=e.g.userData.id;mf.items[t]=`owned`,hf();let n=kf(t);$h(),sg(n?`${x_(t).name} — worn`:`${x_(t).name} added. No room to wear it; open your satchel.`,n?2:3)}else mf.wishes.push({text:e.g.userData.text,cycle:mf.cycles}),hf(),sg(`Wish kept: “${e.g.userData.text}”`,3);rg(J(`satchelBtn`)),navigator.vibrate&&navigator.vibrate([30,30,60]),Y.ceremony&&!C_.some(e=>e.kind===`wish`)&&xf(_f.WISHES_ALL_COLLECTED)}function E_(){let e=J(`satchelWishes`);e.innerHTML=``,mf.wishes.length||(e.innerHTML=`<div class="empty">No wishes yet. Gather the seven orbs.</div>`),mf.wishes.forEach(t=>{let n=document.createElement(`div`);n.className=`wishrow`,n.innerHTML=`<span class="star">✦</span><div><div>“${t.text.replace(/</g,`&lt;`)}”</div><div class="meta">Granted on your ${fg(t.cycle)} gathering</div></div>`,e.appendChild(n)});let t=J(`satchelItems`);t.innerHTML=``;let n=Zd.filter(e=>gf(e.id));n.length||(t.innerHTML=`<div class="empty">Nothing yet. Win duels and visit the trader.</div>`);let r=Sf();if(n.length&&r>0){let e=document.createElement(`div`);e.className=`slotline`,e.textContent=`Worn ${Tf()} of ${r}`,t.appendChild(e)}n.forEach(e=>{let n=Cf(e.id),r=document.createElement(`div`);r.className=`item`+(n?` isworn`:``),r.innerHTML=`<div class="row"><div class="swatch" style="background:${Qd(e.color)}"></div><div><div class="name">${e.name}</div><div class="desc">${e.desc}</div></div></div>`;let i=document.createElement(`button`);i.textContent=n?`Take off`:`Wear`,i.addEventListener(`click`,()=>{let t=Of(e.id);if(!t.ok){sg(t.reason,3);return}E_(),rg(J(`satchelBtn`))}),r.appendChild(i),t.appendChild(r)})}yf(_f.ITEM_BOUGHT,e=>w_(`item`,e)),J(`satchelBtn`).addEventListener(`click`,()=>{Y.state===`play`&&(Y.state=`satchel`,E_(),J(`satchel`).classList.remove(`hidden`))}),J(`satchelClose`).addEventListener(`click`,()=>{J(`satchel`).classList.add(`hidden`),Y.state=`play`});var $=J(`rc`).getContext(`2d`),D_=J(`dist`),O_=0;function k_(e,t,n,r,i){let a=q.finder,o=Cf(`lens`)?a.rangeWithLens:a.range,s=a.revealDistance;O_+=e*a.sweepSpeed,$.clearRect(0,0,256,256),$.strokeStyle=`rgba(143,245,200,0.25)`,$.lineWidth=2,[.33,.66,1].forEach(e=>{$.beginPath(),$.arc(128,128,118*e,0,Math.PI*2),$.stroke()}),$.beginPath(),$.moveTo(128,10),$.lineTo(128,246),$.moveTo(10,128),$.lineTo(246,128),$.stroke(),$.save(),$.translate(128,128),$.rotate(O_);let c=$.createLinearGradient(0,0,118,0);c.addColorStop(0,`rgba(143,245,200,0.35)`),c.addColorStop(1,`rgba(143,245,200,0)`),$.fillStyle=c,$.beginPath(),$.moveTo(0,0),$.arc(0,0,118,-.9,0),$.closePath(),$.fill(),$.restore();let l=(e,a)=>{let s=e-Z.position.x,c=a-Z.position.z;return[(s*r+c*i)/o*118,-(s*t+c*n)/o*118,Math.hypot(s,c)]},u=1/0;for(let e of gg){if(e.found)continue;let[t,n,r]=l(e.x,e.z);u=Math.min(u,r);let i=Math.hypot(t,n),a=i<=118,o=r<=s;a||(t*=112/i,n*=112/i),$.fillStyle=o?Qd(e.color):`#f6efdf`,$.globalAlpha=a?.75+.25*Math.sin(performance.now()/250+e.phase):.4,$.beginPath(),$.arc(128+t,128+n,o?10:a?7:5,0,Math.PI*2),$.fill(),o&&($.fillStyle=`#1b1a17`,$.font=`bold 13px Trebuchet MS, sans-serif`,$.textAlign=`center`,$.textBaseline=`middle`,$.fillText(e.n,128+t,128+n+1)),$.globalAlpha=1}$.strokeStyle=`#f6efdf`,$.lineWidth=2.5;for(let e of r_){let[t,n,r]=l(e.g.position.x,e.g.position.z);Math.hypot(t,n)>110||($.globalAlpha=e.cooldown>0?.35:.9,$.strokeStyle=`#f6efdf`,$.beginPath(),$.moveTo(128+t,128+n-8),$.lineTo(128+t+8,128+n),$.lineTo(128+t,128+n+8),$.lineTo(128+t-8,128+n),$.closePath(),$.stroke(),r<=s&&($.fillStyle=`#f6efdf`,$.font=`bold 10px Trebuchet MS, sans-serif`,$.textAlign=`center`,$.textBaseline=`middle`,$.fillText(e.tier,128+t,128+n+1)),$.globalAlpha=1)}$.fillStyle=`#ffe9b0`;for(let e of C_){let[t,n]=l(e.g.position.x,e.g.position.z);Math.hypot(t,n)>110||$.fillRect(128+t-4,128+n-4,8,8)}$.fillStyle=`#f6efdf`,$.beginPath(),$.moveTo(128,119),$.lineTo(135,135),$.lineTo(121,135),$.closePath(),$.fill(),D_.textContent=u===1/0?``:`Nearest orb: ${Math.round(u)} m`}var A_=new kn,j_={wings:[],tail:[],neck:[],eyes:[],sparks:null,ring:null,built:!1},M_=[];function N_(){if(j_.built)return;j_.built=!0;let e=lf(15852213,.25),t=lf(16774616,.3),n=lf(13214042,.6),r=lf(2761504),i=new W(new Xo(1,20,16),e);i.scale.set(2.3,1.9,3),i.position.set(0,6,-1),A_.add(i);let a=new W(new Xo(1,16,12),t);a.scale.set(1.7,1.3,2.6),a.position.set(0,5.4,-.6),A_.add(a);for(let e=0;e<5;e++){let t=new W(new ka(.35,.9-e*.1,4),n);t.position.set(0,7.9-e*.15,.6-e*.9),t.rotation.x=-.4,A_.add(t)}for(let t=0;t<5;t++){let n=new W(new Xo(1-t*.11,14,10),e);n.position.set(0,6.8+t*.85,1.6+t*.75),A_.add(n),j_.neck.push(n)}let o=new kn;o.position.set(0,10.6,5.2);let s=new W(new Xo(.9,18,14),e);s.scale.set(1,.85,1.25),o.add(s);let c=new W(new Ea(1,.6,1.3),e);c.position.set(0,-.15,1.2),o.add(c);let l=new W(new Ea(.85,.28,1.1),t);l.position.set(0,-.55,1.05),l.rotation.x=.18,o.add(l);let u=new W(new Ea(.5,.15,.2),r);u.position.set(0,.05,1.85),o.add(u),[-1,1].forEach(t=>{let i=new W(new Xo(.17,10,8),uf(9434568));i.position.set(t*.5,.2,.75),o.add(i),j_.eyes.push(i);let a=new W(new Ea(.45,.12,.3),r);a.position.set(t*.5,.45,.7),a.rotation.z=-t*.3,o.add(a);let s=new W(new Oa(.06,.16,1.8,6),n);s.position.set(t*.55,.9,-.6),s.rotation.set(-.9,0,-t*.35),o.add(s);let c=new W(new Oa(.04,.09,.9,6),n);c.position.set(t*.9,1.4,-.9),c.rotation.set(-.5,0,-t*.9),o.add(c);let l=new W(new ka(.35,.9,4),e);l.position.set(t*.95,-.1,-.2),l.rotation.set(0,0,t*Math.PI/2+t*.4),o.add(l)}),A_.add(o),j_.head=o;let d=new so;d.moveTo(0,0),d.lineTo(3.2,2.4),d.lineTo(6.4,2),d.lineTo(5.6,.2),d.lineTo(6.2,-2),d.lineTo(3.4,-1.4),d.lineTo(0,-1.2),d.lineTo(0,0);let f=new Jo(d),p=new cs({color:15126421,emissive:15126421,emissiveIntensity:.3,roughness:.6,metalness:0,transparent:!0,opacity:.85,side:2});[[-1,0,6.9,-.4],[1,0,6.9,-.4],[-1,.7,6.4,-2.6],[1,.7,6.4,-2.6]].forEach(([e,t,r,i],a)=>{let o=new kn;o.position.set(e*1.6,r,i);let s=new W(f,p);s.scale.set(e*(1-t*.35),1-t*.3,1),s.rotation.x=-Math.PI/2;let c=new W(new Oa(.06,.1,6.4,6),n);c.rotation.set(0,e*.3,Math.PI/2),c.position.set(e*3,.03,1.1),o.add(s,c),A_.add(o),j_.wings.push({pivot:o,s:e,phase:a<2?0:.6})}),[[-1.3,1.2],[1.3,1.2],[-1.4,-2.4],[1.4,-2.4]].forEach(([t,r])=>{let i=new W(new Oa(.28,.36,1.6,8),e);i.position.set(t,4.4,r),i.rotation.x=.35,A_.add(i);for(let e=-1;e<=1;e++){let i=new W(new ka(.09,.4,5),n);i.position.set(t+e*.2,3.5,r+.5),i.rotation.x=Math.PI*.75,A_.add(i)}});for(let n=0;n<8;n++){let r=new W(new Xo(.75-n*.08,12,8),n%2?t:e);A_.add(r),j_.tail.push(r)}let m=new W(new ka(.4,1.2,4),n);A_.add(m),j_.tailTip=m;let h=new W(new Zo(5.5,.08,6,80),uf(9434568,.6));h.rotation.x=Math.PI/2,h.position.y=.15,A_.add(h),j_.ring=h;let g=new Float32Array(540);for(let e=0;e<180;e++){let t=Math.random()*Math.PI*2,n=2+Math.random()*5;g[e*3]=Math.cos(t)*n,g[e*3+1]=Math.random()*13,g[e*3+2]=Math.sin(t)*n}let _=new Mr;_.setAttribute(`position`,new _r(g,3)),j_.sparks=new ya(_,new ma({color:16774084,size:.16,transparent:!0,opacity:.9})),A_.add(j_.sparks);let v=df(16771504,3.5,50);v.position.y=8,A_.add(v);let y=df(9434568,1.5,12);y.position.set(0,10,7),A_.add(y)}function P_(e){let t=Y.t;A_.position.y=Math.sin(t*1.1)*.35+.4,j_.wings.forEach(e=>{e.pivot.rotation.z=e.s*(.25+Math.sin(t*2.2+e.phase)*.45)}),j_.head.position.y=10.6+Math.sin(t*1.6)*.15,j_.head.rotation.x=Math.sin(t*.9)*.08,j_.neck.forEach((e,n)=>{e.position.x=Math.sin(t*1.6+n*.5)*.15*n/4}),j_.tail.forEach((e,n)=>{let r=n+1;e.position.set(Math.sin(t*1.5-r*.5)*.35*r*.5,6-r*.45+Math.sin(t*1.2-r*.4)*.2,-3.6-r*.75)});let n=j_.tail[7];j_.tailTip.position.set(n.position.x,n.position.y,n.position.z-.8),j_.tailTip.rotation.x=-Math.PI/2;let r=.7+.3*Math.sin(t*4);j_.eyes.forEach(e=>e.material.opacity=r),j_.eyes.forEach(e=>e.material.transparent=!0),j_.ring.rotation.z+=e*.4,j_.ring.scale.setScalar(1+Math.sin(t*2)*.03);let i=j_.sparks.geometry.attributes.position;for(let t=0;t<i.count;t++){let n=i.getY(t)+e*1.6;n>13&&(n=0),i.setY(t,n)}i.needsUpdate=!0}function F_(){Y.state=`ending`,Y.ceremony=!0,Y.endT=0,Y.nightTarget=1,Y.camPitch=q.camera.cinematicPitch,J(`hint`).style.opacity=0,gg.forEach((e,t)=>{let n=new W(hg,lf(e.color,.9));n.add(df(e.color,1.5,12)),tf.add(n),M_.push({m:n,i:t})}),N_();let e=ff(),t=Z.position.x+e.x*q.ceremony.keeperDistance,n=Z.position.z+e.z*q.ceremony.keeperDistance;A_.position.set(t,hm(t,n),n),A_.lookAt(Z.position.x,0,Z.position.z),A_.scale.setScalar(.001),tf.add(A_);let r=Y.orderKept?q.ceremony.wishesInOrder:q.ceremony.wishesOutOfOrder;J(`wishIntro`).textContent=f_(mf.cycles,Y.orderKept),J(`wishBtn`).textContent=r===1?`Make the wish`:`Make the wishes`,J(`wishAsk`).style.display=`block`,J(`wishDone`).style.display=`none`,J(`wishInputs`).innerHTML=``;for(let e=0;e<r;e++){let t=document.createElement(`input`);t.type=`text`,t.maxLength=80,t.autocomplete=`off`,t.placeholder=r===1?`I wish for…`:`Wish ${e+1}…`,t.className=`wishInput`,t.addEventListener(`keydown`,e=>{e.key===`Enter`&&L_()}),J(`wishInputs`).appendChild(t)}}var I_=[];function L_(){let e=[...document.querySelectorAll(`.wishInput`)].map(e=>e.value.trim()).filter(Boolean);I_=e.length?e:[`A wish kept secret`];let t=J(`wishEcho`);t.innerHTML=``,I_.forEach(e=>{let n=document.createElement(`div`);n.textContent=`“${e}”`,t.appendChild(n)}),J(`wishAsk`).style.display=`none`,J(`wishDone`).style.display=`block`,navigator.vibrate&&navigator.vibrate([40,60,40,60,120])}J(`wishBtn`).addEventListener(`click`,L_),J(`claimBtn`).addEventListener(`click`,()=>{J(`wish`).classList.add(`hidden`),Y.state=`play`;let e=Math.atan2(A_.position.z-Z.position.z,A_.position.x-Z.position.x);I_.forEach((t,n)=>w_(`wish`,t,e+(n-(I_.length-1)/2)*.5)),M_.forEach(({m:e})=>tf.remove(e)),M_.length=0,mf.cycles++,hf(),sg(`Walk over the tokens to keep your wishes`,3)});function R_(){Y.departT=0,sg(`The Keeper rises and the valley sleeps. The orbs will scatter again soon.`,3.5)}yf(_f.ORBS_ALL_FOUND,F_),yf(_f.WISHES_ALL_COLLECTED,R_);var z_=q.map,B_=Xp*2,V_=new Uint8Array(z_.grid*z_.grid),H_=e=>Math.floor((e+Xp)/B_*z_.grid),U_=0;function W_(e){if(U_+=e,U_<.25)return;U_=0;let t=H_(Z.position.x),n=H_(Z.position.z),r=Math.ceil(z_.seeRadius/B_*z_.grid);for(let e=n-r;e<=n+r;e++)if(!(e<0||e>=z_.grid))for(let i=t-r;i<=t+r;i++){if(i<0||i>=z_.grid)continue;let a=i-t,o=e-n;a*a+o*o<=r*r&&(V_[e*z_.grid+i]=1)}}function G_(){V_.fill(0)}var K_=null,q_=-1;function J_(){let e=z_.resolution,t=document.createElement(`canvas`);t.width=t.height=e;let n=t.getContext(`2d`),r=n.createImageData(e,e),i=[63,143,191];for(let t=0;t<e;t++)for(let n=0;n<e;n++){let a=n/(e-1)*B_-Xp,o=t/(e-1)*B_-Xp,s=(t*e+n)*4;if(Math.hypot(a,o)>Xp){r.data[s]=24,r.data[s+1]=30,r.data[s+2]=26,r.data[s+3]=255;continue}let c,l,u;if(Fm(a,o))[c,l,u]=i;else{let{region:e,neighbour:t,blend:n}=im(a,o),r=e.ground[0],i=t.ground[0];c=(r>>16&255)*(1-n)+(i>>16&255)*n,l=(r>>8&255)*(1-n)+(i>>8&255)*n,u=(r&255)*(1-n)+(i&255)*n}let d=B_/e,f=lm(a+d,o)-lm(a-d,o)+(lm(a,o+d)-lm(a,o-d)),p=Math.max(.55,Math.min(1.45,1+f*.16));r.data[s]=Math.min(255,c*p),r.data[s+1]=Math.min(255,l*p),r.data[s+2]=Math.min(255,u*p),r.data[s+3]=255}n.putImageData(r,0,0),K_=t,q_=$p}var Y_=J(`mapc`),X_=Y_.getContext(`2d`),Z_=document.createElement(`canvas`);Z_.width=Z_.height=z_.grid;var Q_=Z_.getContext(`2d`);function $_(){(!K_||q_!==$p)&&J_();let e=Y_.width;X_.clearRect(0,0,e,e),X_.imageSmoothingEnabled=!0,X_.drawImage(K_,0,0,e,e);let t=Q_.createImageData(z_.grid,z_.grid);for(let e=0;e<V_.length;e++)t.data[e*4+3]=V_[e]?0:238;Q_.putImageData(t,0,0),X_.drawImage(Z_,0,0,e,e);let n=(t,n)=>[(t+Xp)/B_*e,(n+Xp)/B_*e],r=(e,t)=>{let n=H_(e),r=H_(t);return n>=0&&r>=0&&n<z_.grid&&r<z_.grid&&V_[r*z_.grid+n]};X_.font=`bold 13px Trebuchet MS, sans-serif`,X_.textAlign=`center`;for(let e of Qp){if(!r(e.x,e.z))continue;let[t,i]=n(e.x,e.z);X_.fillStyle=`rgba(27,26,23,0.75)`,X_.beginPath(),X_.arc(t,i,5,0,Math.PI*2),X_.fill(),X_.fillStyle=`#f6efdf`,X_.fillText(e.name,t,i-10)}for(let e of gg){if(!e.found)continue;let[t,r]=n(e.x,e.z);X_.fillStyle=Qd(e.color),X_.beginPath(),X_.arc(t,r,6,0,Math.PI*2),X_.fill(),X_.fillStyle=`#1b1a17`,X_.fillText(e.n,t,r+4)}let[i,a]=n(Z.position.x,Z.position.z);X_.save(),X_.translate(i,a),X_.rotate(-Y.camYaw),X_.fillStyle=`#8ff5c8`,X_.beginPath(),X_.moveTo(0,-9),X_.lineTo(6,7),X_.lineTo(0,3),X_.lineTo(-6,7),X_.closePath(),X_.fill(),X_.restore()}var ev=J(`map`);function tv(){Y.state===`play`&&(Y.state=`map`,ev.classList.remove(`hidden`),requestAnimationFrame(()=>requestAnimationFrame($_)))}function nv(){ev.classList.add(`hidden`),Y.state===`map`&&(Y.state=`play`)}J(`finder`).addEventListener(`click`,tv),J(`mapClose`).addEventListener(`click`,nv),window.addEventListener(`keydown`,e=>{e.repeat||e.key.toLowerCase()===`m`&&(Y.state===`map`?nv():tv())});var rv=`modulepreload`,iv=function(e,t){return new URL(e,t).href},av={},ov=function(e,t,n){let r=Promise.resolve();if(t&&t.length>0){let e=document.getElementsByTagName(`link`),i=document.querySelector(`meta[property=csp-nonce]`),a=i?.nonce||i?.getAttribute(`nonce`);function o(e){return Promise.all(e.map(e=>Promise.resolve(e).then(e=>({status:`fulfilled`,value:e}),e=>({status:`rejected`,reason:e}))))}function s(e){return import.meta.resolve?import.meta.resolve(e):new URL(e,import.meta.url).href}r=o(t.map(t=>{if(t=iv(t,n),t=s(t),t in av)return;av[t]=!0;let r=t.endsWith(`.css`);for(let n=e.length-1;n>=0;n--){let i=e[n];if(i.href===t&&(!r||i.rel===`stylesheet`))return}let i=document.createElement(`link`);if(i.rel=r?`stylesheet`:rv,r||(i.as=`script`),i.crossOrigin=``,i.href=t,a&&i.setAttribute(`nonce`,a),document.head.appendChild(i),r)return new Promise((e,n)=>{i.addEventListener(`load`,e),i.addEventListener(`error`,()=>n(Error(`Unable to preload CSS for ${t}`)))})}))}function i(e){let t=new Event(`vite:preloadError`,{cancelable:!0});if(t.payload=e,window.dispatchEvent(t),!t.defaultPrevented)throw e}return r.then(t=>{for(let e of t||[])e.status===`rejected`&&i(e.reason);return e().catch(i)})};for(let e in mf.items)mf.items[e]===`bought`&&w_(`item`,e);$h();var sv=new _c,cv=new z,{player:lv,camera:uv,orbs:dv,ceremony:fv,dayNight:pv}=q;Y.camPitch=uv.pitch,Pg(mf.camDist??uv.distance);var mv=0;Yp().then(()=>{Lm(Y.worldSeed),Sg(),a_()}).catch(e=>console.error(`the valley could not be built:`,e)),Zm(),Ym(),hh(),pg(ef),yf(_f.CRAWL_TOGGLE,()=>{Y.state===`play`&&(Y.crawling=!Y.crawling,Yh(Y.crawling),sg(Y.crawling?`Crawling. Slower, and harder to hear.`:`Standing.`,1.6))}),yf(_f.JUMP,()=>{Y.state!==`play`||Y.airborne||Y.crawling||(Y.airborne=!0,Y.vy=q.player.jumpSpeed,Y.airY=hm(Z.position.x,Z.position.z),Xh(!0),navigator.vibrate&&navigator.vibrate(12))}),yf(_f.WHISTLE,()=>{if(Y.state!==`play`||Y.whistleCd>0)return;let e=q.wanderers;Y.whistleT=e.whistleSeconds,Y.whistleCd=e.whistleCooldown,sg(`You whistle. It carries.`,1.8),navigator.vibrate&&navigator.vibrate([15,40,15])}),new URLSearchParams(location.search).has(`tune`)&&ov(()=>import(`./tuner-DoYOLxQV.js`).then(e=>e.initTuner()),[],import.meta.url).catch(e=>console.error(`tuner failed to load:`,e));function hv(){if(!mf.wishes.length)return;let e=Math.min(...mf.wishes.map(e=>e.cycle)),t=mf.wishes.filter(t=>t.cycle===e),n=t[Math.random()*t.length|0];dg(p_(n.text,mf.cycles-n.cycle))}J(`startBtn`).addEventListener(`click`,()=>{J(`start`).classList.add(`hidden`),Y.state=`play`,setTimeout(hv,2200)});function gv(e,t,n,r,i){let a=Z.position.x,o=Z.position.z,s=n;for(let c of Zp){if(c.r<uv.blockRadius)continue;let l=c.x-a,u=c.z-o,d=l*e+u*t;if(d<=.5||d-c.r>s)continue;let f=c.r+uv.clearance,p=Math.abs(l*t-u*e);if(p>=f)continue;let m=n>.01?d/n:0;r+(i-r)*m>c.top+uv.overClearance||(s=Math.min(s,d-Math.sqrt(f*f-p*p)))}return Math.max(Math.min(uv.minClear,n),s)}function _v(){requestAnimationFrame(_v),sv.update();let e=Math.min(sv.getDelta(),q.loop.maxDelta);Y.t+=e;let t=Eg.x,n=Eg.y;if((Og.w||Og.arrowup)&&(n=-1),(Og.s||Og.arrowdown)&&(n=1),(Og.a||Og.arrowleft)&&(t=-1),(Og.d||Og.arrowright)&&(t=1),Og.q&&(Y.camYaw+=uv.turnSpeed*e),Og.e&&(Y.camYaw-=uv.turnSpeed*e),Og.r||Og.f){let t=+!!Og.f-!!Og.r;Y.camPitch=Math.max(uv.pitchMin,Math.min(uv.pitchMax,Y.camPitch+t*uv.pitchKeySpeed*e))}let r=ff(),i=-r.z,a=r.x,o=Y.night;if(Y.night+=(Y.nightTarget-Y.night)*Math.min(1,e*pv.easeRate),(Math.abs(Y.night-o)>.001||Y.t<.2)&&Jm(Y.night),tf.fog.color.copy(nf).lerp(rf,Y.night),$m(Y.night),Zh.lantern?.visible&&(Zh.lanternLight.intensity=pv.lanternBase+Y.night*pv.lanternNightBoost),Qm(Z.position.x,Z.position.y,Z.position.z),Y.whistleT>0&&(Y.whistleT=Math.max(0,Y.whistleT-e)),Y.whistleCd>0&&(Y.whistleCd=Math.max(0,Y.whistleCd-e)),Y.state===`play`){let o=Math.hypot(t,n),s=!1;if(o>.08){let c=Fm(Z.position.x,Z.position.z),l=Math.min(o,1)*(Cf(`boots`)?lv.bootsMultiplier:1)*(Y.crawling?lv.crawlSpeedMultiplier:1)*(c?q.water.wadeSpeed:1),u=r.x*-n+i*t,d=r.z*-n+a*t,f=Math.hypot(u,d)||1;Z.position.x+=u/f*lv.speed*l*e,Z.position.z+=d/f*lv.speed*l*e,Z.rotation.y=Math.atan2(u,d),mv+=e*lv.bobRate*l,s=!0}let c=Math.hypot(Z.position.x,Z.position.z);c>Xp&&(Z.position.x*=Xp/c,Z.position.z*=Xp/c);for(let e of Zp){if(Z.position.y>e.top+lv.jumpClearance)continue;let t=Z.position.x-e.x,n=Z.position.z-e.z,r=Math.hypot(t,n),i=e.r+lv.radius;r<i&&r>1e-4&&(Z.position.x=e.x+t/r*i,Z.position.z=e.z+n/r*i)}let l=hm(Z.position.x,Z.position.z);Y.airborne?(Y.vy-=lv.gravity*e,Y.airY+=Y.vy*e,Y.airY<=l&&(Y.airY=l,Y.vy=0,Y.airborne=!1,Xh(!1),navigator.vibrate&&navigator.vibrate(18)),Z.position.y=Y.airY):Z.position.y=l+Math.abs(Math.sin(mv))*lv.bobHeight,Y.airborne||(Bh.rotation.x=s?Math.sin(mv)*.6:0,Vh.rotation.x=s?-Math.sin(mv)*.6:0,Uh.position.z=Math.sin(Bh.rotation.x)*.3,Wh.position.z=Math.sin(Vh.rotation.x)*.3,qh.rotation.x=s?-Math.sin(mv)*.5:0,Jh.rotation.x=s?Math.sin(mv)*.5:0);for(let t of gg)t.found||(t.mesh.position.y=hm(t.x,t.z)+1.1+Math.sin(Y.t*2+t.phase)*.25,t.mesh.rotation.y+=e,Math.hypot(t.x-Z.position.x,t.z-Z.position.z)<dv.pickupRadius&&Cg(t));for(let t=C_.length-1;t>=0;t--){let n=C_[t];n.g.position.y=hm(n.g.position.x,n.g.position.z)+.7+Math.sin(Y.t*2.5+n.phase)*.15,n.g.rotation.y+=e*1.2,Math.hypot(n.g.position.x-Z.position.x,n.g.position.z-Z.position.z)<1.5&&T_(n,t)}c_(e)}if(yg(),Gh.forEach((e,t)=>{let n=t+1;e.position.set(Math.sin(Y.t*3-n*.6)*.06*n,.35+n*.06+Math.sin(Y.t*2+n)*.02,-.38-n*.09)}),Zh.charm&&(Zh.charm.rotation.z+=e*1.5),Y.state===`duel`){y_(e);let t=Q.w,n=t.g.position.x-Z.position.x,r=t.g.position.z-Z.position.z;Z.rotation.y=Math.atan2(n,r),t.g.rotation.y=Math.atan2(-n,-r),t.g.position.y=Q.over?0:Math.abs(Math.sin(Y.t*14))*.08}if(Y.state===`ending`){Y.endT+=e;let t=Math.min(Y.endT/fv.riseSeconds,1);if(M_.forEach(({m:e,i:n})=>{let r=n/7*Math.PI*2+Y.endT*1.2;e.position.set(Z.position.x+Math.cos(r)*(1.5+2*t),1.5+5*t+Math.sin(Y.endT*3+n)*.2,Z.position.z+Math.sin(r)*(1.5+2*t))}),Y.endT>fv.keeperGrowDelay&&A_.scale.setScalar(.001+Math.min((Y.endT-fv.keeperGrowDelay)/fv.keeperGrowSeconds,1)),Y.endT>fv.wishPromptAt){Y.state=`wish`,J(`wish`).classList.remove(`hidden`);let e=document.querySelector(`.wishInput`);e&&e.focus()}}if(Y.state===`wish`&&M_.forEach(({m:e,i:t})=>{let n=t/7*Math.PI*2+Y.t*1.2;e.position.set(Z.position.x+Math.cos(n)*3.5,6.5+Math.sin(Y.t*3+t)*.2,Z.position.z+Math.sin(n)*3.5)}),Y.ceremony&&j_.built&&P_(e),Y.departT>=0){Y.departT+=e;let t=Math.min(Y.departT/fv.departSeconds,1);A_.position.y+=e*6*t,A_.scale.setScalar(1-t*.9),Y.departT>=fv.departSeconds&&(tf.remove(A_),Y.departT=-1,Y.ceremony=!1,Y.nightTarget=0,Y.respawnT=fv.respawnSeconds,J(`hint`).style.opacity=.75)}Y.respawnT>0&&(Y.respawnT-=e,Y.respawnT<=0&&(Y.respawnT=-1,Y.worldSeed=Xd(),Lm(Y.worldSeed),G_(),Sg(),a_(),sg(`The valley has shifted, and the seven orbs are scattered again`,3.5),setTimeout(hv,3600)));let s=Y.state===`ending`||Y.state===`wish`,c=s?uv.cinematicDistance:Y.camDist,l=Y.camPitch,u=s?uv.cinematicLookAt:uv.lookAtHeight,d=Math.min(1,e*uv.ease),f=Math.cos(l)*c,p=hm(Z.position.x,Z.position.z),m=Math.sin(Y.camYaw),h=Math.cos(Y.camYaw),g=p+u,_=gv(m,h,f,g,g+Math.sin(l)*c),v=f>.01?_/f:1,y=Z.position.x+m*_,b=Z.position.z+h*_,x=hm(y,b),S=p+u+Math.sin(l)*c*v,C=Math.max(S,x+uv.minHeight),w=u+Math.max(0,-l)*c*uv.lookUpGain;af.position.x+=(y-af.position.x)*d,af.position.z+=(b-af.position.z)*d,af.position.y+=(C-af.position.y)*d,cv.set(Z.position.x,p+w,Z.position.z),af.lookAt(cv),W_(e),cg(e),k_(e,r.x,r.z,i,a),gh()}_v(),window.addEventListener(`resize`,()=>{ef.setSize(innerWidth,innerHeight),_h(innerWidth,innerHeight),af.aspect=innerWidth/innerHeight,af.updateProjectionMatrix()});export{q as t};