...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function Gs(e,t,n){let r=new Float32Array(js),i=new z(0,1,0);return new Wa({name:`SphericalGaussianBlur`,defines:{n:js,CUBEUV_TEXEL_WIDTH:1/t,CUBEUV_TEXEL_HEIGHT:1/n,CUBEUV_MAX_MIP:`${e}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:r},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:i}},vertexShader:Js(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function qs(){return new Wa({name:`CubemapToCubeUV`,uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:Js(),fragmentShader:`
	...
	`}var Ys=class extends $t{constructor(e=1,t={}){super(e,e,t),this.isWebGLCubeRenderTarget=!0;let n={width:e,height:e,depth:1},r=[n,n,n,n,n,n];this.texture=new Sa(r),this._setTextureOptions(t),this.texture.isRenderTargetTexture=!0}fromEquirectangularTexture(e,t){this.texture.type=t.type,this.texture.colorSpace=t.colorSpace,this.texture.generateMipmaps=t.generateMipmaps,this.texture.minFilter=t.minFilter,this.texture.magFilter=t.magFilter;let n={uniforms:{tEquirect:{value:null}},vertexShader:`
...
`)}var bl={1:`Linear`,2:`Reinhard`,3:`Cineon`,4:`ACESFilmic`,6:`AgX`,7:`Neutral`,5:`Custom`};function xl(e,t){let n=bl[t];return n===void 0?(F(`WebGLProgram: Unsupported toneMapping:`,t),`vec3 `+e+`( vec3 color ) { return LinearToneMapping( color ); }`):`vec3 `+e+`( vec3 color ) { return `+n+`ToneMapping( color ); }`}var Sl=new z;function Cl(){return Bt.getLuminanceCoefficients(Sl),[`float luminance( const in vec3 rgb ) {`,`	const vec3 weights = vec3( ${Sl.x.toFixed(4)}, ${Sl.y.toFixed(4)}, ${Sl.z.toFixed(4)} );`,`	return dot( weights, rgb );`,`}`].join(`
...
void main() {
	...
	if ( coord.x >= 1.0 ) {
		...
		}`},Vm=class{constructor(){this.isPass=!0,this.enabled=!0,this.needsSwap=!0,this.clear=!1,this.renderToScreen=!1}setSize(){}render(){console.error(`THREE.Pass: .render() must be implemented in derived pass.`)}dispose(){}},Hm=new Go(-1,1,1,-1,0,1),Um=new class extends Nr{constructor(){super(),this.setAttribute(`position`,new xr([-1,3,0,-1,-1,0,3,-1,0],3)),this.setAttribute(`uv`,new xr([0,2,0,0,2,0],2))}},Wm=class{constructor(e){this._mesh=new U(Um,e)}dispose(){this._mesh.geometry.dispose()}render(e){e.render(this._mesh,Hm)}get material(){return this._mesh.material}set material(e){this._mesh.material=e}},Gm=class extends Vm{constructor(e,t=`tDiffuse`){super(),this.textureID=t,this.uniforms=null,this.material=null,e instanceof Wa?(this.uniforms=e.uniforms,this.material=e):e&&(this.uniforms=Va.clone(e.uniforms),this.material=new Wa({name:e.name===void 0?`unspecified`:e.name,defines:Object.assign({},e.defines),uniforms:this.uniforms,vertexShader:e.vertexShader,fragmentShader:e.fragmentShader})),this._fsQuad=new Wm(this.material)}render(e,t,n){this.uniforms[this.textureID]&&(this.uniforms[this.textureID].value=n.texture),this._fsQuad.material=this.material,this.renderToScreen?(e.setRenderTarget(null),this._fsQuad.render(e)):(e.setRenderTarget(t),this.clear&&e.clear(e.autoClearColor,e.autoClearDepth,e.autoClearStencil),this._fsQuad.render(e))}dispose(){this.material.dispose(),this._fsQuad.dispose()}},Km=class extends Vm{constructor(e,t){super(),this.scene=e,this.camera=t,this.clear=!0,this.needsSwap=!1,this.inverse=!1}render(e,t,n){let r=e.getContext(),i=e.state;i.buffers.color.setMask(!1),i.buffers.depth.setMask(!1),i.buffers.color.setLocked(!0),i.buffers.depth.setLocked(!0);let a,o;this.inverse?(a=0,o=1):(a=1,o=0),i.buffers.stencil.setTest(!0),i.buffers.stencil.setOp(r.REPLACE,r.REPLACE,r.REPLACE),i.buffers.stencil.setFunc(r.ALWAYS,a,4294967295),i.buffers.stencil.setClear(o),i.buffers.stencil.setLocked(!0),e.setRenderTarget(n),this.clear&&e.clear(),e.render(this.scene,this.camera),e.setRenderTarget(t),this.clear&&e.clear(),e.render(this.scene,this.camera),i.buffers.color.setLocked(!1),i.buffers.depth.setLocked(!1),i.buffers.color.setMask(!0),i.buffers.depth.setMask(!0),i.buffers.stencil.setLocked(!1),i.buffers.stencil.setFunc(r.EQUAL,1,4294967295),i.buffers.stencil.setOp(r.KEEP,r.KEEP,r.KEEP),i.buffers.stencil.setLocked(!0)}},qm=class extends Vm{constructor(){super(),this.needsSwap=!1}render(e){e.state.buffers.stencil.setLocked(!1),e.state.buffers.stencil.setTest(!1)}},Jm=class{constructor(e,t){if(this.renderer=e,this._pixelRatio=e.getPixelRatio(),t===void 0){let n=e.getSize(new R);this._width=n.width,this._height=n.height,t=new $t(this._width*this._pixelRatio,this._height*this._pixelRatio,{type:_}),t.texture.name=`EffectComposer.rt1`}else this._width=t.width,this._height=t.height;this.renderTarget1=t,this.renderTarget2=t.clone(),this.renderTarget2.texture.name=`EffectComposer.rt2`,this.writeBuffer=this.renderTarget1,this.readBuffer=this.renderTarget2,this.renderToScreen=!0,this.passes=[],this.copyPass=new Gm(Bm),this.copyPass.material.blending=0,this.timer=new ns}swapBuffers(){let e=this.readBuffer;this.readBuffer=this.writeBuffer,this.writeBuffer=e}addPass(e){this.passes.push(e),e.setSize(this._width*this._pixelRatio,this._height*this._pixelRatio)}insertPass(e,t){this.passes.splice(t,0,e),e.setSize(this._width*this._pixelRatio,this._height*this._pixelRatio)}removePass(e){let t=this.passes.indexOf(e);t!==-1&&this.passes.splice(t,1)}isLastEnabledPass(e){for(let t=e+1;t<this.passes.length;t++)if(this.passes[t].enabled)return!1;return!0}render(e){this.timer.update(),e===void 0&&(e=this.timer.getDelta());let t=this.renderer.getRenderTarget(),n=!1;for(let t=0,r=this.passes.length;t<r;t++){let r=this.passes[t];if(r.enabled!==!1){if(r.renderToScreen=this.renderToScreen&&this.isLastEnabledPass(t),r.render(this.renderer,this.writeBuffer,this.readBuffer,e,n),r.needsSwap){if(n){let t=this.renderer.getContext(),n=this.renderer.state.buffers.stencil;n.setFunc(t.NOTEQUAL,1,4294967295),this.copyPass.render(this.renderer,this.writeBuffer,this.readBuffer,e),n.setFunc(t.EQUAL,1,4294967295)}this.swapBuffers()}Km!==void 0&&(r instanceof Km?n=!0:r instanceof qm&&(n=!1))}}this.renderer.setRenderTarget(t)}reset(e){if(e===void 0){let t=this.renderer.getSize(new R);this._pixelRatio=this.renderer.getPixelRatio(),this._width=t.width,this._height=t.height,e=this.renderTarget1.clone(),e.setSize(this._width*this._pixelRatio,this._height*this._pixelRatio)}this.renderTarget1.dispose(),this.renderTarget2.dispose(),this.renderTarget1=e,this.renderTarget2=e.clone(),this.writeBuffer=this.renderTarget1,this.readBuffer=this.renderTarget2}setSize(e,t){this._width=e,this._height=t;let n=this._width*this._pixelRatio,r=this._height*this._pixelRatio;this.renderTarget1.setSize(n,r),this.renderTarget2.setSize(n,r);for(let e=0;e<this.passes.length;e++)this.passes[e].setSize(n,r)}setPixelRatio(e){this._pixelRatio=e,this.setSize(this._width,this._height)}dispose(){this.renderTarget1.dispose(),this.renderTarget2.dispose(),this.copyPass.dispose()}},Ym=class extends Vm{constructor(e,t,n=null,r=null,i=null){super(),this.scene=e,this.camera=t,this.overrideMaterial=n,this.clearColor=r,this.clearAlpha=i,this.clear=!0,this.clearDepth=!1,this.needsSwap=!1,this.isRenderPass=!0,this._oldClearColor=new H}render(e,t,n){let r=e.autoClear;e.autoClear=!1;let i,a;this.overrideMaterial!==null&&(a=this.scene.overrideMaterial,this.scene.overrideMaterial=this.overrideMaterial),this.clearColor!==null&&(e.getClearColor(this._oldClearColor),e.setClearColor(this.clearColor,e.getClearAlpha())),this.clearAlpha!==null&&(i=e.getClearAlpha(),e.setClearAlpha(this.clearAlpha)),this.clearDepth==1&&e.clearDepth(),e.setRenderTarget(this.renderToScreen?null:n),this.clear===!0&&e.clear(e.autoClearColor,e.autoClearDepth,e.autoClearStencil),e.render(this.scene,this.camera),this.clearColor!==null&&e.setClearColor(this._oldClearColor),this.clearAlpha!==null&&e.setClearAlpha(i),this.overrideMaterial!==null&&(this.scene.overrideMaterial=a),e.autoClear=r}},Xm={name:`LuminosityHighPassShader`,uniforms:{tDiffuse:{value:null},luminosityThreshold:{value:1},smoothWidth:{value:1},defaultColor:{value:new H(0)},defaultOpacity:{value:0}},vertexShader:`
		...
		void main() {
			...
			gl_FragColor = mix( outputColor, texel, alpha );
				...
				}`})}};Zm.BlurDirectionX=new R(1,0),Zm.BlurDirectionY=new R(0,1);var Qm={name:`OutputShader`,uniforms:{tDiffuse:{value:null},toneMappingExposure:{value:1}},vertexShader:`
		precision highp float;
		...
		}`},$m=class extends Vm{constructor(){super(),this.isOutputPass=!0,this.uniforms=Va.clone(Qm.uniforms),this.material=new Ga({name:Qm.name,uniforms:this.uniforms,vertexShader:Qm.vertexShader,fragmentShader:Qm.fragmentShader}),this._fsQuad=new Wm(this.material),this._outputColorSpace=null,this._toneMapping=null}render(e,t,n){this.uniforms.tDiffuse.value=n.texture,this.uniforms.toneMappingExposure.value=e.toneMappingExposure,(this._outputColorSpace!==e.outputColorSpace||this._toneMapping!==e.toneMapping)&&(this._outputColorSpace=e.outputColorSpace,this._toneMapping=e.toneMapping,this.material.defines={},Bt.getTransfer(this._outputColorSpace)===`srgb`&&(this.material.defines.SRGB_TRANSFER=``),this._toneMapping===1?this.material.defines.LINEAR_TONE_MAPPING=``:this._toneMapping===2?this.material.defines.REINHARD_TONE_MAPPING=``:this._toneMapping===3?this.material.defines.CINEON_TONE_MAPPING=``:this._toneMapping===4?this.material.defines.ACES_FILMIC_TONE_MAPPING=``:this._toneMapping===6?this.material.defines.AGX_TONE_MAPPING=``:this._toneMapping===7?this.material.defines.NEUTRAL_TONE_MAPPING=``:this._toneMapping===5&&(this.material.defines.CUSTOM_TONE_MAPPING=``),this.material.needsUpdate=!0),this.renderToScreen===!0?(e.setRenderTarget(null),this._fsQuad.render(e)):(e.setRenderTarget(t),this.clear&&e.clear(e.autoClearColor,e.autoClearDepth,e.autoClearStencil),this._fsQuad.render(e))}dispose(){this.material.dispose(),this._fsQuad.dispose()}},eh=null;function th(){if(!K.bloom.enabled)return!1;eh=new Jm(qd),eh.addPass(new Ym(Jd,Zd));let e=new Zm(new R(innerWidth,innerHeight),K.bloom.strength,K.bloom.radius,K.bloom.threshold);return eh.addPass(e),eh.addPass(new $m),qd.info.autoReset=!1,!0}var nh=!1;function rh(e){nh=!e}function ih(){eh&&!nh?(qd.info.reset(),eh.render()):(qd.info.autoReset||qd.info.reset(),qd.render(Jd,Zd))}function ah(e,t){eh&&eh.setSize(e,t)}var oh={ORBS_ALL_FOUND:`orbs:all-found`,DUEL_CHALLENGE:`duel:challenge`,ITEM_BOUGHT:`shop:item-bought`,WISHES_ALL_COLLECTED:`wishes:all-collected`,CRAWL_TOGGLE:`player:crawl-toggle`,WHISTLE:`player:whistle`,LOADOUT_CHANGED:`loadout:changed`,JUMP:`player:jump`},sh=new Map;function ch(e,t){return sh.has(e)||sh.set(e,new Set),sh.get(e).add(t),()=>lh(e,t)}function lh(e,t){sh.get(e)?.delete(t)}function uh(e,t){let n=sh.get(e);if(!(!n||n.size===0))for(let r of[...n])try{r(t)}catch(t){console.error(`listener for "${e}" threw:`,t)}}var dh=()=>K.loadout.slots,fh=e=>uf(e)&&Y.worn.includes(e),ph=()=>Y.worn.filter(uf),mh=()=>ph().length;function hh(){let e=dh();return e>0?Math.max(0,e-mh()):1/0}function gh(e,t){if(!uf(e))return{ok:!1,worn:!1,reason:`You do not have that.`};let n=fh(e);if(t&&!n){if(hh()<=0)return{ok:!1,worn:!1,reason:`You can only carry ${dh()}. Take something off first.`};Y.worn.push(e)}else if(!t&&n)Y.worn=Y.worn.filter(t=>t!==e);else return{ok:!0,worn:n,reason:``};return lf(),uh(oh.LOADOUT_CHANGED,e),{ok:!0,worn:t,reason:``}}var _h=e=>gh(e,!fh(e));function vh(e){return gh(e,!0).worn}var Z=new An,yh=new An;yh.position.y=.3,Z.add(yh);var bh=Sd,xh=wd,Sh=tf(bh),Ch=tf(Td),wh=tf(Ed),Th=new U(new ka(.34,.4,.85,10),Sh);Th.position.y=.55;var Eh=new U(new Fa(.36,.06,8,18),tf(Cd));Eh.rotation.x=Math.PI/2,Eh.position.y=.42;var Dh=new U(new Pa(.34,16,12),Ch);Dh.position.y=1.32;var Oh=new U(new Pa(.36,16,12,0,Math.PI*2,0,Math.PI*.62),Sh);Oh.position.y=1.33;var kh=new U(new Pa(.24,12,10),wh);kh.scale.set(1,.85,.6),kh.position.set(0,1.26,.22);var Ah=new U(new Pa(.14,10,8),wh);Ah.position.set(0,1.19,.36);var jh=new Pa(.045,8,8),Mh=tf(Vu),Nh=new U(jh,Mh),Ph=new U(jh,Mh);Nh.position.set(-.09,1.31,.42),Ph.position.set(.09,1.31,.42);var Fh=new Pa(.11,10,8),Ih=new U(Fh,Ch),Lh=new U(Fh,Ch);Ih.position.set(-.36,1.36,.02),Lh.position.set(.36,1.36,.02);var Rh=new U(new Fa(.35,.035,6,20),tf(Cd));Rh.rotation.x=Math.PI/2,Rh.position.y=1.44;var zh=new U(new Da(.08,.45,.03),tf(Cd));zh.position.set(.12,1.2,-.36),zh.rotation.z=.3;var Bh=new ka(.08,.09,.6,8),Vh=new U(Bh,Sh),Hh=new U(Bh,Sh);Vh.position.set(-.42,.6,0),Hh.position.set(.42,.6,0);var Uh=new Pa(.09,8,8),Wh=new U(Uh,Ch),Gh=new U(Uh,Ch);Wh.position.set(-.42,.28,0),Gh.position.set(.42,.28,0);var Kh=[];for(let e=0;e<6;e++){let t=new U(new Pa(.075-e*.006,8,6),Ch);yh.add(t),Kh.push(t)}var qh=[Dh,kh,Ah,Nh,Ph,Ih,Lh,Rh,zh,Eh];yh.add(new U(Gf(qh.map(nf),!1),rf),Th,Oh,Vh,Hh,Wh,Gh);function Jh(e){let t=new An;t.position.set(e*.15,.46,0);let n=new U(new ka(.1,.11,.44,8),Sh);n.position.y=-.22;let r=new U(new Da(.17,.1,.28),Ch);return r.position.set(0,-.44,.05),t.add(n,r),Z.add(t),t}var Yh=Jh(-1),Xh=Jh(1);Z.traverse(e=>{e.isMesh&&(e.castShadow=!0,e.receiveShadow=!0)}),Jd.add(Z);function Zh(e){yh.position.y=e?.02:.3,yh.rotation.x=e?1.15:0,Yh.rotation.z=e?-.35:0,Xh.rotation.z=e?.35:0}function Qh(e){Yh.rotation.x=e?-.7:0,Xh.rotation.x=e?-.4:0,Vh.rotation.x=e?-1.5:0,Hh.rotation.x=e?-1.5:0}var $h={};function eg(){if($h.built)return;$h.built=!0;let e=new An,t=new U(new ka(.62,.62,.04,16),tf(Dd));t.position.y=1.62;let n=new U(new Aa(.42,.32,16),tf(Od));n.position.y=1.78,e.add(t,n),yh.add(e),$h.hat=e;let r=new An,i=new U(new ka(.1,.12,.22,8),tf(Bu)),a=new U(new Pa(.07,8,8),af(Hu[2])),o=of(kd,0,9);o.position.y=.3,r.add(i,a,o),r.position.set(.55,.22,.12),yh.add(r),$h.lantern=r,$h.lanternLight=o;let s=new U(new Fa(.55,.03,6,30),af(Bu));s.rotation.x=Math.PI/2,s.position.y=.5,yh.add(s),$h.charm=s}function tg(){eg(),Sh.color.set(fh(`cloak`)?xh:bh),$h.hat.visible=fh(`hat`),$h.lantern.visible=fh(`lantern`),$h.charm.visible=fh(`charm`)}ch(oh.LOADOUT_CHANGED,tg);var ng=q(`pouch`),rg=q(`fragCount`);function ig(){rg.textContent=Y.fragments,ng.setAttribute(`aria-label`,Y.fragments+` fragments. Open the trader.`)}function ag(e){e.classList.remove(`bump`),e.offsetWidth,e.classList.add(`bump`)}function og(e){Y.fragments+=e,lf(),ig(),ag(ng)}ig();var sg=q(`toast`),cg=0;function lg(e,t=2.2){sg.classList.remove(`echo`),sg.textContent=e,sg.style.opacity=1,cg=t}function ug(e){cg>0&&(cg-=e,cg<=0&&(sg.style.opacity=0))}var dg=document.createElement(`span`);dg.id=`orderTag`,dg.className=`none`,q(`counter`).appendChild(dg);function fg(e,t){if(t===0){dg.className=`none`,dg.textContent=``;return}dg.className=e?`kept`:`broken`,dg.textContent=e?`in order`:`order broken`}function pg(e,t=5){lg(e,t),sg.classList.add(`echo`)}q(`jumpBtn`).addEventListener(`pointerdown`,e=>{e.preventDefault(),uh(oh.JUMP)});var mg=e=>e+([`th`,`st`,`nd`,`rd`][(e%100-20)%10]||[`th`,`st`,`nd`,`rd`][e%100]||`th`);function hg(e){if(!new URLSearchParams(location.search).has(`stats`))return;let t=document.createElement(`div`);t.id=`stats`,document.body.appendChild(t);let n=0,r=performance.now(),i=999;(function a(){requestAnimationFrame(a),n++;let o=performance.now();if(o-r>=500){let a=Math.round(n*1e3/(o-r));a<i&&(i=a),n=0,r=o;let s=e.info.render;t.textContent=`${a} fps (low ${i})  ${s.calls} calls  ${(s.triangles/1e3).toFixed(1)}k tris`}})()}var gg=e=>K.duel.opponentBase+e*K.duel.opponentPerTier;function _g(e,t=Math.random){let n=K.duel,r=t()<n.flawlessChance,i=n.lootBase+e+Math.floor(t()*n.lootVariance);return{loot:r?i*n.flawlessMultiplier:i,flawless:r}}function vg(e={}){let t=K.orbs,{count:n=7,inner:r=t.innerRadius,outer:i=t.outerRadius,minSpacing:a=t.minSpacing,minFromPlayer:o=t.minDistanceFromPlayer,playerX:s=0,playerZ:c=0,attempts:l=4e3,random:u=Math.random}=e,d=i-r,f=[],p=()=>{let e=u()*Math.PI*2,t=r+u()*d;return{x:Math.cos(e)*t,z:Math.sin(e)*t}},m=0;for(;f.length<n&&m++<l;){let e=p();Math.hypot(e.x-s,e.z-c)<o||f.every(t=>Math.hypot(t.x-e.x,t.z-e.z)>=a)&&f.push(e)}for(;f.length<n;)f.push(p());for(let e=f.length-1;e>0;e--){let t=u()*(e+1)|0;[f[e],f[t]]=[f[t],f[e]]}return f}var yg=K.collect,bg=yg.sparks,xg=new Float32Array(bg*3),Sg=new Float32Array(bg*3),Cg=new Float32Array(bg*3),wg=new Nr;wg.setAttribute(`position`,new vr(xg,3)),wg.setAttribute(`color`,new vr(Sg,3));function Tg(){let e=document.createElement(`canvas`);e.width=e.height=64;let t=e.getContext(`2d`),n=t.createRadialGradient(32,32,0,32,32,32);return n.addColorStop(0,`rgba(255,255,255,1)`),n.addColorStop(.35,`rgba(255,255,255,0.85)`),n.addColorStop(1,`rgba(255,255,255,0)`),t.fillStyle=n,t.fillRect(0,0,64,64),new Ca(e)}var Eg=new ha({size:yg.sparkSize,map:Tg(),vertexColors:!0,transparent:!0,opacity:1,blending:1,depthWrite:!1,sizeAttenuation:!0}),Dg=new ba(wg,Eg);Dg.visible=!1,Dg.frustumCulled=!1,Jd.add(Dg);var Og=0,kg=!1,Ag=new H;function jg(e,t,n,r){Ag.setHex(r);for(let r=0;r<bg;r++){let i=r*3;xg[i]=e,xg[i+1]=t,xg[i+2]=n;let a=Math.random()*2-1,o=Math.sqrt(1-a*a),s=Math.random()*Math.PI*2,c=yg.sparkSpeed*(.45+Math.random()*.75),l=.55+o*.45;Cg[i]=Math.cos(s)*l*c,Cg[i+1]=(a*.75+.55)*c,Cg[i+2]=Math.sin(s)*l*c;let u=.7+Math.random()*.45;Sg[i]=Math.min(1,Ag.r*u),Sg[i+1]=Math.min(1,Ag.g*u),Sg[i+2]=Math.min(1,Ag.b*u)}wg.attributes.position.needsUpdate=!0,wg.attributes.color.needsUpdate=!0,Eg.opacity=1,Dg.visible=!0,Og=0,kg=!0}function Mg(e){if(!kg)return;if(Og+=e,Og>=yg.sparkLife){Dg.visible=!1,kg=!1;return}for(let t=0;t<bg;t++){let n=t*3;xg[n]+=Cg[n]*e,xg[n+1]+=Cg[n+1]*e,xg[n+2]+=Cg[n+2]*e,Cg[n+1]-=yg.sparkGravity*e;let r=1-yg.sparkDrag*e;Cg[n]*=r,Cg[n+2]*=r}wg.attributes.position.needsUpdate=!0;let t=Og/yg.sparkLife;Eg.opacity=t<.5?1:1-(t-.5)*2}var Ng=K.camera,Pg=new z,Fg=0,Ig=typeof matchMedia==`function`&&matchMedia(`(prefers-reduced-motion: reduce)`).matches;function Lg(e){J.bench||Ig||(Fg=Math.max(Fg,e))}function Rg(e,t,n,r,i){let a=Z.position.x,o=Z.position.z,s=n;for(let c of om){if(c.r<Ng.blockRadius)continue;let l=c.x-a,u=c.z-o,d=l*e+u*t;if(d<=.5||d-c.r>s)continue;let f=c.r+Ng.clearance,p=Math.abs(l*t-u*e);if(p>=f)continue;let m=n>.01?d/n:0;r+(i-r)*m>c.top+Ng.overClearance||(s=Math.min(s,d-Math.sqrt(f*f-p*p)))}return Math.max(Math.min(Ng.minClear,n),s)}function zg(e){let t=J.state===`ending`||J.state===`wish`,n=t?Ng.cinematicDistance:J.camDist,r=J.camPitch,i=t?Ng.cinematicLookAt:Ng.lookAtHeight,a=Math.min(1,e*Ng.ease),o=Math.cos(r)*n,s=jf(Z.position.x,Z.position.z),c=Math.sin(J.camYaw),l=Math.cos(J.camYaw),u=s+i,d=Rg(c,l,o,u,u+Math.sin(r)*n),f=o>.01?d/o:1,p=Z.position.x+c*d,m=Z.position.z+l*d,h=jf(p,m),g=s+i+Math.sin(r)*n*f,_=Math.max(g,h+Ng.minHeight),v=i+Math.max(0,-r)*n*Ng.lookUpGain;Zd.position.x+=(p-Zd.position.x)*a,Zd.position.z+=(m-Zd.position.z)*a,Zd.position.y+=(_-Zd.position.y)*a,Fg>1e-4&&(Zd.position.x+=(Math.random()*2-1)*Fg,Zd.position.y+=(Math.random()*2-1)*Fg,Zd.position.z+=(Math.random()*2-1)*Fg,Fg-=Fg*Math.min(1,K.collect.shakeDecay*e)),Pg.set(Z.position.x,s+v,Z.position.z),Zd.lookAt(Pg)}var Bg=K.collect,Vg=Hu,Hg=.6,Ug=.18,Wg=new Pa(.55,18,14),Gg=[],Kg=K.orbs.litAtOnce,qg=[];for(let e=0;e<Kg;e++){let e=of(Yu,0,K.orbs.lightRange);e.visible=!1,Jd.add(e),qg.push(e)}var Jg=Array(Kg).fill(null),Yg=new Float32Array(Kg);function Xg(){for(let e=0;e<Kg;e++)Jg[e]=null,Yg[e]=1/0;for(let e of Gg){if(e.found)continue;let t=e.x-Z.position.x,n=e.z-Z.position.z,r=Math.sqrt(t*t+n*n);for(let t=0;t<Kg;t++)if(r<Yg[t]){for(let e=Kg-1;e>t;e--)Yg[e]=Yg[e-1],Jg[e]=Jg[e-1];Yg[t]=r,Jg[t]=e;break}}for(let e=0;e<Kg;e++){let t=qg[e],n=Jg[e];n&&Yg[e]<K.orbs.lightCutoff?(t.visible=!0,t.color.setHex(n.color),t.intensity=K.orbs.lightIntensity,t.position.set(n.x,n.mesh.position.y,n.z)):(t.visible=!1,t.intensity=0)}}for(let e=0;e<7;e++){let t=Vg[e],n=new U(Wg,tf(t,Hg));n.add(new U(new Pa(.9,14,10),af(t,Ug)));let r=document.createElement(`canvas`);r.width=r.height=128;let i=r.getContext(`2d`);i.fillStyle=`#f6efdf`,i.beginPath(),i.arc(64,64,54,0,Math.PI*2),i.fill(),i.lineWidth=8,i.strokeStyle=Gd(t),i.stroke(),i.fillStyle=`#1b1a17`,i.font=`bold 72px Trebuchet MS, sans-serif`,i.textAlign=`center`,i.textBaseline=`middle`,i.fillText(String(e+1),64,68);let a=new $r(new zr({map:new Ca(r),transparent:!0}));a.position.y=1.35,a.scale.setScalar(.8),n.add(a),Gg.push({x:0,z:0,mesh:n,color:t,found:!1,phase:Math.random()*6,n:e+1})}var Zg=q(`counter`),Qg=Gg.map(e=>{let t=document.createElement(`i`);return t.textContent=e.n,t.style.setProperty(`--c`,Gd(e.color)),Zg.appendChild(t),t});function $g(e=Math.random){J.found=0,J.orderKept=!0;let t=vg({playerX:Z.position.x,playerZ:Z.position.z,random:e});Gg.forEach((e,n)=>{e.x=t[n].x,e.z=t[n].z,e.found=!1,e.mesh.position.set(e.x,jf(e.x,e.z)+1.1,e.z),t_(e),Jd.add(e.mesh),Qg[n].classList.remove(`on`)}),fg(!0,0)}$g();var e_=[];function t_(e){e.mesh.scale.setScalar(1),e.mesh.material.emissiveIntensity=Hg,e.mesh.children[0].material.opacity=Ug,e.mesh.children[0].scale.setScalar(1)}function n_(e){e_.push({o:e,age:0})}function r_(e){for(let t=e_.length-1;t>=0;t--){let n=e_[t];n.age+=e;let r=n.age/Bg.orbFlare;if(r>=1){Jd.remove(n.o.mesh),t_(n.o),e_.splice(t,1);continue}let i=.3,a=r<i?1+(Bg.orbPop-1)*(r/i):Bg.orbPop*(1-(r-i)/.7)**2;n.o.mesh.scale.setScalar(Math.max(1e-4,a)),n.o.mesh.position.y+=Bg.orbRise*e,n.o.mesh.material.emissiveIntensity=Hg*(1+(Bg.orbFlash-1)*(1-r));let o=n.o.mesh.children[0];o.scale.setScalar(1+r*1.6),o.material.opacity=Ug*(1-r)}}function i_(e){e.n!==J.found+1&&J.orderKept?(J.orderKept=!1,lg(`Order broken at ${e.n}. One wish.`)):J.found<6&&lg(J.orderKept?`Orb ${e.n} found, in order. ${J.found+1} of 7`:`Orb ${e.n} found. ${J.found+1} of 7`),e.found=!0,J.found++,n_(e),jg(e.mesh.position.x,e.mesh.position.y,e.mesh.position.z,e.color),Lg(Bg.shake),Qg[Gg.indexOf(e)].classList.add(`on`),navigator.vibrate&&navigator.vibrate(40),fg(J.orderKept,J.found),J.found===7&&(lg(J.orderKept?`All seven, in perfect order`:`All seven gathered`),uh(oh.ORBS_ALL_FOUND))}var a_=q(`stick`),o_=q(`knob`),s_={active:!1,id:null,cx:0,cy:0,x:0,y:0},c_={active:!1,id:null,lastX:0,lastY:0},l_={},u_=55,d_=new Map,f_={active:!1,candidate:!1,a:null,b:null,gap0:0,gap:0,dist0:0},p_=(e,t)=>Math.hypot(e.x-t.x,e.y-t.y),m_=()=>s_.active?Math.hypot(s_.x,s_.y):0;function h_(e){let t=K.camera;J.camDist=Math.max(t.minDistance,Math.min(t.maxDistance,e))}var g_=0;function __(){clearTimeout(g_),g_=setTimeout(()=>{Y.camDist=J.camDist,lf()},250)}function v_(){s_.active=!1,s_.x=s_.y=0,a_.style.display=`none`}function y_(){if(f_.active||f_.candidate)return;let e=[...d_.keys()];e.length<2||(f_.candidate=!0,[f_.a,f_.b]=e,f_.gap0=p_(d_.get(f_.a),d_.get(f_.b)))}function b_(e){f_.active=!0,f_.candidate=!1,v_(),c_.active=!1,f_.gap=e,f_.dist0=J.camDist}function x_(){let e=f_.active;f_.active=f_.candidate=!1,f_.a=f_.b=null,e&&__();let t=[...d_.keys()];if(e&&t.length===1){let e=d_.get(t[0]);c_.active=!0,c_.id=t[0],c_.lastX=e.x,c_.lastY=e.y}}function S_(e){d_.set(e.identifier,{x:e.clientX,y:e.clientY}),y_(),e.clientX<innerWidth*.5&&!s_.active?(s_.active=!0,s_.id=e.identifier,s_.cx=e.clientX,s_.cy=e.clientY,s_.x=s_.y=0,a_.style.display=`block`,a_.style.left=s_.cx+`px`,a_.style.top=s_.cy+`px`,o_.style.transform=`translate(-50%,-50%)`):c_.active||(c_.active=!0,c_.id=e.identifier,c_.lastX=e.clientX,c_.lastY=e.clientY)}function C_(e){let t=d_.get(e.identifier);if(t&&(t.x=e.clientX,t.y=e.clientY),(f_.active||f_.candidate)&&(e.identifier===f_.a||e.identifier===f_.b)){let e=d_.get(f_.a),t=d_.get(f_.b);if(e&&t){let n=p_(e,t);if(f_.candidate){let e=K.camera;Math.abs(n-f_.gap0)>e.pinchThreshold&&m_()<e.pinchJoyTolerance&&b_(n)}if(f_.active){n>1&&h_(f_.dist0*(f_.gap/n));return}}}if(s_.active&&e.identifier===s_.id){let t=e.clientX-s_.cx,n=e.clientY-s_.cy,r=Math.hypot(t,n);r>u_&&(t*=u_/r,n*=u_/r),s_.x=t/u_,s_.y=n/u_,o_.style.transform=`translate(calc(-50% + ${t}px), calc(-50% + ${n}px))`}else if(c_.active&&e.identifier===c_.id){let t=K.camera;J.camYaw-=(e.clientX-c_.lastX)*t.dragSensitivity;let n=(e.clientY-c_.lastY)*t.dragSensitivityY*(t.invertY?-1:1);J.camPitch=Math.max(t.pitchMin,Math.min(t.pitchMax,J.camPitch+n)),c_.lastX=e.clientX,c_.lastY=e.clientY}}function w_(e){d_.delete(e.identifier),(f_.active||f_.candidate)&&(e.identifier===f_.a||e.identifier===f_.b)&&x_(),s_.active&&e.identifier===s_.id&&(s_.active=!1,s_.x=s_.y=0,a_.style.display=`none`),c_.active&&e.identifier===c_.id&&(c_.active=!1)}Kd.addEventListener(`touchstart`,e=>{e.preventDefault();for(let t of e.changedTouches)S_(t)},{passive:!1}),Kd.addEventListener(`touchmove`,e=>{e.preventDefault();for(let t of e.changedTouches)C_(t)},{passive:!1}),Kd.addEventListener(`touchend`,e=>{for(let t of e.changedTouches)w_(t)}),Kd.addEventListener(`touchcancel`,e=>{for(let t of e.changedTouches)w_(t)}),Kd.addEventListener(`wheel`,e=>{e.preventDefault(),h_(J.camDist*Math.exp(e.deltaY*K.camera.wheelStep)),__()},{passive:!1}),Kd.addEventListener(`mousedown`,e=>S_({clientX:e.clientX,clientY:e.clientY,identifier:`m`})),window.addEventListener(`mousemove`,e=>C_({clientX:e.clientX,clientY:e.clientY,identifier:`m`})),window.addEventListener(`mouseup`,()=>w_({identifier:`m`})),window.addEventListener(`keydown`,e=>{let t=e.key.toLowerCase();e.repeat||(t===`c`&&uh(oh.CRAWL_TOGGLE),t===`v`&&uh(oh.WHISTLE),t===` `&&uh(oh.JUMP)),t===` `&&e.preventDefault(),l_[t]=!0}),window.addEventListener(`keyup`,e=>l_[e.key.toLowerCase()]=!1);var T_=[{name:`Bram the Woodcutter`,short:`Bram`,color:Md.bram.coat,hat:Md.bram.hat,skin:Md.bram.skin,build:1.1,headwear:`cap`,prop:`axe`},{name:`Nell the Herbalist`,short:`Nell`,color:Md.nell.coat,hat:Md.nell.hat,skin:Md.nell.skin,build:.92,headwear:`kerchief`,prop:`basket`},{name:`Pip the Courier`,short:`Pip`,color:Md.pip.coat,hat:Md.pip.hat,skin:Md.pip.skin,build:.85,headwear:`cap`,prop:`satchel`},{name:`Marla Stonehand`,short:`Marla`,color:Md.marla.coat,hat:Md.marla.hat,skin:Md.marla.skin,build:1.18,headwear:`none`,prop:`hammer`},{name:`Old Tarrow`,short:`Tarrow`,color:Md.tarrow.coat,hat:Md.tarrow.hat,skin:Md.tarrow.skin,build:.95,headwear:`brim`,prop:`staff`,beard:!0},{name:`Sable the Fencer`,short:`Sable`,color:Md.sable.coat,hat:Md.sable.hat,skin:Md.sable.skin,build:1,headwear:`none`,prop:`blade`},{name:`The Grey Pilgrim`,short:`the Pilgrim`,color:Md.pilgrim.coat,hat:Md.pilgrim.hat,skin:Md.pilgrim.skin,build:1.05,headwear:`hood`,prop:`staff`}],E_={torso:new ka(.3,.38,.8,10),head:new Pa(.28,14,12),arm:new ka(.075,.085,.55,7),hand:new Pa(.085,7,6),leg:new ka(.095,.105,.42,7),foot:new Da(.16,.09,.26),eye:new Pa(.035,6,6),cap:new Aa(.34,.3,8),brim:new ka(.46,.46,.035,12),crown:new Aa(.3,.34,10),hood:new Pa(.33,14,12,0,Math.PI*2,0,Math.PI*.6),kerchief:new Pa(.3,12,10,0,Math.PI*2,0,Math.PI*.45),handle:new ka(.035,.035,.9,6),staff:new ka(.04,.045,1.7,6),axeHead:new Da(.07,.26,.3),hammer:new Da(.2,.2,.3),blade:new Da(.045,.95,.1),bag:new Da(.3,.26,.16),basket:new ka(.19,.15,.22,9),beard:new Aa(.17,.34,8)},D_=tf(Vu),O_=tf(Iu),k_=tf(Nd),A_=tf(Bu),j_=tf(Pd),M_=tf(Fd),N_=tf(Id),P_=tf(Ld),F_=tf(Rd),I_=tf(xd),L_=rf;function R_(e){let t=new An,n=[],r=(...e)=>n.push(...e),i=tf(e.color),a=tf(e.skin),o=tf(e.hat),s=e.build,c=new U(E_.torso,i);c.position.y=.86*s,c.scale.setScalar(s);let l=new U(E_.head,a);if(l.position.y=1.48*s,r(c,l),[-1,1].forEach(e=>{let t=new U(E_.eye,D_);t.position.set(e*.1*s,1.52*s,.245*s),r(t)}),e.beard){let e=new U(E_.beard,N_);e.position.set(0,1.3*s,.16*s),e.rotation.x=Math.PI,r(e)}let u={arms:[],legs:[]};if([-1,1].forEach(e=>{let n=new An;n.position.set(e*.38*s,1.16*s,0);let r=new U(E_.arm,i);r.position.y=-.27;let o=new U(E_.hand,a);o.position.y=-.56,n.add(new U(Gf([r,o].map(nf),!1),L_)),t.add(n),u.arms.push(n);let c=new An;c.position.set(e*.15*s,.46*s,0);let l=new U(E_.leg,M_);l.position.y=-.21;let d=new U(E_.foot,O_);d.position.set(0,-.42,.05),c.add(new U(Gf([l,d].map(nf),!1),L_)),t.add(c),u.legs.push(c)}),e.headwear===`cap`){let e=new U(E_.cap,o);e.position.y=1.72*s,r(e)}else if(e.headwear===`brim`){let e=new U(E_.brim,o);e.position.y=1.66*s;let t=new U(E_.crown,o);t.position.y=1.82*s,r(e,t)}else if(e.headwear===`hood`){let e=new U(E_.hood,o);e.position.y=1.5*s,r(e)}else if(e.headwear===`kerchief`){let e=new U(E_.kerchief,o);e.position.y=1.5*s,r(e)}let d=.38*s,f=.72*s,p=.12;if(e.prop===`axe`){let e=new U(E_.handle,O_);e.position.set(d,f,p),e.rotation.z=.25;let t=new U(E_.axeHead,k_);t.position.set(d+.16,f+.42,p),r(e,t)}else if(e.prop===`hammer`){let e=new U(E_.handle,O_);e.position.set(d,f,p),e.rotation.z=.2;let t=new U(E_.hammer,k_);t.position.set(d+.13,f+.44,p),r(e,t)}else if(e.prop===`blade`){let e=new U(E_.blade,k_);e.position.set(d,f+.35,p),e.rotation.z=.12;let t=new U(E_.hand,A_);t.position.set(d,f-.1,p),r(e,t)}else if(e.prop===`staff`){let e=new U(E_.staff,O_);e.position.set(d,f+.36,p),e.rotation.z=.06,r(e)}else if(e.prop===`satchel`){let e=new U(E_.bag,P_);e.position.set(-.34*s,.8*s,.1),e.rotation.z=-.15;let t=new U(E_.handle,F_);t.position.set(-.1*s,1.15*s,.05),t.rotation.z=Math.PI/2.6,r(e,t)}else if(e.prop===`basket`){let e=new U(E_.basket,j_);e.position.set(d,f,.1);let t=new U(E_.hand,I_);t.position.set(d,f+.14,.1),t.scale.set(1.6,.7,1.6),r(e,t)}return t.add(new U(Gf(n.map(nf),!1),L_)),t.traverse(e=>{e.isMesh&&(e.castShadow=!0,e.receiveShadow=!0)}),Jd.add(t),{g:t,limbs:u}}var z_=T_.map((e,t)=>{let{g:n,limbs:r}=R_(e);return{...e,g:n,limbs:r,tier:t+1,hx:0,hz:0,tx:0,tz:0,wait:0,cooldown:0,bob:Math.random()*6}});function B_(e=Math.random){z_.forEach((t,n)=>{t.hx=Gg[n].x,t.hz=Gg[n].z;let r=K.wanderers,i=e()*Math.PI*2,a=r.campRadiusMin+e()*(r.campRadiusMax-r.campRadiusMin),o=t.hx+Math.cos(i)*a,s=t.hz+Math.sin(i)*a;t.g.position.set(o,jf(o,s),s),V_(t)})}function V_(e){let t=K.wanderers,n=Math.random()*Math.PI*2,r=Math.random()*t.roamRadius;e.tx=Math.max(-df+5,Math.min(df-5,e.hx+Math.cos(n)*r)),e.tz=Math.max(-df+5,Math.min(df-5,e.hz+Math.sin(n)*r)),e.wait=t.waitMin+Math.random()*(t.waitMax-t.waitMin)}B_();function H_(e,t){let n=t?Math.sin(e.bob):0;e.limbs.arms[0].rotation.x=n*.55,e.limbs.arms[1].rotation.x=-n*.55,e.limbs.legs[0].rotation.x=-n*.5,e.limbs.legs[1].rotation.x=n*.5}function U_(e){if(J.bench)return;let t=K.wanderers,n=fh(`bell`)?t.hearingWithBell:t.hearingRange;J.crawling&&(n*=t.crawlHearingMultiplier),J.whistleT>0&&(n=Math.max(n,t.whistleRange));for(let r of z_){r.cooldown=Math.max(0,r.cooldown-e);let i=Z.position.x-r.g.position.x,a=Z.position.z-r.g.position.z,o=Math.hypot(i,a),s=o<n&&r.cooldown===0&&!J.ceremony;s&&(r.tx=Z.position.x,r.tz=Z.position.z,r.wait=0);let c=r.tx-r.g.position.x,l=r.tz-r.g.position.z,u=Math.hypot(c,l);if(u>.5){let n=s?t.huntSpeed:t.roamSpeed;r.g.position.x+=c/u*n*e,r.g.position.z+=l/u*n*e,r.g.rotation.y=Math.atan2(c,l),r.bob+=e*t.bobRate,r.g.position.y=jf(r.g.position.x,r.g.position.z)+Math.abs(Math.sin(r.bob))*.1,H_(r,!0)}else r.g.position.y=jf(r.g.position.x,r.g.position.z),r.wait-=e,r.wait<=0&&V_(r),H_(r,!1);J.state===`play`&&s&&o<t.challengeRange&&uh(oh.DUEL_CHALLENGE,r)}}var W_=[{id:`boots`,name:`Swift boots`,desc:`Walk 40% faster.`,cost:12,color:Hd.boots},{id:`lens`,name:`Long lens`,desc:`Finder sees 50% farther.`,cost:10,color:Hd.lens},{id:`grip`,name:`Duelist grip`,desc:`Each tap counts more in duels.`,cost:18,color:Hd.grip},{id:`lantern`,name:`Brass lantern`,desc:`Carry your own light for the dark.`,cost:8,color:Hd.lantern},{id:`hat`,name:`Straw hat`,desc:`A wide hat, worn over the hood.`,cost:6,color:Hd.hat},{id:`cloak`,name:`Violet suit`,desc:`A new color for your ninja suit.`,cost:9,color:Hd.cloak},{id:`charm`,name:`Orbit charm`,desc:`A small ring that circles your sash.`,cost:14,color:Hd.charm},{id:`bell`,name:`Silver bell`,desc:`Wanderers hear you and seek you from farther.`,cost:16,color:Hd.bell}];function G_(e){return W_.find(t=>t.id===e)}function K_(){let e=q(`shopItems`);e.innerHTML=``;for(let t of W_){let n=document.createElement(`div`);n.className=`item`;let r=document.createElement(`div`);r.className=`row`;let i=document.createElement(`div`);i.className=`swatch`,i.style.background=Gd(t.color);let a=document.createElement(`div`);a.innerHTML=`<div class="name">${t.name}</div><div class="desc">${t.desc}</div>`,r.append(i,a),n.appendChild(r);let o=Y.items[t.id];if(o){let e=document.createElement(`span`);e.className=`owned`,e.textContent=o===`owned`?`Kept`:`Set down for you`,n.appendChild(e)}else{let e=document.createElement(`button`);e.textContent=`${t.cost} ◆`,e.disabled=Y.fragments<t.cost,e.addEventListener(`click`,()=>{Y.fragments-=t.cost,Y.items[t.id]=`bought`,lf(),ig(),K_(),uh(oh.ITEM_BOUGHT,t.id),lg(`${t.name} set down beside you`)}),n.appendChild(e)}e.appendChild(n)}}ng.addEventListener(`click`,()=>{J.state===`play`&&(J.state=`shop`,K_(),q(`shop`).classList.remove(`hidden`))}),q(`shopClose`).addEventListener(`click`,()=>{q(`shop`).classList.add(`hidden`),J.state=`play`});var q_=[];function J_(e,t,n){let r=new An;if(e===`item`){let n=G_(t),i=new U(new Da(.7,.45,.5),tf(zd)),a=new U(new Da(.74,.18,.54),tf(n.color,.35));a.position.y=.32;let o=new U(new Da(.12,.14,.06),tf(Bu));o.position.set(0,.22,.28),r.add(i,a,o,of(n.color,.9,6)),r.userData={kind:e,id:t}}else{let n=new U(new Ma(.42,0),tf(Bd,.9));n.add(new U(new Pa(.7,12,10),af(Vd,.2))),n.add(of(Bd,1.2,8)),r.add(n),r.userData={kind:e,text:t}}let i=n===void 0?Math.random()*Math.PI*2:n,a=Z.position.x+Math.cos(i)*3.2,o=Z.position.z+Math.sin(i)*3.2,s=Math.hypot(a,o),c=df-4;s>c&&(a*=c/s,o*=c/s),r.position.set(a,jf(a,o)+.7,o),Jd.add(r),q_.push({g:r,kind:e,phase:Math.random()*6})}function Y_(e,t){if(Jd.remove(e.g),q_.splice(t,1),e.kind===`item`){let t=e.g.userData.id;Y.items[t]=`owned`,lf();let n=vh(t);tg(),lg(n?`${G_(t).name} — worn`:`${G_(t).name} added. No room to wear it; open your satchel.`,n?2:3)}else Y.wishes.push({text:e.g.userData.text,cycle:Y.cycles}),lf(),lg(`Wish kept: “${e.g.userData.text}”`,3);ag(q(`satchelBtn`)),navigator.vibrate&&navigator.vibrate([30,30,60]),J.ceremony&&!q_.some(e=>e.kind===`wish`)&&uh(oh.WISHES_ALL_COLLECTED)}function X_(){let e=q(`satchelWishes`);if(e.innerHTML=``,Y.wishes.length||(e.innerHTML=`<div class="empty">No wishes yet. Gather the seven orbs.</div>`),Y.wishes.forEach((t,n)=>{let r=document.createElement(`div`);r.className=`wishrow`;let i=document.createElement(`span`);i.className=`star`,i.textContent=`✦`;let a=document.createElement(`div`),o=document.createElement(`div`);o.textContent=`“${t.text}”`;let s=document.createElement(`div`);s.className=`meta`,s.textContent=`Granted on your ${mg(t.cycle)} gathering`,a.append(o,s);let c=document.createElement(`button`);c.className=`quiet forget`,c.textContent=`Forget`,c.setAttribute(`aria-label`,`Forget this wish`),c.addEventListener(`click`,()=>{Y.wishes.splice(n,1),lf(),X_()}),r.append(i,a,c),e.appendChild(r)}),Y.wishes.length>1){let t=document.createElement(`button`);t.className=`quiet forgetall`,t.textContent=`Forget every wish`,t.addEventListener(`click`,()=>{Y.wishes.length=0,lf(),X_()}),e.appendChild(t)}let t=q(`satchelItems`);t.innerHTML=``;let n=W_.filter(e=>uf(e.id));n.length||(t.innerHTML=`<div class="empty">Nothing yet. Win duels and visit the trader.</div>`);let r=dh();if(n.length&&r>0){let e=document.createElement(`div`);e.className=`slotline`,e.textContent=`Worn ${mh()} of ${r}`,t.appendChild(e)}n.forEach(e=>{let n=fh(e.id),r=document.createElement(`div`);r.className=`item`+(n?` isworn`:``),r.innerHTML=`<div class="row"><div class="swatch" style="background:${Gd(e.color)}"></div><div><div class="name">${e.name}</div><div class="desc">${e.desc}</div></div></div>`;let i=document.createElement(`button`);i.textContent=n?`Take off`:`Wear`,i.addEventListener(`click`,()=>{let t=_h(e.id);if(!t.ok){lg(t.reason,3);return}X_(),ag(q(`satchelBtn`))}),r.appendChild(i),t.appendChild(r)})}ch(oh.ITEM_BOUGHT,e=>J_(`item`,e)),q(`satchelBtn`).addEventListener(`click`,()=>{J.state===`play`&&(J.state=`satchel`,X_(),q(`satchel`).classList.remove(`hidden`))}),q(`satchelClose`).addEventListener(`click`,()=>{q(`satchel`).classList.add(`hidden`),J.state=`play`});var Q=q(`rc`).getContext(`2d`),Z_=q(`dist`),Q_=0;function $_(e,t,n,r,i){let a=K.finder,o=fh(`lens`)?a.rangeWithLens:a.range,s=a.revealDistance;Q_+=e*a.sweepSpeed,Q.clearRect(0,0,256,256),Q.strokeStyle=`rgba(143,245,200,0.25)`,Q.lineWidth=2,[.33,.66,1].forEach(e=>{Q.beginPath(),Q.arc(128,128,118*e,0,Math.PI*2),Q.stroke()}),Q.beginPath(),Q.moveTo(128,10),Q.lineTo(128,246),Q.moveTo(10,128),Q.lineTo(246,128),Q.stroke(),Q.save(),Q.translate(128,128),Q.rotate(Q_);let c=Q.createLinearGradient(0,0,118,0);c.addColorStop(0,`rgba(143,245,200,0.35)`),c.addColorStop(1,`rgba(143,245,200,0)`),Q.fillStyle=c,Q.beginPath(),Q.moveTo(0,0),Q.arc(0,0,118,-.9,0),Q.closePath(),Q.fill(),Q.restore();let l=(e,a)=>{let s=e-Z.position.x,c=a-Z.position.z;return[(s*r+c*i)/o*118,-(s*t+c*n)/o*118,Math.hypot(s,c)]},u=1/0;for(let e of Gg){if(e.found)continue;let[t,n,r]=l(e.x,e.z);u=Math.min(u,r);let i=Math.hypot(t,n),a=i<=118,o=r<=s;a||(t*=112/i,n*=112/i),Q.fillStyle=o?Gd(e.color):`#f6efdf`,Q.globalAlpha=a?.75+.25*Math.sin(performance.now()/250+e.phase):.4,Q.beginPath(),Q.arc(128+t,128+n,o?10:a?7:5,0,Math.PI*2),Q.fill(),o&&(Q.fillStyle=`#1b1a17`,Q.font=`bold 13px Trebuchet MS, sans-serif`,Q.textAlign=`center`,Q.textBaseline=`middle`,Q.fillText(e.n,128+t,128+n+1)),Q.globalAlpha=1}Q.strokeStyle=`#f6efdf`,Q.lineWidth=2.5;for(let e of z_){let[t,n,r]=l(e.g.position.x,e.g.position.z);Math.hypot(t,n)>110||(Q.globalAlpha=e.cooldown>0?.35:.9,Q.strokeStyle=`#f6efdf`,Q.beginPath(),Q.moveTo(128+t,128+n-8),Q.lineTo(128+t+8,128+n),Q.lineTo(128+t,128+n+8),Q.lineTo(128+t-8,128+n),Q.closePath(),Q.stroke(),r<=s&&(Q.fillStyle=`#f6efdf`,Q.font=`bold 10px Trebuchet MS, sans-serif`,Q.textAlign=`center`,Q.textBaseline=`middle`,Q.fillText(e.tier,128+t,128+n+1)),Q.globalAlpha=1)}Q.fillStyle=`#ffe9b0`;for(let e of q_){let[t,n]=l(e.g.position.x,e.g.position.z);Math.hypot(t,n)>110||Q.fillRect(128+t-4,128+n-4,8,8)}Q.fillStyle=`#f6efdf`,Q.beginPath(),Q.moveTo(128,119),Q.lineTo(135,135),Q.lineTo(121,135),Q.closePath(),Q.fill(),Z_.textContent=u===1/0?``:`Nearest orb: ${Math.round(u)} m`}var ev=K.map,tv=df*2,nv=new Uint8Array(ev.grid*ev.grid),rv=e=>Math.floor((e+df)/tv*ev.grid),iv=0;function av(e){if(iv+=e,iv<.25)return;iv=0;let t=rv(Z.position.x),n=rv(Z.position.z),r=Math.ceil(ev.seeRadius/tv*ev.grid);for(let e=n-r;e<=n+r;e++)if(!(e<0||e>=ev.grid))for(let i=t-r;i<=t+r;i++){if(i<0||i>=ev.grid)continue;let a=i-t,o=e-n;a*a+o*o<=r*r&&(nv[e*ev.grid+i]=1)}}function ov(){nv.fill(0)}var sv=null,cv=-1;function lv(){let e=ev.resolution,t=document.createElement(`canvas`);t.width=t.height=e;let n=t.getContext(`2d`),r=n.createImageData(e,e),i=[63,143,191];for(let t=0;t<e;t++)for(let n=0;n<e;n++){let a=n/(e-1)*tv-df,o=t/(e-1)*tv-df,s=(t*e+n)*4;if(Math.hypot(a,o)>df){r.data[s]=24,r.data[s+1]=30,r.data[s+2]=26,r.data[s+3]=255;continue}let c,l,u;if(vm(a,o))[c,l,u]=i;else{let{region:e,neighbour:t,blend:n}=gf(a,o),r=e.ground[0],i=t.ground[0];c=(r>>16&255)*(1-n)+(i>>16&255)*n,l=(r>>8&255)*(1-n)+(i>>8&255)*n,u=(r&255)*(1-n)+(i&255)*n}let d=tv/e,f=kf(a+d,o)-kf(a-d,o)+(kf(a,o+d)-kf(a,o-d)),p=Math.max(.55,Math.min(1.45,1+f*.16));r.data[s]=Math.min(255,c*p),r.data[s+1]=Math.min(255,l*p),r.data[s+2]=Math.min(255,u*p),r.data[s+3]=255}n.putImageData(r,0,0),sv=t,cv=xm}var uv=q(`mapc`),dv=uv.getContext(`2d`),fv=document.createElement(`canvas`);fv.width=fv.height=ev.grid;var pv=fv.getContext(`2d`);function mv(){(!sv||cv!==xm)&&lv();let e=uv.width;dv.clearRect(0,0,e,e),dv.imageSmoothingEnabled=!0,dv.drawImage(sv,0,0,e,e);let t=pv.createImageData(ev.grid,ev.grid);for(let e=0;e<nv.length;e++)t.data[e*4+3]=nv[e]?0:238;pv.putImageData(t,0,0),dv.drawImage(fv,0,0,e,e);let n=(t,n)=>[(t+df)/tv*e,(n+df)/tv*e],r=(e,t)=>{let n=rv(e),r=rv(t);return n>=0&&r>=0&&n<ev.grid&&r<ev.grid&&nv[r*ev.grid+n]};dv.font=`bold 13px Trebuchet MS, sans-serif`,dv.textAlign=`center`;for(let e of bm){if(!r(e.x,e.z))continue;let[t,i]=n(e.x,e.z);dv.fillStyle=`rgba(27,26,23,0.75)`,dv.beginPath(),dv.arc(t,i,5,0,Math.PI*2),dv.fill(),dv.fillStyle=`#f6efdf`,dv.fillText(e.name,t,i-10)}for(let e of Gg){if(!e.found)continue;let[t,r]=n(e.x,e.z);dv.fillStyle=Gd(e.color),dv.beginPath(),dv.arc(t,r,6,0,Math.PI*2),dv.fill(),dv.fillStyle=`#1b1a17`,dv.fillText(e.n,t,r+4)}let[i,a]=n(Z.position.x,Z.position.z);dv.save(),dv.translate(i,a),dv.rotate(-J.camYaw),dv.fillStyle=`#8ff5c8`,dv.beginPath(),dv.moveTo(0,-9),dv.lineTo(6,7),dv.lineTo(0,3),dv.lineTo(-6,7),dv.closePath(),dv.fill(),dv.restore()}var hv=q(`map`);function gv(){J.state===`play`&&(J.state=`map`,hv.classList.remove(`hidden`),requestAnimationFrame(()=>requestAnimationFrame(mv)))}function _v(){hv.classList.add(`hidden`),J.state===`map`&&(J.state=`play`)}q(`finder`).addEventListener(`click`,gv),q(`mapClose`).addEventListener(`click`,_v),window.addEventListener(`keydown`,e=>{e.repeat||e.key.toLowerCase()===`m`&&(J.state===`map`?_v():gv())});function vv(e){J.lowGraphics!==e&&(J.lowGraphics=e,Lm(!e),rh(!e),Tv(),Y.lowGraphics!==e&&(Y.lowGraphics=e,lf()))}var yv=0,bv=0,xv=0,Sv=K.graphics.settleSeconds;function Cv(e){if(J.lowGraphics)return;if(Sv>0){Sv-=e;return}let t=K.graphics;yv+=e,bv++,!(yv<t.sampleSeconds)&&(xv=bv/yv<t.autoLowFps?xv+yv:0,yv=0,bv=0,xv>=t.autoLowSeconds&&vv(!0))}function wv(){Tv(),(Y.lowGraphics||K.graphics.forceLow)&&vv(!0)}function Tv(){J.propBudget=J.lowGraphics?K.graphics.lowProps:K.world.props}var Ev={Bram:{challenge:`One orb. That is all I ever carried out of this valley. Let us see if your arms are better than mine were.`,theyWin:`Ha! Still in me somewhere. Go on — the rest of them are worse than me.`,theyLose:`Quick hands. I wish I had had them when it counted.`},Nell:{challenge:`The second is mine. Not that I wanted the others — there are better things growing out here than wishes.`,theyWin:`Patience beats hurry. Ask the moss, it has been here longer.`,theyLose:`Off you go, then. Mind the nettles down by the water.`},Pip:{challenge:`Third! Third, and I would have had the lot, only I grabbed them out of order like a fool. Come on, quickly.`,theyWin:`Too slow! Everyone is always too slow.`,theyLose:`Fine. You are quick. Do not be quick about the order, though. That is how you end up camped by the third.`},Marla:{challenge:`Four. Halfway, near enough. You will not rush me.`,theyWin:`Hands like stone. I did say.`,theyLose:`Hm. Good. Take it.`},Tarrow:{challenge:`The fifth. I have watched a great many people walk past me, and rather fewer walk back. Let us see which you are.`,theyWin:`No shame in it. I have lost at this spot more times than you have stood on it.`,theyLose:`Go on, then. And when it asks you — think before you speak.`},Sable:{challenge:`Six. Twice I stood here, and twice I turned around. You will do no better.`,theyWin:`As I thought. The sixth keeps its own.`,theyLose:`Again? Then go. Go and see what is past it, and come back and tell me.`},"the Pilgrim":{challenge:`I have been where you are going.`,theyWin:`Then you are not ready. Good.`,theyLose:`Go. Ask carefully.`}},Dv={challenge:`A duel, then. Ten seconds.`,theyWin:`Better luck further out.`,theyLose:`Well fought.`};function Ov(e){return Ev[e]||Dv}function kv(e,t){let n=`“${e}”`;return t<=0?`You asked for ${n} not long ago.`:t===1?`One gathering ago you asked for ${n}.`:`${t} gatherings ago you asked for ${n}.`}var Av=q(`duel`),jv=K.duel,$={w:null,you:0,them:0,time:jv.seconds,ready:jv.countdown,waiting:!0,over:!1,taps:0,tapStart:0};function Mv(e){J.state=`duel`,$.w=e,$.you=0,$.them=0,$.time=jv.seconds,$.ready=jv.countdown,$.waiting=!0,$.over=!1,$.taps=0,$.tapStart=0,s_.active=!1,s_.x=s_.y=0,a_.style.display=`none`;let t=[`a gentle`,`an easy`,`a steady`,`a quick`,`a fast`,`a fierce`,`a blistering`][e.tier-1];q(`duelWho`).textContent=`“${Ov(e.short).challenge}”`,q(`duelRules`).textContent=`${e.name} keeps camp by orb ${e.tier}, so expect ${t} pace. ${jv.seconds} seconds: fill your bar first, or be further along when time runs out.`+(e.tier>=4?` Two thumbs are allowed.`:``),q(`resultSay`).textContent=``,q(`themName`).textContent=e.short,q(`duelPlay`).style.display=`block`,q(`duelResult`).style.display=`none`,q(`duelStart`).style.display=`inline-block`,q(`tapzone`).style.display=`none`,q(`tapzone`).textContent=`Get ready…`,Nv(),Av.classList.remove(`hidden`),navigator.vibrate&&navigator.vibrate(30)}q(`duelStart`).addEventListener(`click`,()=>{$.waiting=!1,q(`duelStart`).style.display=`none`,q(`tapzone`).style.display=`flex`});function Nv(){q(`timer`).textContent=$.waiting?jv.seconds.toFixed(1):$.ready>0?String(Math.ceil($.ready)):Math.max(0,$.time).toFixed(1);let e=Math.min(100,$.you*100),t=Math.min(100,$.them*100);q(`youBar`).style.width=e+`%`,q(`youPct`).textContent=Math.round(e)+`%`,q(`themBar`).style.width=t+`%`,q(`themPct`).textContent=Math.round(t)+`%`}function Pv(){J.state!==`duel`||$.over||$.waiting||$.ready>0||($.taps===0&&($.tapStart=performance.now()),$.taps++,$.you+=fh(`grip`)?jv.tapValueWithGrip:jv.tapValue,navigator.vibrate&&navigator.vibrate(8),Nv(),$.you>=1&&Iv(!0))}q(`tapzone`).addEventListener(`touchstart`,e=>{e.preventDefault(),Pv()},{passive:!1}),q(`tapzone`).addEventListener(`mousedown`,Pv),window.addEventListener(`keydown`,e=>{e.code===`Space`&&Pv()});function Fv(e){if(!($.over||$.waiting)){if($.ready>0){$.ready-=e,$.ready<=0&&(q(`tapzone`).textContent=`Tap!`,navigator.vibrate&&navigator.vibrate(25)),Nv();return}$.time-=e,$.them+=e*gg($.w.tier),Nv(),$.them>=1?Iv(!1):$.time<=0&&Iv($.you>=$.them)}}function Iv(e){$.over=!0;let t,n=$.w.short;if(e){Y.wins++;let e=_g($.w.tier);t=e.loot;let r=e.flawless;q(`resultBig`).textContent=r?`Flawless!`:`You win`,q(`resultSay`).textContent=`“${Ov($.w.short).theyLose}”`,q(`resultLoot`).textContent=`${n} hands over ${t} fragments.`,navigator.vibrate&&navigator.vibrate([40,40,80])}else t=jv.consolation,q(`resultBig`).textContent=`Outpaced`,q(`resultSay`).textContent=`“${Ov($.w.short).theyWin}”`,q(`resultLoot`).textContent=`${n} wins, but tosses you ${t} fragment${t===1?``:`s`} for the effort.`;let r=(performance.now()-$.tapStart)/1e3,i=$.taps>1&&r>.2?($.taps-1)/r:0,a=i>(Y.bestTaps||0);a&&(Y.bestTaps=i),q(`resultRate`).textContent=i?`${i.toFixed(1)} taps a second${a?` — your best yet`:``}`:``,og(t),$.w.cooldown=K.wanderers.cooldown,V_($.w),setTimeout(()=>{q(`duelPlay`).style.display=`none`,q(`duelResult`).style.display=`block`},jv.resultDelay)}q(`duelDone`).addEventListener(`click`,()=>{Av.classList.add(`hidden`),J.state=`play`}),ch(oh.DUEL_CHALLENGE,Mv);var Lv=new An,Rv={wings:[],tail:[],neck:[],eyes:[],sparks:null,ring:null,built:!1},zv=[];function Bv(e){let t=J.t;Lv.position.y=Math.sin(t*1.1)*.35+.4,Rv.wings.forEach(e=>{e.pivot.rotation.z=e.s*(.25+Math.sin(t*2.2+e.phase)*.45)}),Rv.head.position.y=10.6+Math.sin(t*1.6)*.15,Rv.head.rotation.x=Math.sin(t*.9)*.08,Rv.neck.forEach((e,n)=>{e.position.x=Math.sin(t*1.6+n*.5)*.15*n/4}),Rv.tail.forEach((e,n)=>{let r=n+1;e.position.set(Math.sin(t*1.5-r*.5)*.35*r*.5,6-r*.45+Math.sin(t*1.2-r*.4)*.2,-3.6-r*.75)});let n=Rv.tail[7];Rv.tailTip.position.set(n.position.x,n.position.y,n.position.z-.8),Rv.tailTip.rotation.x=-Math.PI/2;let r=.7+.3*Math.sin(t*4);Rv.eyes.forEach(e=>e.material.opacity=r),Rv.eyes.forEach(e=>e.material.transparent=!0),Rv.ring.rotation.z+=e*.4,Rv.ring.scale.setScalar(1+Math.sin(t*2)*.03);let i=Rv.sparks.geometry.attributes.position;for(let t=0;t<i.count;t++){let n=i.getY(t)+e*1.6;n>13&&(n=0),i.setY(t,n)}i.needsUpdate=!0}var Vv=K.dayNight,Hv=K.ceremony;function Uv(e){let t=J.night;J.night+=(J.nightTarget-J.night)*Math.min(1,e*Vv.easeRate),(Math.abs(J.night-t)>.001||J.t<.2)&&Nm(J.night),Jd.fog.color.copy(Yd).lerp(Xd,J.night),zm(J.night),$h.lantern?.visible&&($h.lanternLight.intensity=Vv.lanternBase+J.night*Vv.lanternNightBoost),Rm(Z.position.x,Z.position.y,Z.position.z),J.whistleT>0&&(J.whistleT=Math.max(0,J.whistleT-e)),J.whistleCd>0&&(J.whistleCd=Math.max(0,J.whistleCd-e))}function Wv(e,t){if(J.state===`duel`){Fv(e);let t=$.w,n=t.g.position.x-Z.position.x,r=t.g.position.z-Z.position.z;Z.rotation.y=Math.atan2(n,r),t.g.rotation.y=Math.atan2(-n,-r),t.g.position.y=$.over?0:Math.abs(Math.sin(J.t*14))*.08}if(J.state===`ending`){J.endT+=e;let t=Math.min(J.endT/Hv.riseSeconds,1);if(zv.forEach(({m:e,i:n})=>{let r=n/7*Math.PI*2+J.endT*1.2;e.position.set(Z.position.x+Math.cos(r)*(1.5+2*t),1.5+5*t+Math.sin(J.endT*3+n)*.2,Z.position.z+Math.sin(r)*(1.5+2*t))}),J.endT>Hv.keeperGrowDelay&&Lv.scale.setScalar(.001+Math.min((J.endT-Hv.keeperGrowDelay)/Hv.keeperGrowSeconds,1)),J.endT>Hv.wishPromptAt){J.state=`wish`,q(`wish`).classList.remove(`hidden`);let e=document.querySelector(`.wishInput`);e&&e.focus()}}if(J.state===`wish`&&zv.forEach(({m:e,i:t})=>{let n=t/7*Math.PI*2+J.t*1.2;e.position.set(Z.position.x+Math.cos(n)*3.5,6.5+Math.sin(J.t*3+t)*.2,Z.position.z+Math.sin(n)*3.5)}),J.ceremony&&Rv.built&&Bv(e),J.departT>=0){J.departT+=e;let t=Math.min(J.departT/Hv.departSeconds,1);Lv.position.y+=e*6*t,Lv.scale.setScalar(1-t*.9),J.departT>=Hv.departSeconds&&(Jd.remove(Lv),J.departT=-1,J.ceremony=!1,J.nightTarget=0,J.respawnT=Hv.respawnSeconds,q(`hint`).style.opacity=.75)}J.respawnT>0&&(J.respawnT-=e,J.respawnT<=0&&(J.respawnT=-1,J.worldSeed=Wd(),Sm(J.worldSeed),ov(),$g(),B_(),lg(`The valley has shifted, and the seven orbs are scattered again`,3.5),setTimeout(t,3600)))}var Gv=K.player,Kv=K.orbs,qv=0;function Jv(e,t,n,r,i,a){if(J.state===`play`){let o=Math.hypot(t,n),s=!1;if(o>.08){let c=vm(Z.position.x,Z.position.z),l=Math.min(o,1)*(fh(`boots`)?Gv.bootsMultiplier:1)*(J.crawling?Gv.crawlSpeedMultiplier:1)*(c?K.water.wadeSpeed:1),u=r.x*-n+i*t,d=r.z*-n+a*t,f=Math.hypot(u,d)||1;Z.position.x+=u/f*Gv.speed*l*e,Z.position.z+=d/f*Gv.speed*l*e,Z.rotation.y=Math.atan2(u,d),qv+=e*Gv.bobRate*l,s=!0}let c=Math.hypot(Z.position.x,Z.position.z);c>df&&(Z.position.x*=df/c,Z.position.z*=df/c);for(let e of om){if(Z.position.y>e.top+Gv.jumpClearance)continue;let t=Z.position.x-e.x,n=Z.position.z-e.z,r=Math.hypot(t,n),i=e.r+Gv.radius;r<i&&r>1e-4&&(Z.position.x=e.x+t/r*i,Z.position.z=e.z+n/r*i)}let l=jf(Z.position.x,Z.position.z);J.airborne?(J.vy-=Gv.gravity*e,J.airY+=J.vy*e,J.airY<=l&&(J.airY=l,J.vy=0,J.airborne=!1,Qh(!1),navigator.vibrate&&navigator.vibrate(18)),Z.position.y=J.airY):Z.position.y=l+Math.abs(Math.sin(qv))*Gv.bobHeight,J.airborne||(Vh.rotation.x=s?Math.sin(qv)*.6:0,Hh.rotation.x=s?-Math.sin(qv)*.6:0,Wh.position.z=Math.sin(Vh.rotation.x)*.3,Gh.position.z=Math.sin(Hh.rotation.x)*.3,Yh.rotation.x=s?-Math.sin(qv)*.5:0,Xh.rotation.x=s?Math.sin(qv)*.5:0);for(let t of Gg)t.found||(t.mesh.position.y=jf(t.x,t.z)+1.1+Math.sin(J.t*2+t.phase)*.25,t.mesh.rotation.y+=e,Math.hypot(t.x-Z.position.x,t.z-Z.position.z)<Kv.pickupRadius&&i_(t));for(let t=q_.length-1;t>=0;t--){let n=q_[t];n.g.position.y=jf(n.g.position.x,n.g.position.z)+.7+Math.sin(J.t*2.5+n.phase)*.15,n.g.rotation.y+=e*1.2,Math.hypot(n.g.position.x-Z.position.x,n.g.position.z-Z.position.z)<1.5&&Y_(n,t)}U_(e)}Xg(),r_(e),Mg(e),Kh.forEach((e,t)=>{let n=t+1;e.position.set(Math.sin(J.t*3-n*.6)*.06*n,.35+n*.06+Math.sin(J.t*2+n)*.02,-.38-n*.09)}),$h.charm&&($h.charm.rotation.z+=e*1.5)}var Yv=`modulepreload`,Xv=function(e,t){return new URL(e,t).href},Zv={},Qv=function(e,t,n){let r=Promise.resolve();if(t&&t.length>0){let e=document.getElementsByTagName(`link`),i=document.querySelector(`meta[property=csp-nonce]`),a=i?.nonce||i?.getAttribute(`nonce`);function o(e){return Promise.all(e.map(e=>Promise.resolve(e).then(e=>({status:`fulfilled`,value:e}),e=>({status:`rejected`,reason:e}))))}function s(e){return import.meta.resolve?import.meta.resolve(e):new URL(e,import.meta.url).href}r=o(t.map(t=>{if(t=Xv(t,n),t=s(t),t in Zv)return;Zv[t]=!0;let r=t.endsWith(`.css`);for(let n=e.length-1;n>=0;n--){let i=e[n];if(i.href===t&&(!r||i.rel===`stylesheet`))return}let i=document.createElement(`link`);if(i.rel=r?`stylesheet`:Yv,r||(i.as=`script`),i.crossOrigin=``,i.href=t,a&&i.setAttribute(`nonce`,a),document.head.appendChild(i),r)return new Promise((e,n)=>{i.addEventListener(`load`,e),i.addEventListener(`error`,()=>n(Error(`Unable to preload CSS for ${t}`)))})}))}function i(e){let t=new Event(`vite:preloadError`,{cancelable:!0});if(t.payload=e,window.dispatchEvent(t),!t.defaultPrevented)throw e}return r.then(t=>{for(let e of t||[])e.status===`rejected`&&i(e.reason);return e().catch(i)})};for(let e in Y.items)Y.items[e]===`bought`&&J_(`item`,e);tg();var $v=new ns,ey=K.camera;J.camPitch=ey.pitch,h_(Y.camDist??ey.distance),am().then(()=>{Sm(J.worldSeed);let e=J.bench?Ud(J.worldSeed^24301):void 0;$g(e),B_(e),J.bench&&ny()}).catch(e=>console.error(`the valley could not be built:`,e)),Im(),Pm(),wv(),th(),hg(qd),ch(oh.CRAWL_TOGGLE,()=>{J.state===`play`&&(J.crawling=!J.crawling,Zh(J.crawling),lg(J.crawling?`Crawling. Slower, and harder to hear.`:`Standing.`,1.6))}),ch(oh.JUMP,()=>{J.state!==`play`||J.airborne||J.crawling||(J.airborne=!0,J.vy=K.player.jumpSpeed,J.airY=jf(Z.position.x,Z.position.z),Qh(!0),navigator.vibrate&&navigator.vibrate(12))}),ch(oh.WHISTLE,()=>{if(J.state!==`play`||J.whistleCd>0)return;let e=K.wanderers;J.whistleT=e.whistleSeconds,J.whistleCd=e.whistleCooldown,lg(`You whistle. It carries.`,1.8),navigator.vibrate&&navigator.vibrate([15,40,15])}),new URLSearchParams(location.search).has(`tune`)&&Qv(()=>import(`./tuner-CvRp--RE.js`).then(e=>e.initTuner()),[],import.meta.url).catch(e=>console.error(`tuner failed to load:`,e));function ty(){if(!Y.wishes.length)return;let e=Math.min(...Y.wishes.map(e=>e.cycle)),t=Y.wishes.filter(t=>t.cycle===e),n=t[Math.random()*t.length|0];pg(kv(n.text,Y.cycles-n.cycle))}q(`startBtn`).addEventListener(`click`,()=>{q(`start`).classList.add(`hidden`),J.state=`play`,setTimeout(ty,2200)});function ny(){q(`start`).classList.add(`hidden`),J.state=`play`;let e=K.bench;Z.position.set(e.x,jf(e.x,e.z),e.z),J.camYaw=e.yaw,J.camPitch=e.pitch,J.camDist=e.distance,J.night=J.nightTarget=e.night}function ry(){let e=K.bench;Z.position.x=e.x,Z.position.z=e.z,J.camYaw=e.yaw,J.camPitch=e.pitch,J.camDist=e.distance,J.night=J.nightTarget=e.night}var iy=!0,ay=0;document.addEventListener(`visibilitychange`,()=>{document.hidden?(iy=!1,cancelAnimationFrame(ay),ay=0):iy||(iy=!0,$v.update(),ay||=requestAnimationFrame(oy))});function oy(){if(!iy)return;ay=requestAnimationFrame(oy),$v.update();let e=Math.min($v.getDelta(),K.loop.maxDelta);J.t+=e;let t=s_.x,n=s_.y;if(J.bench&&(ry(),t=n=0),!J.bench&&(l_.w||l_.arrowup)&&(n=-1),!J.bench&&(l_.s||l_.arrowdown)&&(n=1),!J.bench&&(l_.a||l_.arrowleft)&&(t=-1),!J.bench&&(l_.d||l_.arrowright)&&(t=1),!J.bench&&l_.q&&(J.camYaw+=ey.turnSpeed*e),!J.bench&&l_.e&&(J.camYaw-=ey.turnSpeed*e),!J.bench&&(l_.r||l_.f)){let t=+!!l_.f-!!l_.r;J.camPitch=Math.max(ey.pitchMin,Math.min(ey.pitchMax,J.camPitch+t*ey.pitchKeySpeed*e))}let r=sf(),i=-r.z,a=r.x;Uv(e),Jv(e,t,n,r,i,a),Wv(e,ty),zg(e),Cv(e),av(e),ug(e),$_(e,r.x,r.z,i,a),ih()}oy(),window.addEventListener(`resize`,()=>{qd.setSize(innerWidth,innerHeight),ah(innerWidth,innerHeight),Zd.aspect=innerWidth/innerHeight,Zd.updateProjectionMatrix()});export{K as t};