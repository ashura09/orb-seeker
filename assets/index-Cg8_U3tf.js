...
void main() {
	...
	if ( coord.x >= 1.0 ) {
		...
		}`},Om=class{constructor(){this.isPass=!0,this.enabled=!0,this.needsSwap=!0,this.clear=!1,this.renderToScreen=!1}setSize(){}render(){console.error(`THREE.Pass: .render() must be implemented in derived pass.`)}dispose(){}},km=new Wo(-1,1,1,-1,0,1),Am=new class extends Mr{constructor(){super(),this.setAttribute(`position`,new br([-1,3,0,-1,-1,0,3,-1,0],3)),this.setAttribute(`uv`,new br([0,2,0,0,2,0],2))}},jm=class{constructor(e){this._mesh=new W(Am,e)}dispose(){this._mesh.geometry.dispose()}render(e){e.render(this._mesh,km)}get material(){return this._mesh.material}set material(e){this._mesh.material=e}},Mm=class extends Om{constructor(e,t=`tDiffuse`){super(),this.textureID=t,this.uniforms=null,this.material=null,e instanceof Ua?(this.uniforms=e.uniforms,this.material=e):e&&(this.uniforms=Ba.clone(e.uniforms),this.material=new Ua({name:e.name===void 0?`unspecified`:e.name,defines:Object.assign({},e.defines),uniforms:this.uniforms,vertexShader:e.vertexShader,fragmentShader:e.fragmentShader})),this._fsQuad=new jm(this.material)}render(e,t,n){this.uniforms[this.textureID]&&(this.uniforms[this.textureID].value=n.texture),this._fsQuad.material=this.material,this.renderToScreen?(e.setRenderTarget(null),this._fsQuad.render(e)):(e.setRenderTarget(t),this.clear&&e.clear(e.autoClearColor,e.autoClearDepth,e.autoClearStencil),this._fsQuad.render(e))}dispose(){this.material.dispose(),this._fsQuad.dispose()}},Nm=class extends Om{constructor(e,t){super(),this.scene=e,this.camera=t,this.clear=!0,this.needsSwap=!1,this.inverse=!1}render(e,t,n){let r=e.getContext(),i=e.state;i.buffers.color.setMask(!1),i.buffers.depth.setMask(!1),i.buffers.color.setLocked(!0),i.buffers.depth.setLocked(!0);let a,o;this.inverse?(a=0,o=1):(a=1,o=0),i.buffers.stencil.setTest(!0),i.buffers.stencil.setOp(r.REPLACE,r.REPLACE,r.REPLACE),i.buffers.stencil.setFunc(r.ALWAYS,a,4294967295),i.buffers.stencil.setClear(o),i.buffers.stencil.setLocked(!0),e.setRenderTarget(n),this.clear&&e.clear(),e.render(this.scene,this.camera),e.setRenderTarget(t),this.clear&&e.clear(),e.render(this.scene,this.camera),i.buffers.color.setLocked(!1),i.buffers.depth.setLocked(!1),i.buffers.color.setMask(!0),i.buffers.depth.setMask(!0),i.buffers.stencil.setLocked(!1),i.buffers.stencil.setFunc(r.EQUAL,1,4294967295),i.buffers.stencil.setOp(r.KEEP,r.KEEP,r.KEEP),i.buffers.stencil.setLocked(!0)}},Pm=class extends Om{constructor(){super(),this.needsSwap=!1}render(e){e.state.buffers.stencil.setLocked(!1),e.state.buffers.stencil.setTest(!1)}},Fm=class{constructor(e,t){if(this.renderer=e,this._pixelRatio=e.getPixelRatio(),t===void 0){let n=e.getSize(new R);this._width=n.width,this._height=n.height,t=new Qt(this._width*this._pixelRatio,this._height*this._pixelRatio,{type:_}),t.texture.name=`EffectComposer.rt1`}else this._width=t.width,this._height=t.height;this.renderTarget1=t,this.renderTarget2=t.clone(),this.renderTarget2.texture.name=`EffectComposer.rt2`,this.writeBuffer=this.renderTarget1,this.readBuffer=this.renderTarget2,this.renderToScreen=!0,this.passes=[],this.copyPass=new Mm(Dm),this.copyPass.material.blending=0,this.timer=new ts}swapBuffers(){let e=this.readBuffer;this.readBuffer=this.writeBuffer,this.writeBuffer=e}addPass(e){this.passes.push(e),e.setSize(this._width*this._pixelRatio,this._height*this._pixelRatio)}insertPass(e,t){this.passes.splice(t,0,e),e.setSize(this._width*this._pixelRatio,this._height*this._pixelRatio)}removePass(e){let t=this.passes.indexOf(e);t!==-1&&this.passes.splice(t,1)}isLastEnabledPass(e){for(let t=e+1;t<this.passes.length;t++)if(this.passes[t].enabled)return!1;return!0}render(e){this.timer.update(),e===void 0&&(e=this.timer.getDelta());let t=this.renderer.getRenderTarget(),n=!1;for(let t=0,r=this.passes.length;t<r;t++){let r=this.passes[t];if(r.enabled!==!1){if(r.renderToScreen=this.renderToScreen&&this.isLastEnabledPass(t),r.render(this.renderer,this.writeBuffer,this.readBuffer,e,n),r.needsSwap){if(n){let t=this.renderer.getContext(),n=this.renderer.state.buffers.stencil;n.setFunc(t.NOTEQUAL,1,4294967295),this.copyPass.render(this.renderer,this.writeBuffer,this.readBuffer,e),n.setFunc(t.EQUAL,1,4294967295)}this.swapBuffers()}Nm!==void 0&&(r instanceof Nm?n=!0:r instanceof Pm&&(n=!1))}}this.renderer.setRenderTarget(t)}reset(e){if(e===void 0){let t=this.renderer.getSize(new R);this._pixelRatio=this.renderer.getPixelRatio(),this._width=t.width,this._height=t.height,e=this.renderTarget1.clone(),e.setSize(this._width*this._pixelRatio,this._height*this._pixelRatio)}this.renderTarget1.dispose(),this.renderTarget2.dispose(),this.renderTarget1=e,this.renderTarget2=e.clone(),this.writeBuffer=this.renderTarget1,this.readBuffer=this.renderTarget2}setSize(e,t){this._width=e,this._height=t;let n=this._width*this._pixelRatio,r=this._height*this._pixelRatio;this.renderTarget1.setSize(n,r),this.renderTarget2.setSize(n,r);for(let e=0;e<this.passes.length;e++)this.passes[e].setSize(n,r)}setPixelRatio(e){this._pixelRatio=e,this.setSize(this._width,this._height)}dispose(){this.renderTarget1.dispose(),this.renderTarget2.dispose(),this.copyPass.dispose()}},Im=class extends Om{constructor(e,t,n=null,r=null,i=null){super(),this.scene=e,this.camera=t,this.overrideMaterial=n,this.clearColor=r,this.clearAlpha=i,this.clear=!0,this.clearDepth=!1,this.needsSwap=!1,this.isRenderPass=!0,this._oldClearColor=new U}render(e,t,n){let r=e.autoClear;e.autoClear=!1;let i,a;this.overrideMaterial!==null&&(a=this.scene.overrideMaterial,this.scene.overrideMaterial=this.overrideMaterial),this.clearColor!==null&&(e.getClearColor(this._oldClearColor),e.setClearColor(this.clearColor,e.getClearAlpha())),this.clearAlpha!==null&&(i=e.getClearAlpha(),e.setClearAlpha(this.clearAlpha)),this.clearDepth==1&&e.clearDepth(),e.setRenderTarget(this.renderToScreen?null:n),this.clear===!0&&e.clear(e.autoClearColor,e.autoClearDepth,e.autoClearStencil),e.render(this.scene,this.camera),this.clearColor!==null&&e.setClearColor(this._oldClearColor),this.clearAlpha!==null&&e.setClearAlpha(i),this.overrideMaterial!==null&&(this.scene.overrideMaterial=a),e.autoClear=r}},Lm={name:`LuminosityHighPassShader`,uniforms:{tDiffuse:{value:null},luminosityThreshold:{value:1},smoothWidth:{value:1},defaultColor:{value:new U(0)},defaultOpacity:{value:0}},vertexShader:`
		...
		void main() {
			...
			gl_FragColor = mix( outputColor, texel, alpha );
				...
				}`})}};Rm.BlurDirectionX=new R(1,0),Rm.BlurDirectionY=new R(0,1);var zm={name:`OutputShader`,uniforms:{tDiffuse:{value:null},toneMappingExposure:{value:1}},vertexShader:`
		precision highp float;
		...
		}`},Bm=class extends Om{constructor(){super(),this.isOutputPass=!0,this.uniforms=Ba.clone(zm.uniforms),this.material=new Wa({name:zm.name,uniforms:this.uniforms,vertexShader:zm.vertexShader,fragmentShader:zm.fragmentShader}),this._fsQuad=new jm(this.material),this._outputColorSpace=null,this._toneMapping=null}render(e,t,n){this.uniforms.tDiffuse.value=n.texture,this.uniforms.toneMappingExposure.value=e.toneMappingExposure,(this._outputColorSpace!==e.outputColorSpace||this._toneMapping!==e.toneMapping)&&(this._outputColorSpace=e.outputColorSpace,this._toneMapping=e.toneMapping,this.material.defines={},V.getTransfer(this._outputColorSpace)===`srgb`&&(this.material.defines.SRGB_TRANSFER=``),this._toneMapping===1?this.material.defines.LINEAR_TONE_MAPPING=``:this._toneMapping===2?this.material.defines.REINHARD_TONE_MAPPING=``:this._toneMapping===3?this.material.defines.CINEON_TONE_MAPPING=``:this._toneMapping===4?this.material.defines.ACES_FILMIC_TONE_MAPPING=``:this._toneMapping===6?this.material.defines.AGX_TONE_MAPPING=``:this._toneMapping===7?this.material.defines.NEUTRAL_TONE_MAPPING=``:this._toneMapping===5&&(this.material.defines.CUSTOM_TONE_MAPPING=``),this.material.needsUpdate=!0),this.renderToScreen===!0?(e.setRenderTarget(null),this._fsQuad.render(e)):(e.setRenderTarget(t),this.clear&&e.clear(e.autoClearColor,e.autoClearDepth,e.autoClearStencil),this._fsQuad.render(e))}dispose(){this.material.dispose(),this._fsQuad.dispose()}},Vm=null;function Hm(){if(!q.bloom.enabled)return!1;Vm=new Fm(Fd),Vm.addPass(new Im(Id,zd));let e=new Rm(new R(innerWidth,innerHeight),q.bloom.strength,q.bloom.radius,q.bloom.threshold);return Vm.addPass(e),Vm.addPass(new Bm),Fd.info.autoReset=!1,!0}var Um=!1;function Wm(e){Um=!e}function Gm(){Vm&&!Um?(Fd.info.reset(),Vm.render()):(Fd.info.autoReset||Fd.info.reset(),Fd.render(Id,zd))}function Km(e,t){Vm&&Vm.setSize(e,t)}var qm={ORBS_ALL_FOUND:`orbs:all-found`,DUEL_CHALLENGE:`duel:challenge`,ITEM_BOUGHT:`shop:item-bought`,WISHES_ALL_COLLECTED:`wishes:all-collected`,CRAWL_TOGGLE:`player:crawl-toggle`,WHISTLE:`player:whistle`,LOADOUT_CHANGED:`loadout:changed`,JUMP:`player:jump`},Jm=new Map;function Ym(e,t){return Jm.has(e)||Jm.set(e,new Set),Jm.get(e).add(t),()=>Xm(e,t)}function Xm(e,t){Jm.get(e)?.delete(t)}function Zm(e,t){let n=Jm.get(e);if(!(!n||n.size===0))for(let r of[...n])try{r(t)}catch(t){console.error(`listener for "${e}" threw:`,t)}}var Qm=()=>q.loadout.slots,$m=e=>Xd(e)&&Jd.worn.includes(e),eh=()=>Jd.worn.filter(Xd),th=()=>eh().length;function nh(){let e=Qm();return e>0?Math.max(0,e-th()):1/0}function rh(e,t){if(!Xd(e))return{ok:!1,worn:!1,reason:`You do not have that.`};let n=$m(e);if(t&&!n){if(nh()<=0)return{ok:!1,worn:!1,reason:`You can only carry ${Qm()}. Take something off first.`};Jd.worn.push(e)}else if(!t&&n)Jd.worn=Jd.worn.filter(t=>t!==e);else return{ok:!0,worn:n,reason:``};return Yd(),Zm(qm.LOADOUT_CHANGED,e),{ok:!0,worn:t,reason:``}}var ih=e=>rh(e,!$m(e));function ah(e){return rh(e,!0).worn}var Z=new kn,oh=new kn;oh.position.y=.3,Z.add(oh);var sh=pd,ch=md,lh=Ud(sh),uh=Ud(hd),dh=Ud(zu),fh=new W(new Oa(.34,.4,.85,10),lh);fh.position.y=.55;var ph=new W(new Pa(.36,.06,8,18),Ud(Iu));ph.rotation.x=Math.PI/2,ph.position.y=.42;var mh=new W(new Na(.34,16,12),uh);mh.position.y=1.32;var hh=new W(new Na(.36,16,12,0,Math.PI*2,0,Math.PI*.62),lh);hh.position.y=1.33;var gh=new W(new Na(.24,12,10),dh);gh.scale.set(1,.85,.6),gh.position.set(0,1.26,.22);var _h=new W(new Na(.14,10,8),dh);_h.position.set(0,1.19,.36);var vh=new Na(.045,8,8),yh=Ud(Fu),bh=new W(vh,yh),xh=new W(vh,yh);bh.position.set(-.09,1.31,.42),xh.position.set(.09,1.31,.42);var Sh=new Na(.11,10,8),Ch=new W(Sh,uh),wh=new W(Sh,uh);Ch.position.set(-.36,1.36,.02),wh.position.set(.36,1.36,.02);var Th=new W(new Pa(.35,.035,6,20),Ud(Iu));Th.rotation.x=Math.PI/2,Th.position.y=1.44;var Eh=new W(new Ea(.08,.45,.03),Ud(Iu));Eh.position.set(.12,1.2,-.36),Eh.rotation.z=.3;var Dh=new Oa(.08,.09,.6,8),Oh=new W(Dh,lh),kh=new W(Dh,lh);Oh.position.set(-.42,.6,0),kh.position.set(.42,.6,0);var Ah=new Na(.09,8,8),jh=new W(Ah,uh),Mh=new W(Ah,uh);jh.position.set(-.42,.28,0),Mh.position.set(.42,.28,0);var Nh=[];for(let e=0;e<6;e++){let t=new W(new Na(.075-e*.006,8,6),uh);oh.add(t),Nh.push(t)}oh.add(fh,ph,mh,hh,gh,_h,bh,xh,Ch,wh,Th,Eh,Oh,kh,jh,Mh);function Ph(e){let t=new kn;t.position.set(e*.15,.46,0);let n=new W(new Oa(.1,.11,.44,8),lh);n.position.y=-.22;let r=new W(new Ea(.17,.1,.28),uh);return r.position.set(0,-.44,.05),t.add(n,r),Z.add(t),t}var Fh=Ph(-1),Ih=Ph(1);Z.traverse(e=>{e.isMesh&&(e.castShadow=!0,e.receiveShadow=!0)}),Id.add(Z);function Lh(e){oh.position.y=e?.02:.3,oh.rotation.x=e?1.15:0,Fh.rotation.z=e?-.35:0,Ih.rotation.z=e?.35:0}function Rh(e){Fh.rotation.x=e?-.7:0,Ih.rotation.x=e?-.4:0,Oh.rotation.x=e?-1.5:0,kh.rotation.x=e?-1.5:0}var zh={};function Bh(){if(zh.built)return;zh.built=!0;let e=new kn,t=new W(new Oa(.62,.62,.04,16),Ud(gd));t.position.y=1.62;let n=new W(new ka(.42,.32,16),Ud(_d));n.position.y=1.78,e.add(t,n),oh.add(e),zh.hat=e;let r=new kn,i=new W(new Oa(.1,.12,.22,8),Ud(Pu)),a=new W(new Na(.07,8,8),Wd(Nu[2])),o=Gd(vd,0,9);o.position.y=.3,r.add(i,a,o),r.position.set(.55,.22,.12),oh.add(r),zh.lantern=r,zh.lanternLight=o;let s=new W(new Pa(.55,.03,6,30),Wd(Pu));s.rotation.x=Math.PI/2,s.position.y=.5,oh.add(s),zh.charm=s}function Vh(){Bh(),lh.color.set($m(`cloak`)?ch:sh),zh.hat.visible=$m(`hat`),zh.lantern.visible=$m(`lantern`),zh.charm.visible=$m(`charm`)}Ym(qm.LOADOUT_CHANGED,Vh);var Hh=J(`pouch`),Uh=J(`fragCount`);function Wh(){Uh.textContent=Jd.fragments}function Gh(e){e.classList.remove(`bump`),e.offsetWidth,e.classList.add(`bump`)}function Kh(e){Jd.fragments+=e,Yd(),Wh(),Gh(Hh)}Wh();var qh=J(`toast`),Jh=0;function Yh(e,t=2.2){qh.classList.remove(`echo`),qh.textContent=e,qh.style.opacity=1,Jh=t}function Xh(e){Jh>0&&(Jh-=e,Jh<=0&&(qh.style.opacity=0))}var Zh=document.createElement(`span`);Zh.id=`orderTag`,Zh.className=`none`,J(`counter`).appendChild(Zh);function Qh(e,t){if(t===0){Zh.className=`none`,Zh.textContent=``;return}Zh.className=e?`kept`:`broken`,Zh.textContent=e?`in order`:`order broken`}function $h(e,t=5){Yh(e,t),qh.classList.add(`echo`)}J(`jumpBtn`).addEventListener(`pointerdown`,e=>{e.preventDefault(),Zm(qm.JUMP)});var eg=e=>e+([`th`,`st`,`nd`,`rd`][(e%100-20)%10]||[`th`,`st`,`nd`,`rd`][e%100]||`th`);function tg(e){if(!new URLSearchParams(location.search).has(`stats`))return;let t=document.createElement(`div`);t.id=`stats`,document.body.appendChild(t);let n=0,r=performance.now(),i=999;(function a(){requestAnimationFrame(a),n++;let o=performance.now();if(o-r>=500){let a=Math.round(n*1e3/(o-r));a<i&&(i=a),n=0,r=o;let s=e.info.render;t.textContent=`${a} fps (low ${i})  ${s.calls} calls  ${(s.triangles/1e3).toFixed(1)}k tris`}})()}var ng=e=>q.duel.opponentBase+e*q.duel.opponentPerTier;function rg(e,t=Math.random){let n=q.duel,r=t()<n.flawlessChance,i=n.lootBase+e+Math.floor(t()*n.lootVariance);return{loot:r?i*n.flawlessMultiplier:i,flawless:r}}function ig(e={}){let t=q.orbs,{count:n=7,inner:r=t.innerRadius,outer:i=t.outerRadius,minSpacing:a=t.minSpacing,minFromPlayer:o=t.minDistanceFromPlayer,playerX:s=0,playerZ:c=0,attempts:l=4e3,random:u=Math.random}=e,d=i-r,f=[],p=()=>{let e=u()*Math.PI*2,t=r+u()*d;return{x:Math.cos(e)*t,z:Math.sin(e)*t}},m=0;for(;f.length<n&&m++<l;){let e=p();Math.hypot(e.x-s,e.z-c)<o||f.every(t=>Math.hypot(t.x-e.x,t.z-e.z)>=a)&&f.push(e)}for(;f.length<n;)f.push(p());for(let e=f.length-1;e>0;e--){let t=u()*(e+1)|0;[f[e],f[t]]=[f[t],f[e]]}return f}var ag=Nu,og=new Na(.55,18,14),sg=[],cg=q.orbs.litAtOnce,lg=[];for(let e=0;e<cg;e++){let e=Gd(id,0,q.orbs.lightRange);e.visible=!1,Id.add(e),lg.push(e)}function ug(){let e=sg.filter(e=>!e.found).map(e=>({o:e,d:Math.hypot(e.x-Z.position.x,e.z-Z.position.z)})).sort((e,t)=>e.d-t.d).slice(0,cg);lg.forEach((t,n)=>{let r=e[n];r&&r.d<q.orbs.lightCutoff?(t.visible=!0,t.color.setHex(r.o.color),t.intensity=q.orbs.lightIntensity,t.position.set(r.o.x,r.o.mesh.position.y,r.o.z)):(t.visible=!1,t.intensity=0)})}for(let e=0;e<7;e++){let t=ag[e],n=new W(og,Ud(t,.6));n.add(new W(new Na(.9,14,10),Wd(t,.18)));let r=document.createElement(`canvas`);r.width=r.height=128;let i=r.getContext(`2d`);i.fillStyle=`#f6efdf`,i.beginPath(),i.arc(64,64,54,0,Math.PI*2),i.fill(),i.lineWidth=8,i.strokeStyle=Nd(t),i.stroke(),i.fillStyle=`#1b1a17`,i.font=`bold 72px Trebuchet MS, sans-serif`,i.textAlign=`center`,i.textBaseline=`middle`,i.fillText(String(e+1),64,68);let a=new Qr(new Rr({map:new Sa(r),transparent:!0}));a.position.y=1.35,a.scale.setScalar(.8),n.add(a),sg.push({x:0,z:0,mesh:n,color:t,found:!1,phase:Math.random()*6,n:e+1})}var dg=J(`counter`),fg=sg.map(e=>{let t=document.createElement(`i`);return t.textContent=e.n,t.style.setProperty(`--c`,Nd(e.color)),dg.appendChild(t),t});function pg(e=Math.random){Y.found=0,Y.orderKept=!0;let t=ig({playerX:Z.position.x,playerZ:Z.position.z,random:e});sg.forEach((e,n)=>{e.x=t[n].x,e.z=t[n].z,e.found=!1,e.mesh.position.set(e.x,vf(e.x,e.z)+1.1,e.z),Id.add(e.mesh),fg[n].classList.remove(`on`)}),Qh(!0,0)}pg();function mg(e){e.n!==Y.found+1&&Y.orderKept?(Y.orderKept=!1,Yh(`Order broken at ${e.n}. One wish.`)):Y.found<6&&Yh(Y.orderKept?`Orb ${e.n} found, in order. ${Y.found+1} of 7`:`Orb ${e.n} found. ${Y.found+1} of 7`),e.found=!0,Y.found++,Id.remove(e.mesh),fg[sg.indexOf(e)].classList.add(`on`),navigator.vibrate&&navigator.vibrate(40),Qh(Y.orderKept,Y.found),Y.found===7&&(Yh(Y.orderKept?`All seven, in perfect order`:`All seven gathered`),Zm(qm.ORBS_ALL_FOUND))}var hg=J(`stick`),gg=J(`knob`),_g={active:!1,id:null,cx:0,cy:0,x:0,y:0},vg={active:!1,id:null,lastX:0,lastY:0},yg={},bg=55,xg=new Map,Sg={active:!1,candidate:!1,a:null,b:null,gap0:0,gap:0,dist0:0},Cg=(e,t)=>Math.hypot(e.x-t.x,e.y-t.y),wg=()=>_g.active?Math.hypot(_g.x,_g.y):0;function Tg(e){let t=q.camera;Y.camDist=Math.max(t.minDistance,Math.min(t.maxDistance,e))}var Eg=0;function Dg(){clearTimeout(Eg),Eg=setTimeout(()=>{Jd.camDist=Y.camDist,Yd()},250)}function Og(){_g.active=!1,_g.x=_g.y=0,hg.style.display=`none`}function kg(){if(Sg.active||Sg.candidate)return;let e=[...xg.keys()];e.length<2||(Sg.candidate=!0,[Sg.a,Sg.b]=e,Sg.gap0=Cg(xg.get(Sg.a),xg.get(Sg.b)))}function Ag(e){Sg.active=!0,Sg.candidate=!1,Og(),vg.active=!1,Sg.gap=e,Sg.dist0=Y.camDist}function jg(){let e=Sg.active;Sg.active=Sg.candidate=!1,Sg.a=Sg.b=null,e&&Dg();let t=[...xg.keys()];if(e&&t.length===1){let e=xg.get(t[0]);vg.active=!0,vg.id=t[0],vg.lastX=e.x,vg.lastY=e.y}}function Mg(e){xg.set(e.identifier,{x:e.clientX,y:e.clientY}),kg(),e.clientX<innerWidth*.5&&!_g.active?(_g.active=!0,_g.id=e.identifier,_g.cx=e.clientX,_g.cy=e.clientY,_g.x=_g.y=0,hg.style.display=`block`,hg.style.left=_g.cx+`px`,hg.style.top=_g.cy+`px`,gg.style.transform=`translate(-50%,-50%)`):vg.active||(vg.active=!0,vg.id=e.identifier,vg.lastX=e.clientX,vg.lastY=e.clientY)}function Ng(e){let t=xg.get(e.identifier);if(t&&(t.x=e.clientX,t.y=e.clientY),(Sg.active||Sg.candidate)&&(e.identifier===Sg.a||e.identifier===Sg.b)){let e=xg.get(Sg.a),t=xg.get(Sg.b);if(e&&t){let n=Cg(e,t);if(Sg.candidate){let e=q.camera;Math.abs(n-Sg.gap0)>e.pinchThreshold&&wg()<e.pinchJoyTolerance&&Ag(n)}if(Sg.active){n>1&&Tg(Sg.dist0*(Sg.gap/n));return}}}if(_g.active&&e.identifier===_g.id){let t=e.clientX-_g.cx,n=e.clientY-_g.cy,r=Math.hypot(t,n);r>bg&&(t*=bg/r,n*=bg/r),_g.x=t/bg,_g.y=n/bg,gg.style.transform=`translate(calc(-50% + ${t}px), calc(-50% + ${n}px))`}else if(vg.active&&e.identifier===vg.id){let t=q.camera;Y.camYaw-=(e.clientX-vg.lastX)*t.dragSensitivity;let n=(e.clientY-vg.lastY)*t.dragSensitivityY*(t.invertY?-1:1);Y.camPitch=Math.max(t.pitchMin,Math.min(t.pitchMax,Y.camPitch+n)),vg.lastX=e.clientX,vg.lastY=e.clientY}}function Pg(e){xg.delete(e.identifier),(Sg.active||Sg.candidate)&&(e.identifier===Sg.a||e.identifier===Sg.b)&&jg(),_g.active&&e.identifier===_g.id&&(_g.active=!1,_g.x=_g.y=0,hg.style.display=`none`),vg.active&&e.identifier===vg.id&&(vg.active=!1)}Pd.addEventListener(`touchstart`,e=>{e.preventDefault();for(let t of e.changedTouches)Mg(t)},{passive:!1}),Pd.addEventListener(`touchmove`,e=>{e.preventDefault();for(let t of e.changedTouches)Ng(t)},{passive:!1}),Pd.addEventListener(`touchend`,e=>{for(let t of e.changedTouches)Pg(t)}),Pd.addEventListener(`touchcancel`,e=>{for(let t of e.changedTouches)Pg(t)}),Pd.addEventListener(`wheel`,e=>{e.preventDefault(),Tg(Y.camDist*Math.exp(e.deltaY*q.camera.wheelStep)),Dg()},{passive:!1}),Pd.addEventListener(`mousedown`,e=>Mg({clientX:e.clientX,clientY:e.clientY,identifier:`m`})),window.addEventListener(`mousemove`,e=>Ng({clientX:e.clientX,clientY:e.clientY,identifier:`m`})),window.addEventListener(`mouseup`,()=>Pg({identifier:`m`})),window.addEventListener(`keydown`,e=>{let t=e.key.toLowerCase();e.repeat||(t===`c`&&Zm(qm.CRAWL_TOGGLE),t===`v`&&Zm(qm.WHISTLE),t===` `&&Zm(qm.JUMP)),t===` `&&e.preventDefault(),yg[t]=!0}),window.addEventListener(`keyup`,e=>yg[e.key.toLowerCase()]=!1);var Fg=[{name:`Bram the Woodcutter`,short:`Bram`,color:yd.bram.coat,hat:yd.bram.hat,skin:yd.bram.skin,build:1.1,headwear:`cap`,prop:`axe`},{name:`Nell the Herbalist`,short:`Nell`,color:yd.nell.coat,hat:yd.nell.hat,skin:yd.nell.skin,build:.92,headwear:`kerchief`,prop:`basket`},{name:`Pip the Courier`,short:`Pip`,color:yd.pip.coat,hat:yd.pip.hat,skin:yd.pip.skin,build:.85,headwear:`cap`,prop:`satchel`},{name:`Marla Stonehand`,short:`Marla`,color:yd.marla.coat,hat:yd.marla.hat,skin:yd.marla.skin,build:1.18,headwear:`none`,prop:`hammer`},{name:`Old Tarrow`,short:`Tarrow`,color:yd.tarrow.coat,hat:yd.tarrow.hat,skin:yd.tarrow.skin,build:.95,headwear:`brim`,prop:`staff`,beard:!0},{name:`Sable the Fencer`,short:`Sable`,color:yd.sable.coat,hat:yd.sable.hat,skin:yd.sable.skin,build:1,headwear:`none`,prop:`blade`},{name:`The Grey Pilgrim`,short:`the Pilgrim`,color:yd.pilgrim.coat,hat:yd.pilgrim.hat,skin:yd.pilgrim.skin,build:1.05,headwear:`hood`,prop:`staff`}],Ig={torso:new Oa(.3,.38,.8,10),head:new Na(.28,14,12),arm:new Oa(.075,.085,.55,7),hand:new Na(.085,7,6),leg:new Oa(.095,.105,.42,7),foot:new Ea(.16,.09,.26),eye:new Na(.035,6,6),cap:new ka(.34,.3,8),brim:new Oa(.46,.46,.035,12),crown:new ka(.3,.34,10),hood:new Na(.33,14,12,0,Math.PI*2,0,Math.PI*.6),kerchief:new Na(.3,12,10,0,Math.PI*2,0,Math.PI*.45),handle:new Oa(.035,.035,.9,6),staff:new Oa(.04,.045,1.7,6),axeHead:new Ea(.07,.26,.3),hammer:new Ea(.2,.2,.3),blade:new Ea(.045,.95,.1),bag:new Ea(.3,.26,.16),basket:new Oa(.19,.15,.22,9),beard:new ka(.17,.34,8)},Lg=Ud(Fu),Rg=Ud(Lu),zg=Ud(bd),Bg=Ud(Pu),Vg=Ud(xd),Hg=Ud(Sd),Ug=Ud(Cd),Wg=Ud(wd),Gg=Ud(Td),Kg=Ud(Ed),qg=new Ga({vertexColors:!0,roughness:q.render.roughness,metalness:0});function Jg(e){e.updateMatrix();let t=e.geometry.clone().applyMatrix4(e.matrix),n=t.attributes.position.count,r=new Float32Array(n*3),{r:i,g:a,b:o}=e.material.color;for(let e=0;e<n;e++)r[e*3]=i,r[e*3+1]=a,r[e*3+2]=o;return t.setAttribute(`color`,new _r(r,3)),t}function Yg(e){let t=new kn,n=[],r=(...e)=>n.push(...e),i=Ud(e.color),a=Ud(e.skin),o=Ud(e.hat),s=e.build,c=new W(Ig.torso,i);c.position.y=.86*s,c.scale.setScalar(s);let l=new W(Ig.head,a);if(l.position.y=1.48*s,r(c,l),[-1,1].forEach(e=>{let t=new W(Ig.eye,Lg);t.position.set(e*.1*s,1.52*s,.245*s),r(t)}),e.beard){let e=new W(Ig.beard,Ug);e.position.set(0,1.3*s,.16*s),e.rotation.x=Math.PI,r(e)}let u={arms:[],legs:[]};if([-1,1].forEach(e=>{let n=new kn;n.position.set(e*.38*s,1.16*s,0);let r=new W(Ig.arm,i);r.position.y=-.27;let o=new W(Ig.hand,a);o.position.y=-.56,n.add(new W(Mf([r,o].map(Jg),!1),qg)),t.add(n),u.arms.push(n);let c=new kn;c.position.set(e*.15*s,.46*s,0);let l=new W(Ig.leg,Hg);l.position.y=-.21;let d=new W(Ig.foot,Rg);d.position.set(0,-.42,.05),c.add(new W(Mf([l,d].map(Jg),!1),qg)),t.add(c),u.legs.push(c)}),e.headwear===`cap`){let e=new W(Ig.cap,o);e.position.y=1.72*s,r(e)}else if(e.headwear===`brim`){let e=new W(Ig.brim,o);e.position.y=1.66*s;let t=new W(Ig.crown,o);t.position.y=1.82*s,r(e,t)}else if(e.headwear===`hood`){let e=new W(Ig.hood,o);e.position.y=1.5*s,r(e)}else if(e.headwear===`kerchief`){let e=new W(Ig.kerchief,o);e.position.y=1.5*s,r(e)}let d=.38*s,f=.72*s,p=.12;if(e.prop===`axe`){let e=new W(Ig.handle,Rg);e.position.set(d,f,p),e.rotation.z=.25;let t=new W(Ig.axeHead,zg);t.position.set(d+.16,f+.42,p),r(e,t)}else if(e.prop===`hammer`){let e=new W(Ig.handle,Rg);e.position.set(d,f,p),e.rotation.z=.2;let t=new W(Ig.hammer,zg);t.position.set(d+.13,f+.44,p),r(e,t)}else if(e.prop===`blade`){let e=new W(Ig.blade,zg);e.position.set(d,f+.35,p),e.rotation.z=.12;let t=new W(Ig.hand,Bg);t.position.set(d,f-.1,p),r(e,t)}else if(e.prop===`staff`){let e=new W(Ig.staff,Rg);e.position.set(d,f+.36,p),e.rotation.z=.06,r(e)}else if(e.prop===`satchel`){let e=new W(Ig.bag,Wg);e.position.set(-.34*s,.8*s,.1),e.rotation.z=-.15;let t=new W(Ig.handle,Gg);t.position.set(-.1*s,1.15*s,.05),t.rotation.z=Math.PI/2.6,r(e,t)}else if(e.prop===`basket`){let e=new W(Ig.basket,Vg);e.position.set(d,f,.1);let t=new W(Ig.hand,Kg);t.position.set(d,f+.14,.1),t.scale.set(1.6,.7,1.6),r(e,t)}return t.add(new W(Mf(n.map(Jg),!1),qg)),t.traverse(e=>{e.isMesh&&(e.castShadow=!0,e.receiveShadow=!0)}),Id.add(t),{g:t,limbs:u}}var Xg=Fg.map((e,t)=>{let{g:n,limbs:r}=Yg(e);return{...e,g:n,limbs:r,tier:t+1,hx:0,hz:0,tx:0,tz:0,wait:0,cooldown:0,bob:Math.random()*6}});function Zg(e=Math.random){Xg.forEach((t,n)=>{t.hx=sg[n].x,t.hz=sg[n].z;let r=q.wanderers,i=e()*Math.PI*2,a=r.campRadiusMin+e()*(r.campRadiusMax-r.campRadiusMin),o=t.hx+Math.cos(i)*a,s=t.hz+Math.sin(i)*a;t.g.position.set(o,vf(o,s),s),Qg(t)})}function Qg(e){let t=q.wanderers,n=Math.random()*Math.PI*2,r=Math.random()*t.roamRadius;e.tx=Math.max(-Zd+5,Math.min(Zd-5,e.hx+Math.cos(n)*r)),e.tz=Math.max(-Zd+5,Math.min(Zd-5,e.hz+Math.sin(n)*r)),e.wait=t.waitMin+Math.random()*(t.waitMax-t.waitMin)}Zg();function $g(e,t){let n=t?Math.sin(e.bob):0;e.limbs.arms[0].rotation.x=n*.55,e.limbs.arms[1].rotation.x=-n*.55,e.limbs.legs[0].rotation.x=-n*.5,e.limbs.legs[1].rotation.x=n*.5}function e_(e){if(Y.bench)return;let t=q.wanderers,n=$m(`bell`)?t.hearingWithBell:t.hearingRange;Y.crawling&&(n*=t.crawlHearingMultiplier),Y.whistleT>0&&(n=Math.max(n,t.whistleRange));for(let r of Xg){r.cooldown=Math.max(0,r.cooldown-e);let i=Z.position.x-r.g.position.x,a=Z.position.z-r.g.position.z,o=Math.hypot(i,a),s=o<n&&r.cooldown===0&&!Y.ceremony;s&&(r.tx=Z.position.x,r.tz=Z.position.z,r.wait=0);let c=r.tx-r.g.position.x,l=r.tz-r.g.position.z,u=Math.hypot(c,l);if(u>.5){let n=s?t.huntSpeed:t.roamSpeed;r.g.position.x+=c/u*n*e,r.g.position.z+=l/u*n*e,r.g.rotation.y=Math.atan2(c,l),r.bob+=e*t.bobRate,r.g.position.y=vf(r.g.position.x,r.g.position.z)+Math.abs(Math.sin(r.bob))*.1,$g(r,!0)}else r.g.position.y=vf(r.g.position.x,r.g.position.z),r.wait-=e,r.wait<=0&&Qg(r),$g(r,!1);Y.state===`play`&&s&&o<t.challengeRange&&Zm(qm.DUEL_CHALLENGE,r)}}var t_=[{id:`boots`,name:`Swift boots`,desc:`Walk 40% faster.`,cost:12,color:Ad.boots},{id:`lens`,name:`Long lens`,desc:`Finder sees 50% farther.`,cost:10,color:Ad.lens},{id:`grip`,name:`Duelist grip`,desc:`Each tap counts more in duels.`,cost:18,color:Ad.grip},{id:`lantern`,name:`Brass lantern`,desc:`Carry your own light for the dark.`,cost:8,color:Ad.lantern},{id:`hat`,name:`Straw hat`,desc:`A wide hat, worn over the hood.`,cost:6,color:Ad.hat},{id:`cloak`,name:`Violet suit`,desc:`A new color for your ninja suit.`,cost:9,color:Ad.cloak},{id:`charm`,name:`Orbit charm`,desc:`A small ring that circles your sash.`,cost:14,color:Ad.charm},{id:`bell`,name:`Silver bell`,desc:`Wanderers hear you and seek you from farther.`,cost:16,color:Ad.bell}];function n_(e){return t_.find(t=>t.id===e)}function r_(){let e=J(`shopItems`);e.innerHTML=``;for(let t of t_){let n=document.createElement(`div`);n.className=`item`;let r=document.createElement(`div`);r.className=`row`;let i=document.createElement(`div`);i.className=`swatch`,i.style.background=Nd(t.color);let a=document.createElement(`div`);a.innerHTML=`<div class="name">${t.name}</div><div class="desc">${t.desc}</div>`,r.append(i,a),n.appendChild(r);let o=Jd.items[t.id];if(o){let e=document.createElement(`span`);e.className=`owned`,e.textContent=o===`owned`?`Kept`:`Set down for you`,n.appendChild(e)}else{let e=document.createElement(`button`);e.textContent=`${t.cost} ◆`,e.disabled=Jd.fragments<t.cost,e.addEventListener(`click`,()=>{Jd.fragments-=t.cost,Jd.items[t.id]=`bought`,Yd(),Wh(),r_(),Zm(qm.ITEM_BOUGHT,t.id),Yh(`${t.name} set down beside you`)}),n.appendChild(e)}e.appendChild(n)}}Hh.addEventListener(`click`,()=>{Y.state===`play`&&(Y.state=`shop`,r_(),J(`shop`).classList.remove(`hidden`))}),J(`shopClose`).addEventListener(`click`,()=>{J(`shop`).classList.add(`hidden`),Y.state=`play`});var i_=[];function a_(e,t,n){let r=new kn;if(e===`item`){let n=n_(t),i=new W(new Ea(.7,.45,.5),Ud(Dd)),a=new W(new Ea(.74,.18,.54),Ud(n.color,.35));a.position.y=.32;let o=new W(new Ea(.12,.14,.06),Ud(Pu));o.position.set(0,.22,.28),r.add(i,a,o,Gd(n.color,.9,6)),r.userData={kind:e,id:t}}else{let n=new W(new ja(.42,0),Ud(Od,.9));n.add(new W(new Na(.7,12,10),Wd(kd,.2))),n.add(Gd(Od,1.2,8)),r.add(n),r.userData={kind:e,text:t}}let i=n===void 0?Math.random()*Math.PI*2:n,a=Z.position.x+Math.cos(i)*3.2,o=Z.position.z+Math.sin(i)*3.2;r.position.set(a,vf(a,o)+.7,o),Id.add(r),i_.push({g:r,kind:e,phase:Math.random()*6})}function o_(e,t){if(Id.remove(e.g),i_.splice(t,1),e.kind===`item`){let t=e.g.userData.id;Jd.items[t]=`owned`,Yd();let n=ah(t);Vh(),Yh(n?`${n_(t).name} — worn`:`${n_(t).name} added. No room to wear it; open your satchel.`,n?2:3)}else Jd.wishes.push({text:e.g.userData.text,cycle:Jd.cycles}),Yd(),Yh(`Wish kept: “${e.g.userData.text}”`,3);Gh(J(`satchelBtn`)),navigator.vibrate&&navigator.vibrate([30,30,60]),Y.ceremony&&!i_.some(e=>e.kind===`wish`)&&Zm(qm.WISHES_ALL_COLLECTED)}function s_(){let e=J(`satchelWishes`);e.innerHTML=``,Jd.wishes.length||(e.innerHTML=`<div class="empty">No wishes yet. Gather the seven orbs.</div>`),Jd.wishes.forEach(t=>{let n=document.createElement(`div`);n.className=`wishrow`,n.innerHTML=`<span class="star">✦</span><div><div>“${t.text.replace(/</g,`&lt;`)}”</div><div class="meta">Granted on your ${eg(t.cycle)} gathering</div></div>`,e.appendChild(n)});let t=J(`satchelItems`);t.innerHTML=``;let n=t_.filter(e=>Xd(e.id));n.length||(t.innerHTML=`<div class="empty">Nothing yet. Win duels and visit the trader.</div>`);let r=Qm();if(n.length&&r>0){let e=document.createElement(`div`);e.className=`slotline`,e.textContent=`Worn ${th()} of ${r}`,t.appendChild(e)}n.forEach(e=>{let n=$m(e.id),r=document.createElement(`div`);r.className=`item`+(n?` isworn`:``),r.innerHTML=`<div class="row"><div class="swatch" style="background:${Nd(e.color)}"></div><div><div class="name">${e.name}</div><div class="desc">${e.desc}</div></div></div>`;let i=document.createElement(`button`);i.textContent=n?`Take off`:`Wear`,i.addEventListener(`click`,()=>{let t=ih(e.id);if(!t.ok){Yh(t.reason,3);return}s_(),Gh(J(`satchelBtn`))}),r.appendChild(i),t.appendChild(r)})}Ym(qm.ITEM_BOUGHT,e=>a_(`item`,e)),J(`satchelBtn`).addEventListener(`click`,()=>{Y.state===`play`&&(Y.state=`satchel`,s_(),J(`satchel`).classList.remove(`hidden`))}),J(`satchelClose`).addEventListener(`click`,()=>{J(`satchel`).classList.add(`hidden`),Y.state=`play`});var Q=J(`rc`).getContext(`2d`),c_=J(`dist`),l_=0;function u_(e,t,n,r,i){let a=q.finder,o=$m(`lens`)?a.rangeWithLens:a.range,s=a.revealDistance;l_+=e*a.sweepSpeed,Q.clearRect(0,0,256,256),Q.strokeStyle=`rgba(143,245,200,0.25)`,Q.lineWidth=2,[.33,.66,1].forEach(e=>{Q.beginPath(),Q.arc(128,128,118*e,0,Math.PI*2),Q.stroke()}),Q.beginPath(),Q.moveTo(128,10),Q.lineTo(128,246),Q.moveTo(10,128),Q.lineTo(246,128),Q.stroke(),Q.save(),Q.translate(128,128),Q.rotate(l_);let c=Q.createLinearGradient(0,0,118,0);c.addColorStop(0,`rgba(143,245,200,0.35)`),c.addColorStop(1,`rgba(143,245,200,0)`),Q.fillStyle=c,Q.beginPath(),Q.moveTo(0,0),Q.arc(0,0,118,-.9,0),Q.closePath(),Q.fill(),Q.restore();let l=(e,a)=>{let s=e-Z.position.x,c=a-Z.position.z;return[(s*r+c*i)/o*118,-(s*t+c*n)/o*118,Math.hypot(s,c)]},u=1/0;for(let e of sg){if(e.found)continue;let[t,n,r]=l(e.x,e.z);u=Math.min(u,r);let i=Math.hypot(t,n),a=i<=118,o=r<=s;a||(t*=112/i,n*=112/i),Q.fillStyle=o?Nd(e.color):`#f6efdf`,Q.globalAlpha=a?.75+.25*Math.sin(performance.now()/250+e.phase):.4,Q.beginPath(),Q.arc(128+t,128+n,o?10:a?7:5,0,Math.PI*2),Q.fill(),o&&(Q.fillStyle=`#1b1a17`,Q.font=`bold 13px Trebuchet MS, sans-serif`,Q.textAlign=`center`,Q.textBaseline=`middle`,Q.fillText(e.n,128+t,128+n+1)),Q.globalAlpha=1}Q.strokeStyle=`#f6efdf`,Q.lineWidth=2.5;for(let e of Xg){let[t,n,r]=l(e.g.position.x,e.g.position.z);Math.hypot(t,n)>110||(Q.globalAlpha=e.cooldown>0?.35:.9,Q.strokeStyle=`#f6efdf`,Q.beginPath(),Q.moveTo(128+t,128+n-8),Q.lineTo(128+t+8,128+n),Q.lineTo(128+t,128+n+8),Q.lineTo(128+t-8,128+n),Q.closePath(),Q.stroke(),r<=s&&(Q.fillStyle=`#f6efdf`,Q.font=`bold 10px Trebuchet MS, sans-serif`,Q.textAlign=`center`,Q.textBaseline=`middle`,Q.fillText(e.tier,128+t,128+n+1)),Q.globalAlpha=1)}Q.fillStyle=`#ffe9b0`;for(let e of i_){let[t,n]=l(e.g.position.x,e.g.position.z);Math.hypot(t,n)>110||Q.fillRect(128+t-4,128+n-4,8,8)}Q.fillStyle=`#f6efdf`,Q.beginPath(),Q.moveTo(128,119),Q.lineTo(135,135),Q.lineTo(121,135),Q.closePath(),Q.fill(),c_.textContent=u===1/0?``:`Nearest orb: ${Math.round(u)} m`}var d_=q.map,f_=Zd*2,p_=new Uint8Array(d_.grid*d_.grid),m_=e=>Math.floor((e+Zd)/f_*d_.grid),h_=0;function g_(e){if(h_+=e,h_<.25)return;h_=0;let t=m_(Z.position.x),n=m_(Z.position.z),r=Math.ceil(d_.seeRadius/f_*d_.grid);for(let e=n-r;e<=n+r;e++)if(!(e<0||e>=d_.grid))for(let i=t-r;i<=t+r;i++){if(i<0||i>=d_.grid)continue;let a=i-t,o=e-n;a*a+o*o<=r*r&&(p_[e*d_.grid+i]=1)}}function __(){p_.fill(0)}var v_=null,y_=-1;function b_(){let e=d_.resolution,t=document.createElement(`canvas`);t.width=t.height=e;let n=t.getContext(`2d`),r=n.createImageData(e,e),i=[63,143,191];for(let t=0;t<e;t++)for(let n=0;n<e;n++){let a=n/(e-1)*f_-Zd,o=t/(e-1)*f_-Zd,s=(t*e+n)*4;if(Math.hypot(a,o)>Zd){r.data[s]=24,r.data[s+1]=30,r.data[s+2]=26,r.data[s+3]=255;continue}let c,l,u;if(am(a,o))[c,l,u]=i;else{let{region:e,neighbour:t,blend:n}=nf(a,o),r=e.ground[0],i=t.ground[0];c=(r>>16&255)*(1-n)+(i>>16&255)*n,l=(r>>8&255)*(1-n)+(i>>8&255)*n,u=(r&255)*(1-n)+(i&255)*n}let d=f_/e,f=gf(a+d,o)-gf(a-d,o)+(gf(a,o+d)-gf(a,o-d)),p=Math.max(.55,Math.min(1.45,1+f*.16));r.data[s]=Math.min(255,c*p),r.data[s+1]=Math.min(255,l*p),r.data[s+2]=Math.min(255,u*p),r.data[s+3]=255}n.putImageData(r,0,0),v_=t,y_=cm}var x_=J(`mapc`),S_=x_.getContext(`2d`),C_=document.createElement(`canvas`);C_.width=C_.height=d_.grid;var w_=C_.getContext(`2d`);function T_(){(!v_||y_!==cm)&&b_();let e=x_.width;S_.clearRect(0,0,e,e),S_.imageSmoothingEnabled=!0,S_.drawImage(v_,0,0,e,e);let t=w_.createImageData(d_.grid,d_.grid);for(let e=0;e<p_.length;e++)t.data[e*4+3]=p_[e]?0:238;w_.putImageData(t,0,0),S_.drawImage(C_,0,0,e,e);let n=(t,n)=>[(t+Zd)/f_*e,(n+Zd)/f_*e],r=(e,t)=>{let n=m_(e),r=m_(t);return n>=0&&r>=0&&n<d_.grid&&r<d_.grid&&p_[r*d_.grid+n]};S_.font=`bold 13px Trebuchet MS, sans-serif`,S_.textAlign=`center`;for(let e of sm){if(!r(e.x,e.z))continue;let[t,i]=n(e.x,e.z);S_.fillStyle=`rgba(27,26,23,0.75)`,S_.beginPath(),S_.arc(t,i,5,0,Math.PI*2),S_.fill(),S_.fillStyle=`#f6efdf`,S_.fillText(e.name,t,i-10)}for(let e of sg){if(!e.found)continue;let[t,r]=n(e.x,e.z);S_.fillStyle=Nd(e.color),S_.beginPath(),S_.arc(t,r,6,0,Math.PI*2),S_.fill(),S_.fillStyle=`#1b1a17`,S_.fillText(e.n,t,r+4)}let[i,a]=n(Z.position.x,Z.position.z);S_.save(),S_.translate(i,a),S_.rotate(-Y.camYaw),S_.fillStyle=`#8ff5c8`,S_.beginPath(),S_.moveTo(0,-9),S_.lineTo(6,7),S_.lineTo(0,3),S_.lineTo(-6,7),S_.closePath(),S_.fill(),S_.restore()}var E_=J(`map`);function D_(){Y.state===`play`&&(Y.state=`map`,E_.classList.remove(`hidden`),requestAnimationFrame(()=>requestAnimationFrame(T_)))}function O_(){E_.classList.add(`hidden`),Y.state===`map`&&(Y.state=`play`)}J(`finder`).addEventListener(`click`,D_),J(`mapClose`).addEventListener(`click`,O_),window.addEventListener(`keydown`,e=>{e.repeat||e.key.toLowerCase()===`m`&&(Y.state===`map`?O_():D_())});function k_(e){Y.lowGraphics!==e&&(Y.lowGraphics=e,wm(!e),Wm(!e),F_(),Jd.lowGraphics!==e&&(Jd.lowGraphics=e,Yd()))}var A_=0,j_=0,M_=0;function N_(e){if(Y.lowGraphics)return;let t=q.graphics;A_+=e,j_++,!(A_<t.sampleSeconds)&&(M_=j_/A_<t.autoLowFps?M_+A_:0,A_=0,j_=0,M_>=t.autoLowSeconds&&k_(!0))}function P_(){F_(),(Jd.lowGraphics||q.graphics.forceLow)&&k_(!0)}function F_(){Y.propBudget=Y.lowGraphics?q.graphics.lowProps:q.world.props}var I_={Bram:{challenge:`One orb. That is all I ever carried out of this valley. Let us see if your arms are better than mine were.`,theyWin:`Ha! Still in me somewhere. Go on — the rest of them are worse than me.`,theyLose:`Quick hands. I wish I had had them when it counted.`},Nell:{challenge:`The second is mine. Not that I wanted the others — there are better things growing out here than wishes.`,theyWin:`Patience beats hurry. Ask the moss, it has been here longer.`,theyLose:`Off you go, then. Mind the nettles down by the water.`},Pip:{challenge:`Third! Third, and I would have had the lot, only I grabbed them out of order like a fool. Come on, quickly.`,theyWin:`Too slow! Everyone is always too slow.`,theyLose:`Fine. You are quick. Do not be quick about the order, though. That is how you end up camped by the third.`},Marla:{challenge:`Four. Halfway, near enough. You will not rush me.`,theyWin:`Hands like stone. I did say.`,theyLose:`Hm. Good. Take it.`},Tarrow:{challenge:`The fifth. I have watched a great many people walk past me, and rather fewer walk back. Let us see which you are.`,theyWin:`No shame in it. I have lost at this spot more times than you have stood on it.`,theyLose:`Go on, then. And when it asks you — think before you speak.`},Sable:{challenge:`Six. Twice I stood here, and twice I turned around. You will do no better.`,theyWin:`As I thought. The sixth keeps its own.`,theyLose:`Again? Then go. Go and see what is past it, and come back and tell me.`},"the Pilgrim":{challenge:`I have been where you are going.`,theyWin:`Then you are not ready. Good.`,theyLose:`Go. Ask carefully.`}},L_={challenge:`A duel, then. Ten seconds.`,theyWin:`Better luck further out.`,theyLose:`Well fought.`};function R_(e){return I_[e]||L_}function z_(e,t){let n=`“${e}”`;return t<=0?`You asked for ${n} not long ago.`:t===1?`One gathering ago you asked for ${n}.`:`${t} gatherings ago you asked for ${n}.`}var B_=J(`duel`),V_=q.duel,$={w:null,you:0,them:0,time:V_.seconds,ready:V_.countdown,waiting:!0,over:!1};function H_(e){Y.state=`duel`,$.w=e,$.you=0,$.them=0,$.time=V_.seconds,$.ready=V_.countdown,$.waiting=!0,$.over=!1,_g.active=!1,_g.x=_g.y=0,hg.style.display=`none`;let t=[`a gentle`,`an easy`,`a steady`,`a quick`,`a fast`,`a fierce`,`a blistering`][e.tier-1];J(`duelWho`).textContent=`“${R_(e.short).challenge}”`,J(`duelRules`).textContent=`${e.name} keeps camp by orb ${e.tier}, so expect ${t} pace. Ten seconds: tap to fill your bar before theirs.`,J(`resultSay`).textContent=``,J(`themName`).textContent=e.short,J(`duelPlay`).style.display=`block`,J(`duelResult`).style.display=`none`,J(`duelStart`).style.display=`inline-block`,J(`tapzone`).style.display=`none`,J(`tapzone`).textContent=`Get ready…`,U_(),B_.classList.remove(`hidden`),navigator.vibrate&&navigator.vibrate(30)}J(`duelStart`).addEventListener(`click`,()=>{$.waiting=!1,J(`duelStart`).style.display=`none`,J(`tapzone`).style.display=`flex`});function U_(){J(`timer`).textContent=$.waiting?V_.seconds.toFixed(1):$.ready>0?String(Math.ceil($.ready)):Math.max(0,$.time).toFixed(1);let e=Math.min(100,$.you*100),t=Math.min(100,$.them*100);J(`youBar`).style.width=e+`%`,J(`youPct`).textContent=Math.round(e)+`%`,J(`themBar`).style.width=t+`%`,J(`themPct`).textContent=Math.round(t)+`%`}function W_(){Y.state!==`duel`||$.over||$.waiting||$.ready>0||($.you+=$m(`grip`)?V_.tapValueWithGrip:V_.tapValue,navigator.vibrate&&navigator.vibrate(8),U_(),$.you>=1&&K_(!0))}J(`tapzone`).addEventListener(`touchstart`,e=>{e.preventDefault(),W_()},{passive:!1}),J(`tapzone`).addEventListener(`mousedown`,W_),window.addEventListener(`keydown`,e=>{e.code===`Space`&&W_()});function G_(e){if(!($.over||$.waiting)){if($.ready>0){$.ready-=e,$.ready<=0&&(J(`tapzone`).textContent=`Tap!`,navigator.vibrate&&navigator.vibrate(25)),U_();return}$.time-=e,$.them+=e*ng($.w.tier),U_(),$.them>=1?K_(!1):$.time<=0&&K_($.you>$.them)}}function K_(e){$.over=!0;let t,n=$.w.short;if(e){Jd.wins++;let e=rg($.w.tier);t=e.loot;let r=e.flawless;J(`resultBig`).textContent=r?`Flawless!`:`You win`,J(`resultSay`).textContent=`“${R_($.w.short).theyLose}”`,J(`resultLoot`).textContent=`${n} hands over ${t} fragments.`,navigator.vibrate&&navigator.vibrate([40,40,80])}else t=V_.consolation,J(`resultBig`).textContent=`Outpaced`,J(`resultSay`).textContent=`“${R_($.w.short).theyWin}”`,J(`resultLoot`).textContent=`${n} wins, but tosses you ${t} fragment for the effort.`;Kh(t),$.w.cooldown=q.wanderers.cooldown,Qg($.w),setTimeout(()=>{J(`duelPlay`).style.display=`none`,J(`duelResult`).style.display=`block`},V_.resultDelay)}J(`duelDone`).addEventListener(`click`,()=>{B_.classList.add(`hidden`),Y.state=`play`}),Ym(qm.DUEL_CHALLENGE,H_);var q_=new kn,J_={wings:[],tail:[],neck:[],eyes:[],sparks:null,ring:null,built:!1},Y_=[];function X_(e){let t=Y.t;q_.position.y=Math.sin(t*1.1)*.35+.4,J_.wings.forEach(e=>{e.pivot.rotation.z=e.s*(.25+Math.sin(t*2.2+e.phase)*.45)}),J_.head.position.y=10.6+Math.sin(t*1.6)*.15,J_.head.rotation.x=Math.sin(t*.9)*.08,J_.neck.forEach((e,n)=>{e.position.x=Math.sin(t*1.6+n*.5)*.15*n/4}),J_.tail.forEach((e,n)=>{let r=n+1;e.position.set(Math.sin(t*1.5-r*.5)*.35*r*.5,6-r*.45+Math.sin(t*1.2-r*.4)*.2,-3.6-r*.75)});let n=J_.tail[7];J_.tailTip.position.set(n.position.x,n.position.y,n.position.z-.8),J_.tailTip.rotation.x=-Math.PI/2;let r=.7+.3*Math.sin(t*4);J_.eyes.forEach(e=>e.material.opacity=r),J_.eyes.forEach(e=>e.material.transparent=!0),J_.ring.rotation.z+=e*.4,J_.ring.scale.setScalar(1+Math.sin(t*2)*.03);let i=J_.sparks.geometry.attributes.position;for(let t=0;t<i.count;t++){let n=i.getY(t)+e*1.6;n>13&&(n=0),i.setY(t,n)}i.needsUpdate=!0}var Z_=q.dayNight,Q_=q.ceremony;function $_(e){let t=Y.night;Y.night+=(Y.nightTarget-Y.night)*Math.min(1,e*Z_.easeRate),(Math.abs(Y.night-t)>.001||Y.t<.2)&&bm(Y.night),Id.fog.color.copy(Ld).lerp(Rd,Y.night),Em(Y.night),zh.lantern?.visible&&(zh.lanternLight.intensity=Z_.lanternBase+Y.night*Z_.lanternNightBoost),Tm(Z.position.x,Z.position.y,Z.position.z),Y.whistleT>0&&(Y.whistleT=Math.max(0,Y.whistleT-e)),Y.whistleCd>0&&(Y.whistleCd=Math.max(0,Y.whistleCd-e))}function ev(e,t){if(Y.state===`duel`){G_(e);let t=$.w,n=t.g.position.x-Z.position.x,r=t.g.position.z-Z.position.z;Z.rotation.y=Math.atan2(n,r),t.g.rotation.y=Math.atan2(-n,-r),t.g.position.y=$.over?0:Math.abs(Math.sin(Y.t*14))*.08}if(Y.state===`ending`){Y.endT+=e;let t=Math.min(Y.endT/Q_.riseSeconds,1);if(Y_.forEach(({m:e,i:n})=>{let r=n/7*Math.PI*2+Y.endT*1.2;e.position.set(Z.position.x+Math.cos(r)*(1.5+2*t),1.5+5*t+Math.sin(Y.endT*3+n)*.2,Z.position.z+Math.sin(r)*(1.5+2*t))}),Y.endT>Q_.keeperGrowDelay&&q_.scale.setScalar(.001+Math.min((Y.endT-Q_.keeperGrowDelay)/Q_.keeperGrowSeconds,1)),Y.endT>Q_.wishPromptAt){Y.state=`wish`,J(`wish`).classList.remove(`hidden`);let e=document.querySelector(`.wishInput`);e&&e.focus()}}if(Y.state===`wish`&&Y_.forEach(({m:e,i:t})=>{let n=t/7*Math.PI*2+Y.t*1.2;e.position.set(Z.position.x+Math.cos(n)*3.5,6.5+Math.sin(Y.t*3+t)*.2,Z.position.z+Math.sin(n)*3.5)}),Y.ceremony&&J_.built&&X_(e),Y.departT>=0){Y.departT+=e;let t=Math.min(Y.departT/Q_.departSeconds,1);q_.position.y+=e*6*t,q_.scale.setScalar(1-t*.9),Y.departT>=Q_.departSeconds&&(Id.remove(q_),Y.departT=-1,Y.ceremony=!1,Y.nightTarget=0,Y.respawnT=Q_.respawnSeconds,J(`hint`).style.opacity=.75)}Y.respawnT>0&&(Y.respawnT-=e,Y.respawnT<=0&&(Y.respawnT=-1,Y.worldSeed=Md(),lm(Y.worldSeed),__(),pg(),Zg(),Yh(`The valley has shifted, and the seven orbs are scattered again`,3.5),setTimeout(t,3600)))}var tv=q.player,nv=q.orbs,rv=0;function iv(e,t,n,r,i,a){if(Y.state===`play`){let o=Math.hypot(t,n),s=!1;if(o>.08){let c=am(Z.position.x,Z.position.z),l=Math.min(o,1)*($m(`boots`)?tv.bootsMultiplier:1)*(Y.crawling?tv.crawlSpeedMultiplier:1)*(c?q.water.wadeSpeed:1),u=r.x*-n+i*t,d=r.z*-n+a*t,f=Math.hypot(u,d)||1;Z.position.x+=u/f*tv.speed*l*e,Z.position.z+=d/f*tv.speed*l*e,Z.rotation.y=Math.atan2(u,d),rv+=e*tv.bobRate*l,s=!0}let c=Math.hypot(Z.position.x,Z.position.z);c>Zd&&(Z.position.x*=Zd/c,Z.position.z*=Zd/c);for(let e of qp){if(Z.position.y>e.top+tv.jumpClearance)continue;let t=Z.position.x-e.x,n=Z.position.z-e.z,r=Math.hypot(t,n),i=e.r+tv.radius;r<i&&r>1e-4&&(Z.position.x=e.x+t/r*i,Z.position.z=e.z+n/r*i)}let l=vf(Z.position.x,Z.position.z);Y.airborne?(Y.vy-=tv.gravity*e,Y.airY+=Y.vy*e,Y.airY<=l&&(Y.airY=l,Y.vy=0,Y.airborne=!1,Rh(!1),navigator.vibrate&&navigator.vibrate(18)),Z.position.y=Y.airY):Z.position.y=l+Math.abs(Math.sin(rv))*tv.bobHeight,Y.airborne||(Oh.rotation.x=s?Math.sin(rv)*.6:0,kh.rotation.x=s?-Math.sin(rv)*.6:0,jh.position.z=Math.sin(Oh.rotation.x)*.3,Mh.position.z=Math.sin(kh.rotation.x)*.3,Fh.rotation.x=s?-Math.sin(rv)*.5:0,Ih.rotation.x=s?Math.sin(rv)*.5:0);for(let t of sg)t.found||(t.mesh.position.y=vf(t.x,t.z)+1.1+Math.sin(Y.t*2+t.phase)*.25,t.mesh.rotation.y+=e,Math.hypot(t.x-Z.position.x,t.z-Z.position.z)<nv.pickupRadius&&mg(t));for(let t=i_.length-1;t>=0;t--){let n=i_[t];n.g.position.y=vf(n.g.position.x,n.g.position.z)+.7+Math.sin(Y.t*2.5+n.phase)*.15,n.g.rotation.y+=e*1.2,Math.hypot(n.g.position.x-Z.position.x,n.g.position.z-Z.position.z)<1.5&&o_(n,t)}e_(e)}ug(),Nh.forEach((e,t)=>{let n=t+1;e.position.set(Math.sin(Y.t*3-n*.6)*.06*n,.35+n*.06+Math.sin(Y.t*2+n)*.02,-.38-n*.09)}),zh.charm&&(zh.charm.rotation.z+=e*1.5)}var av=q.camera,ov=new z;function sv(e,t,n,r,i){let a=Z.position.x,o=Z.position.z,s=n;for(let c of qp){if(c.r<av.blockRadius)continue;let l=c.x-a,u=c.z-o,d=l*e+u*t;if(d<=.5||d-c.r>s)continue;let f=c.r+av.clearance,p=Math.abs(l*t-u*e);if(p>=f)continue;let m=n>.01?d/n:0;r+(i-r)*m>c.top+av.overClearance||(s=Math.min(s,d-Math.sqrt(f*f-p*p)))}return Math.max(Math.min(av.minClear,n),s)}function cv(e){let t=Y.state===`ending`||Y.state===`wish`,n=t?av.cinematicDistance:Y.camDist,r=Y.camPitch,i=t?av.cinematicLookAt:av.lookAtHeight,a=Math.min(1,e*av.ease),o=Math.cos(r)*n,s=vf(Z.position.x,Z.position.z),c=Math.sin(Y.camYaw),l=Math.cos(Y.camYaw),u=s+i,d=sv(c,l,o,u,u+Math.sin(r)*n),f=o>.01?d/o:1,p=Z.position.x+c*d,m=Z.position.z+l*d,h=vf(p,m),g=s+i+Math.sin(r)*n*f,_=Math.max(g,h+av.minHeight),v=i+Math.max(0,-r)*n*av.lookUpGain;zd.position.x+=(p-zd.position.x)*a,zd.position.z+=(m-zd.position.z)*a,zd.position.y+=(_-zd.position.y)*a,ov.set(Z.position.x,s+v,Z.position.z),zd.lookAt(ov)}var lv=`modulepreload`,uv=function(e,t){return new URL(e,t).href},dv={},fv=function(e,t,n){let r=Promise.resolve();if(t&&t.length>0){let e=document.getElementsByTagName(`link`),i=document.querySelector(`meta[property=csp-nonce]`),a=i?.nonce||i?.getAttribute(`nonce`);function o(e){return Promise.all(e.map(e=>Promise.resolve(e).then(e=>({status:`fulfilled`,value:e}),e=>({status:`rejected`,reason:e}))))}function s(e){return import.meta.resolve?import.meta.resolve(e):new URL(e,import.meta.url).href}r=o(t.map(t=>{if(t=uv(t,n),t=s(t),t in dv)return;dv[t]=!0;let r=t.endsWith(`.css`);for(let n=e.length-1;n>=0;n--){let i=e[n];if(i.href===t&&(!r||i.rel===`stylesheet`))return}let i=document.createElement(`link`);if(i.rel=r?`stylesheet`:lv,r||(i.as=`script`),i.crossOrigin=``,i.href=t,a&&i.setAttribute(`nonce`,a),document.head.appendChild(i),r)return new Promise((e,n)=>{i.addEventListener(`load`,e),i.addEventListener(`error`,()=>n(Error(`Unable to preload CSS for ${t}`)))})}))}function i(e){let t=new Event(`vite:preloadError`,{cancelable:!0});if(t.payload=e,window.dispatchEvent(t),!t.defaultPrevented)throw e}return r.then(t=>{for(let e of t||[])e.status===`rejected`&&i(e.reason);return e().catch(i)})};for(let e in Jd.items)Jd.items[e]===`bought`&&a_(`item`,e);Vh();var pv=new ts,mv=q.camera;Y.camPitch=mv.pitch,Tg(Jd.camDist??mv.distance),Kp().then(()=>{lm(Y.worldSeed);let e=Y.bench?jd(Y.worldSeed^24301):void 0;pg(e),Zg(e),Y.bench&&gv()}).catch(e=>console.error(`the valley could not be built:`,e)),Cm(),xm(),P_(),Hm(),tg(Fd),Ym(qm.CRAWL_TOGGLE,()=>{Y.state===`play`&&(Y.crawling=!Y.crawling,Lh(Y.crawling),Yh(Y.crawling?`Crawling. Slower, and harder to hear.`:`Standing.`,1.6))}),Ym(qm.JUMP,()=>{Y.state!==`play`||Y.airborne||Y.crawling||(Y.airborne=!0,Y.vy=q.player.jumpSpeed,Y.airY=vf(Z.position.x,Z.position.z),Rh(!0),navigator.vibrate&&navigator.vibrate(12))}),Ym(qm.WHISTLE,()=>{if(Y.state!==`play`||Y.whistleCd>0)return;let e=q.wanderers;Y.whistleT=e.whistleSeconds,Y.whistleCd=e.whistleCooldown,Yh(`You whistle. It carries.`,1.8),navigator.vibrate&&navigator.vibrate([15,40,15])}),new URLSearchParams(location.search).has(`tune`)&&fv(()=>import(`./tuner-HjAEwGW9.js`).then(e=>e.initTuner()),[],import.meta.url).catch(e=>console.error(`tuner failed to load:`,e));function hv(){if(!Jd.wishes.length)return;let e=Math.min(...Jd.wishes.map(e=>e.cycle)),t=Jd.wishes.filter(t=>t.cycle===e),n=t[Math.random()*t.length|0];$h(z_(n.text,Jd.cycles-n.cycle))}J(`startBtn`).addEventListener(`click`,()=>{J(`start`).classList.add(`hidden`),Y.state=`play`,setTimeout(hv,2200)});function gv(){J(`start`).classList.add(`hidden`),Y.state=`play`;let e=q.bench;Z.position.set(e.x,vf(e.x,e.z),e.z),Y.camYaw=e.yaw,Y.camPitch=e.pitch,Y.camDist=e.distance,Y.night=Y.nightTarget=e.night}function _v(){let e=q.bench;Z.position.x=e.x,Z.position.z=e.z,Y.camYaw=e.yaw,Y.camPitch=e.pitch,Y.camDist=e.distance,Y.night=Y.nightTarget=e.night}var vv=!0;document.addEventListener(`visibilitychange`,()=>{document.hidden?vv=!1:vv||(vv=!0,pv.update(),requestAnimationFrame(yv))});function yv(){if(!vv)return;requestAnimationFrame(yv),pv.update();let e=Math.min(pv.getDelta(),q.loop.maxDelta);Y.t+=e;let t=_g.x,n=_g.y;if(Y.bench&&(_v(),t=n=0),!Y.bench&&(yg.w||yg.arrowup)&&(n=-1),!Y.bench&&(yg.s||yg.arrowdown)&&(n=1),!Y.bench&&(yg.a||yg.arrowleft)&&(t=-1),!Y.bench&&(yg.d||yg.arrowright)&&(t=1),!Y.bench&&yg.q&&(Y.camYaw+=mv.turnSpeed*e),!Y.bench&&yg.e&&(Y.camYaw-=mv.turnSpeed*e),!Y.bench&&(yg.r||yg.f)){let t=+!!yg.f-!!yg.r;Y.camPitch=Math.max(mv.pitchMin,Math.min(mv.pitchMax,Y.camPitch+t*mv.pitchKeySpeed*e))}let r=Kd(),i=-r.z,a=r.x;$_(e),iv(e,t,n,r,i,a),ev(e,hv),cv(e),N_(e),g_(e),Xh(e),u_(e,r.x,r.z,i,a),Gm()}yv(),window.addEventListener(`resize`,()=>{Fd.setSize(innerWidth,innerHeight),Km(innerWidth,innerHeight),zd.aspect=innerWidth/innerHeight,zd.updateProjectionMatrix()});export{q as t};