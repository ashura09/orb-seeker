...
void main() {
	...
	if ( coord.x >= 1.0 ) {
		...
		}`},ph=class extends th{constructor(){super(),this.isOutputPass=!0,this.uniforms=rs.clone(fh.uniforms),this.material=new ss({name:fh.name,uniforms:this.uniforms,vertexShader:fh.vertexShader,fragmentShader:fh.fragmentShader}),this._fsQuad=new ih(this.material),this._outputColorSpace=null,this._toneMapping=null}render(e,t,n){this.uniforms.tDiffuse.value=n.texture,this.uniforms.toneMappingExposure.value=e.toneMappingExposure,(this._outputColorSpace!==e.outputColorSpace||this._toneMapping!==e.toneMapping)&&(this._outputColorSpace=e.outputColorSpace,this._toneMapping=e.toneMapping,this.material.defines={},V.getTransfer(this._outputColorSpace)===`srgb`&&(this.material.defines.SRGB_TRANSFER=``),this._toneMapping===1?this.material.defines.LINEAR_TONE_MAPPING=``:this._toneMapping===2?this.material.defines.REINHARD_TONE_MAPPING=``:this._toneMapping===3?this.material.defines.CINEON_TONE_MAPPING=``:this._toneMapping===4?this.material.defines.ACES_FILMIC_TONE_MAPPING=``:this._toneMapping===6?this.material.defines.AGX_TONE_MAPPING=``:this._toneMapping===7?this.material.defines.NEUTRAL_TONE_MAPPING=``:this._toneMapping===5&&(this.material.defines.CUSTOM_TONE_MAPPING=``),this.material.needsUpdate=!0),this.renderToScreen===!0?(e.setRenderTarget(null),this._fsQuad.render(e)):(e.setRenderTarget(t),this.clear&&e.clear(e.autoClearColor,e.autoClearDepth,e.autoClearStencil),this._fsQuad.render(e))}dispose(){this.material.dispose(),this._fsQuad.dispose()}},mh=null;function hh(){if(!q.bloom.enabled)return!1;mh=new ch(ef),mh.addPass(new lh(tf,af));let e=new dh(new R(innerWidth,innerHeight),q.bloom.strength,q.bloom.radius,q.bloom.threshold);return mh.addPass(e),mh.addPass(new ph),ef.info.autoReset=!1,!0}function gh(){mh?(ef.info.reset(),mh.render()):ef.render(tf,af)}function _h(e,t){mh&&mh.setSize(e,t)}var Z=new kn,vh=new kn;vh.position.y=.3,Z.add(vh);var yh=2829660,bh=5975171,xh=lf(yh),Sh=lf(8015659),Ch=lf(14264440),wh=new W(new Oa(.34,.4,.85,10),xh);wh.position.y=.55;var Th=new W(new Zo(.36,.06,8,18),lf(14701885));Th.rotation.x=Math.PI/2,Th.position.y=.42;var Eh=new W(new Xo(.34,16,12),Sh);Eh.position.y=1.32;var Dh=new W(new Xo(.36,16,12,0,Math.PI*2,0,Math.PI*.62),xh);Dh.position.y=1.33;var Oh=new W(new Xo(.24,12,10),Ch);Oh.scale.set(1,.85,.6),Oh.position.set(0,1.26,.22);var kh=new W(new Xo(.14,10,8),Ch);kh.position.set(0,1.19,.36);var Ah=new Xo(.045,8,8),jh=lf(1776151),Mh=new W(Ah,jh),Nh=new W(Ah,jh);Mh.position.set(-.09,1.31,.42),Nh.position.set(.09,1.31,.42);var Ph=new Xo(.11,10,8),Fh=new W(Ph,Sh),Ih=new W(Ph,Sh);Fh.position.set(-.36,1.36,.02),Ih.position.set(.36,1.36,.02);var Lh=new W(new Zo(.35,.035,6,20),lf(14701885));Lh.rotation.x=Math.PI/2,Lh.position.y=1.44;var Rh=new W(new Ea(.08,.45,.03),lf(14701885));Rh.position.set(.12,1.2,-.36),Rh.rotation.z=.3;var zh=new Oa(.08,.09,.6,8),Bh=new W(zh,xh),Vh=new W(zh,xh);Bh.position.set(-.42,.6,0),Vh.position.set(.42,.6,0);var Hh=new Xo(.09,8,8),Uh=new W(Hh,Sh),Wh=new W(Hh,Sh);Uh.position.set(-.42,.28,0),Wh.position.set(.42,.28,0);var Gh=[];for(let e=0;e<6;e++){let t=new W(new Xo(.075-e*.006,8,6),Sh);vh.add(t),Gh.push(t)}vh.add(wh,Th,Eh,Dh,Oh,kh,Mh,Nh,Fh,Ih,Lh,Rh,Bh,Vh,Uh,Wh);function Kh(e){let t=new kn;t.position.set(e*.15,.46,0);let n=new W(new Oa(.1,.11,.44,8),xh);n.position.y=-.22;let r=new W(new Ea(.17,.1,.28),Sh);return r.position.set(0,-.44,.05),t.add(n,r),Z.add(t),t}var qh=Kh(-1),Jh=Kh(1);Z.traverse(e=>{e.isMesh&&(e.castShadow=!0,e.receiveShadow=!0)}),tf.add(Z);function Yh(e){vh.position.y=e?.02:.3,vh.rotation.x=e?1.15:0,qh.rotation.z=e?-.35:0,Jh.rotation.z=e?.35:0}var Xh={};function Zh(){if(Xh.built)return;Xh.built=!0;let e=new kn,t=new W(new Oa(.62,.62,.04,16),lf(14268522));t.position.y=1.62;let n=new W(new ka(.42,.32,16),lf(13609301));n.position.y=1.78,e.add(t,n),vh.add(e),Xh.hat=e;let r=new kn,i=new W(new Oa(.1,.12,.22,8),lf(13214042)),a=new W(new Xo(.07,8,8),uf(16769126)),o=df(16765562,0,9);o.position.y=.3,r.add(i,a,o),r.position.set(.55,.22,.12),vh.add(r),Xh.lantern=r,Xh.lanternLight=o;let s=new W(new Zo(.55,.03,6,30),uf(13214042));s.rotation.x=Math.PI/2,s.position.y=.5,vh.add(s),Xh.charm=s}function Qh(){Zh(),xh.color.set(Cf(`cloak`)?bh:yh),Xh.hat.visible=Cf(`hat`),Xh.lantern.visible=Cf(`lantern`),Xh.charm.visible=Cf(`charm`)}yf(_f.LOADOUT_CHANGED,Qh);var $h=J(`pouch`),eg=J(`fragCount`);function tg(){eg.textContent=mf.fragments}function ng(e){e.classList.remove(`bump`),e.offsetWidth,e.classList.add(`bump`)}function rg(e){mf.fragments+=e,hf(),tg(),ng($h)}tg();var ig=J(`toast`),ag=0;function og(e,t=2.2){ig.classList.remove(`echo`),ig.textContent=e,ig.style.opacity=1,ag=t}function sg(e){ag>0&&(ag-=e,ag<=0&&(ig.style.opacity=0))}var cg=document.createElement(`span`);cg.id=`orderTag`,cg.className=`none`,J(`counter`).appendChild(cg);function lg(e,t){if(t===0){cg.className=`none`,cg.textContent=``;return}cg.className=e?`kept`:`broken`,cg.textContent=e?`in order`:`order broken`}function ug(e,t=5){og(e,t),ig.classList.add(`echo`)}var dg=e=>e+([`th`,`st`,`nd`,`rd`][(e%100-20)%10]||[`th`,`st`,`nd`,`rd`][e%100]||`th`);function fg(e){if(!new URLSearchParams(location.search).has(`stats`))return;let t=document.createElement(`div`);t.id=`stats`,document.body.appendChild(t);let n=0,r=performance.now(),i=999;(function a(){requestAnimationFrame(a),n++;let o=performance.now();if(o-r>=500){let a=Math.round(n*1e3/(o-r));a<i&&(i=a),n=0,r=o;let s=e.info.render;t.textContent=`${a} fps (low ${i})  ${s.calls} calls  ${(s.triangles/1e3).toFixed(1)}k tris`}})()}var pg=[16739179,16755021,16769126,9234842,6740456,7639036,14317554],mg=new Xo(.55,18,14),hg=[],gg=q.orbs.litAtOnce,_g=[];for(let e=0;e<gg;e++){let e=df(16777215,0,q.orbs.lightRange);e.visible=!1,tf.add(e),_g.push(e)}function vg(){let e=hg.filter(e=>!e.found).map(e=>({o:e,d:Math.hypot(e.x-Z.position.x,e.z-Z.position.z)})).sort((e,t)=>e.d-t.d).slice(0,gg);_g.forEach((t,n)=>{let r=e[n];r&&r.d<q.orbs.lightCutoff?(t.visible=!0,t.color.setHex(r.o.color),t.intensity=q.orbs.lightIntensity,t.position.set(r.o.x,r.o.mesh.position.y,r.o.z)):(t.visible=!1,t.intensity=0)})}for(let e=0;e<7;e++){let t=pg[e],n=new W(mg,lf(t,.6));n.add(new W(new Xo(.9,14,10),uf(t,.18)));let r=document.createElement(`canvas`);r.width=r.height=128;let i=r.getContext(`2d`);i.fillStyle=`#f6efdf`,i.beginPath(),i.arc(64,64,54,0,Math.PI*2),i.fill(),i.lineWidth=8,i.strokeStyle=Qd(t),i.stroke(),i.fillStyle=`#1b1a17`,i.font=`bold 72px Trebuchet MS, sans-serif`,i.textAlign=`center`,i.textBaseline=`middle`,i.fillText(String(e+1),64,68);let a=new Qr(new Rr({map:new Sa(r),transparent:!0}));a.position.y=1.35,a.scale.setScalar(.8),n.add(a),hg.push({x:0,z:0,mesh:n,color:t,found:!1,phase:Math.random()*6,n:e+1})}var yg=J(`counter`),bg=hg.map(e=>{let t=document.createElement(`i`);return t.textContent=e.n,t.style.setProperty(`--c`,Qd(e.color)),yg.appendChild(t),t});function xg(){Y.found=0,Y.orderKept=!0;let e=q.orbs,t=e.outerRadius-e.innerRadius,n=[],r=0;for(;n.length<7&&r++<4e3;){let r=Math.random()*Math.PI*2,i=e.innerRadius+Math.random()*t,a=Math.cos(r)*i,o=Math.sin(r)*i;Math.hypot(a-Z.position.x,o-Z.position.z)<e.minDistanceFromPlayer||n.every(t=>Math.hypot(t.x-a,t.z-o)>=e.minSpacing)&&n.push({x:a,z:o})}for(;n.length<7;){let r=Math.random()*Math.PI*2,i=e.innerRadius+Math.random()*t;n.push({x:Math.cos(r)*i,z:Math.sin(r)*i})}for(let e=n.length-1;e>0;e--){let t=Math.random()*(e+1)|0;[n[e],n[t]]=[n[t],n[e]]}hg.forEach((e,t)=>{e.x=n[t].x,e.z=n[t].z,e.found=!1,e.mesh.position.set(e.x,hm(e.x,e.z)+1.1,e.z),tf.add(e.mesh),bg[t].classList.remove(`on`)}),lg(!0,0)}xg();function Sg(e){e.n!==Y.found+1&&Y.orderKept?(Y.orderKept=!1,og(`Order broken at ${e.n}. One wish.`)):Y.found<6&&og(Y.orderKept?`Orb ${e.n} found, in order. ${Y.found+1} of 7`:`Orb ${e.n} found. ${Y.found+1} of 7`),e.found=!0,Y.found++,tf.remove(e.mesh),bg[hg.indexOf(e)].classList.add(`on`),navigator.vibrate&&navigator.vibrate(40),lg(Y.orderKept,Y.found),Y.found===7&&(og(Y.orderKept?`All seven, in perfect order`:`All seven gathered`),xf(_f.ORBS_ALL_FOUND))}var Cg=J(`stick`),wg=J(`knob`),Tg={active:!1,id:null,cx:0,cy:0,x:0,y:0},Eg={active:!1,id:null,lastX:0,lastY:0},Dg={},Og=55,kg=new Map,Ag={active:!1,candidate:!1,a:null,b:null,gap0:0,gap:0,dist0:0},jg=(e,t)=>Math.hypot(e.x-t.x,e.y-t.y),Mg=()=>Tg.active?Math.hypot(Tg.x,Tg.y):0;function Ng(e){let t=q.camera;Y.camDist=Math.max(t.minDistance,Math.min(t.maxDistance,e))}var Pg=0;function Fg(){clearTimeout(Pg),Pg=setTimeout(()=>{mf.camDist=Y.camDist,hf()},250)}function Ig(){Tg.active=!1,Tg.x=Tg.y=0,Cg.style.display=`none`}function Lg(){if(Ag.active||Ag.candidate)return;let e=[...kg.keys()];e.length<2||(Ag.candidate=!0,[Ag.a,Ag.b]=e,Ag.gap0=jg(kg.get(Ag.a),kg.get(Ag.b)))}function Rg(e){Ag.active=!0,Ag.candidate=!1,Ig(),Eg.active=!1,Ag.gap=e,Ag.dist0=Y.camDist}function zg(){let e=Ag.active;Ag.active=Ag.candidate=!1,Ag.a=Ag.b=null,e&&Fg();let t=[...kg.keys()];if(e&&t.length===1){let e=kg.get(t[0]);Eg.active=!0,Eg.id=t[0],Eg.lastX=e.x,Eg.lastY=e.y}}function Bg(e){kg.set(e.identifier,{x:e.clientX,y:e.clientY}),Lg(),e.clientX<innerWidth*.5&&!Tg.active?(Tg.active=!0,Tg.id=e.identifier,Tg.cx=e.clientX,Tg.cy=e.clientY,Tg.x=Tg.y=0,Cg.style.display=`block`,Cg.style.left=Tg.cx+`px`,Cg.style.top=Tg.cy+`px`,wg.style.transform=`translate(-50%,-50%)`):Eg.active||(Eg.active=!0,Eg.id=e.identifier,Eg.lastX=e.clientX,Eg.lastY=e.clientY)}function Vg(e){let t=kg.get(e.identifier);if(t&&(t.x=e.clientX,t.y=e.clientY),(Ag.active||Ag.candidate)&&(e.identifier===Ag.a||e.identifier===Ag.b)){let e=kg.get(Ag.a),t=kg.get(Ag.b);if(e&&t){let n=jg(e,t);if(Ag.candidate){let e=q.camera;Math.abs(n-Ag.gap0)>e.pinchThreshold&&Mg()<e.pinchJoyTolerance&&Rg(n)}if(Ag.active){n>1&&Ng(Ag.dist0*(Ag.gap/n));return}}}if(Tg.active&&e.identifier===Tg.id){let t=e.clientX-Tg.cx,n=e.clientY-Tg.cy,r=Math.hypot(t,n);r>Og&&(t*=Og/r,n*=Og/r),Tg.x=t/Og,Tg.y=n/Og,wg.style.transform=`translate(calc(-50% + ${t}px), calc(-50% + ${n}px))`}else if(Eg.active&&e.identifier===Eg.id){let t=q.camera;Y.camYaw-=(e.clientX-Eg.lastX)*t.dragSensitivity;let n=(e.clientY-Eg.lastY)*t.dragSensitivityY*(t.invertY?-1:1);Y.camPitch=Math.max(t.pitchMin,Math.min(t.pitchMax,Y.camPitch+n)),Eg.lastX=e.clientX,Eg.lastY=e.clientY}}function Hg(e){kg.delete(e.identifier),(Ag.active||Ag.candidate)&&(e.identifier===Ag.a||e.identifier===Ag.b)&&zg(),Tg.active&&e.identifier===Tg.id&&(Tg.active=!1,Tg.x=Tg.y=0,Cg.style.display=`none`),Eg.active&&e.identifier===Eg.id&&(Eg.active=!1)}$d.addEventListener(`touchstart`,e=>{e.preventDefault();for(let t of e.changedTouches)Bg(t)},{passive:!1}),$d.addEventListener(`touchmove`,e=>{e.preventDefault();for(let t of e.changedTouches)Vg(t)},{passive:!1}),$d.addEventListener(`touchend`,e=>{for(let t of e.changedTouches)Hg(t)}),$d.addEventListener(`touchcancel`,e=>{for(let t of e.changedTouches)Hg(t)}),$d.addEventListener(`wheel`,e=>{e.preventDefault(),Ng(Y.camDist*Math.exp(e.deltaY*q.camera.wheelStep)),Fg()},{passive:!1}),$d.addEventListener(`mousedown`,e=>Bg({clientX:e.clientX,clientY:e.clientY,identifier:`m`})),window.addEventListener(`mousemove`,e=>Vg({clientX:e.clientX,clientY:e.clientY,identifier:`m`})),window.addEventListener(`mouseup`,()=>Hg({identifier:`m`})),window.addEventListener(`keydown`,e=>{let t=e.key.toLowerCase();e.repeat||(t===`c`&&xf(_f.CRAWL_TOGGLE),t===`v`&&xf(_f.WHISTLE)),Dg[t]=!0}),window.addEventListener(`keyup`,e=>Dg[e.key.toLowerCase()]=!1);var Ug=[{name:`Bram the Woodcutter`,short:`Bram`,color:7048739,hat:5913886,skin:14264440,build:1.1,headwear:`cap`,prop:`axe`},{name:`Nell the Herbalist`,short:`Nell`,color:10181046,hat:16183263,skin:15845797,build:.92,headwear:`kerchief`,prop:`basket`},{name:`Pip the Courier`,short:`Pip`,color:4034505,hat:14701885,skin:15252368,build:.85,headwear:`cap`,prop:`satchel`},{name:`Marla Stonehand`,short:`Marla`,color:9071162,hat:8359053,skin:13209443,build:1.18,headwear:`none`,prop:`hammer`},{name:`Old Tarrow`,short:`Tarrow`,color:8359053,hat:1776151,skin:14465172,build:.95,headwear:`brim`,prop:`staff`,beard:!0},{name:`Sable the Fencer`,short:`Sable`,color:1776151,hat:13214042,skin:14264440,build:1,headwear:`none`,prop:`blade`},{name:`The Grey Pilgrim`,short:`the Pilgrim`,color:14277081,hat:2829660,skin:13607034,build:1.05,headwear:`hood`,prop:`staff`}],Wg={torso:new Oa(.3,.38,.8,10),head:new Xo(.28,14,12),arm:new Oa(.075,.085,.55,7),hand:new Xo(.085,7,6),leg:new Oa(.095,.105,.42,7),foot:new Ea(.16,.09,.26),eye:new Xo(.035,6,6),cap:new ka(.34,.3,8),brim:new Oa(.46,.46,.035,12),crown:new ka(.3,.34,10),hood:new Xo(.33,14,12,0,Math.PI*2,0,Math.PI*.6),kerchief:new Xo(.3,12,10,0,Math.PI*2,0,Math.PI*.45),handle:new Oa(.035,.035,.9,6),staff:new Oa(.04,.045,1.7,6),axeHead:new Ea(.07,.26,.3),hammer:new Ea(.2,.2,.3),blade:new Ea(.045,.95,.1),bag:new Ea(.3,.26,.16),basket:new Oa(.19,.15,.22,9),beard:new ka(.17,.34,8)},Gg=lf(1776151),Kg=lf(7031338),qg=lf(10134443),Jg=lf(13214042),Yg=lf(13609301),Xg=lf(4866104),Zg=lf(15263976),Qg=lf(9071162),$g=lf(5913886),e_=lf(4034373);function t_(e){let t=new kn,n=lf(e.color),r=lf(e.skin),i=lf(e.hat),a=e.build,o=new W(Wg.torso,n);o.position.y=.86*a,o.scale.setScalar(a);let s=new W(Wg.head,r);if(s.position.y=1.48*a,t.add(o,s),[-1,1].forEach(e=>{let n=new W(Wg.eye,Gg);n.position.set(e*.1*a,1.52*a,.245*a),t.add(n)}),e.beard){let e=new W(Wg.beard,Zg);e.position.set(0,1.3*a,.16*a),e.rotation.x=Math.PI,t.add(e)}let c={arms:[],legs:[]};if([-1,1].forEach(e=>{let i=new kn;i.position.set(e*.38*a,1.16*a,0);let o=new W(Wg.arm,n);o.position.y=-.27;let s=new W(Wg.hand,r);s.position.y=-.56,i.add(o,s),t.add(i),c.arms.push(i);let l=new kn;l.position.set(e*.15*a,.46*a,0);let u=new W(Wg.leg,Xg);u.position.y=-.21;let d=new W(Wg.foot,Kg);d.position.set(0,-.42,.05),l.add(u,d),t.add(l),c.legs.push(l)}),e.headwear===`cap`){let e=new W(Wg.cap,i);e.position.y=1.72*a,t.add(e)}else if(e.headwear===`brim`){let e=new W(Wg.brim,i);e.position.y=1.66*a;let n=new W(Wg.crown,i);n.position.y=1.82*a,t.add(e,n)}else if(e.headwear===`hood`){let e=new W(Wg.hood,i);e.position.y=1.5*a,t.add(e)}else if(e.headwear===`kerchief`){let e=new W(Wg.kerchief,i);e.position.y=1.5*a,t.add(e)}let l=.38*a,u=.72*a,d=.12;if(e.prop===`axe`){let e=new W(Wg.handle,Kg);e.position.set(l,u,d),e.rotation.z=.25;let n=new W(Wg.axeHead,qg);n.position.set(l+.16,u+.42,d),t.add(e,n)}else if(e.prop===`hammer`){let e=new W(Wg.handle,Kg);e.position.set(l,u,d),e.rotation.z=.2;let n=new W(Wg.hammer,qg);n.position.set(l+.13,u+.44,d),t.add(e,n)}else if(e.prop===`blade`){let e=new W(Wg.blade,qg);e.position.set(l,u+.35,d),e.rotation.z=.12;let n=new W(Wg.hand,Jg);n.position.set(l,u-.1,d),t.add(e,n)}else if(e.prop===`staff`){let e=new W(Wg.staff,Kg);e.position.set(l,u+.36,d),e.rotation.z=.06,t.add(e)}else if(e.prop===`satchel`){let e=new W(Wg.bag,Qg);e.position.set(-.34*a,.8*a,.1),e.rotation.z=-.15;let n=new W(Wg.handle,$g);n.position.set(-.1*a,1.15*a,.05),n.rotation.z=Math.PI/2.6,t.add(e,n)}else if(e.prop===`basket`){let e=new W(Wg.basket,Yg);e.position.set(l,u,.1);let n=new W(Wg.hand,e_);n.position.set(l,u+.14,.1),n.scale.set(1.6,.7,1.6),t.add(e,n)}return t.traverse(e=>{e.isMesh&&(e.castShadow=!0,e.receiveShadow=!0)}),tf.add(t),{g:t,limbs:c}}var n_=Ug.map((e,t)=>{let{g:n,limbs:r}=t_(e);return{...e,g:n,limbs:r,tier:t+1,hx:0,hz:0,tx:0,tz:0,wait:0,cooldown:0,bob:Math.random()*6}}),r_=e=>q.duel.opponentBase+e*q.duel.opponentPerTier;function i_(){n_.forEach((e,t)=>{e.hx=hg[t].x,e.hz=hg[t].z;let n=q.wanderers,r=Math.random()*Math.PI*2,i=n.campRadiusMin+Math.random()*(n.campRadiusMax-n.campRadiusMin),a=e.hx+Math.cos(r)*i,o=e.hz+Math.sin(r)*i;e.g.position.set(a,hm(a,o),o),a_(e)})}function a_(e){let t=q.wanderers,n=Math.random()*Math.PI*2,r=Math.random()*t.roamRadius;e.tx=Math.max(-Xp+5,Math.min(Xp-5,e.hx+Math.cos(n)*r)),e.tz=Math.max(-Xp+5,Math.min(Xp-5,e.hz+Math.sin(n)*r)),e.wait=t.waitMin+Math.random()*(t.waitMax-t.waitMin)}i_();function o_(e,t){let n=t?Math.sin(e.bob):0;e.limbs.arms[0].rotation.x=n*.55,e.limbs.arms[1].rotation.x=-n*.55,e.limbs.legs[0].rotation.x=-n*.5,e.limbs.legs[1].rotation.x=n*.5}function s_(e){let t=q.wanderers,n=Cf(`bell`)?t.hearingWithBell:t.hearingRange;Y.crawling&&(n*=t.crawlHearingMultiplier),Y.whistleT>0&&(n=Math.max(n,t.whistleRange));for(let r of n_){r.cooldown=Math.max(0,r.cooldown-e);let i=Z.position.x-r.g.position.x,a=Z.position.z-r.g.position.z,o=Math.hypot(i,a),s=o<n&&r.cooldown===0&&!Y.ceremony;s&&(r.tx=Z.position.x,r.tz=Z.position.z,r.wait=0);let c=r.tx-r.g.position.x,l=r.tz-r.g.position.z,u=Math.hypot(c,l);if(u>.5){let n=s?t.huntSpeed:t.roamSpeed;r.g.position.x+=c/u*n*e,r.g.position.z+=l/u*n*e,r.g.rotation.y=Math.atan2(c,l),r.bob+=e*t.bobRate,r.g.position.y=hm(r.g.position.x,r.g.position.z)+Math.abs(Math.sin(r.bob))*.1,o_(r,!0)}else r.g.position.y=hm(r.g.position.x,r.g.position.z),r.wait-=e,r.wait<=0&&a_(r),o_(r,!1);Y.state===`play`&&s&&o<t.challengeRange&&xf(_f.DUEL_CHALLENGE,r)}}var c_={Bram:{challenge:`One orb. That is all I ever carried out of this valley. Let us see if your arms are better than mine were.`,theyWin:`Ha! Still in me somewhere. Go on — the rest of them are worse than me.`,theyLose:`Quick hands. I wish I had had them when it counted.`},Nell:{challenge:`The second is mine. Not that I wanted the others — there are better things growing out here than wishes.`,theyWin:`Patience beats hurry. Ask the moss, it has been here longer.`,theyLose:`Off you go, then. Mind the nettles down by the water.`},Pip:{challenge:`Third! Third, and I would have had the lot, only I grabbed them out of order like a fool. Come on, quickly.`,theyWin:`Too slow! Everyone is always too slow.`,theyLose:`Fine. You are quick. Do not be quick about the order, though. That is how you end up camped by the third.`},Marla:{challenge:`Four. Halfway, near enough. You will not rush me.`,theyWin:`Hands like stone. I did say.`,theyLose:`Hm. Good. Take it.`},Tarrow:{challenge:`The fifth. I have watched a great many people walk past me, and rather fewer walk back. Let us see which you are.`,theyWin:`No shame in it. I have lost at this spot more times than you have stood on it.`,theyLose:`Go on, then. And when it asks you — think before you speak.`},Sable:{challenge:`Six. Twice I stood here, and twice I turned around. You will do no better.`,theyWin:`As I thought. The sixth keeps its own.`,theyLose:`Again? Then go. Go and see what is past it, and come back and tell me.`},"the Pilgrim":{challenge:`I have been where you are going.`,theyWin:`Then you are not ready. Good.`,theyLose:`Go. Ask carefully.`}},l_={challenge:`A duel, then. Ten seconds.`,theyWin:`Better luck further out.`,theyLose:`Well fought.`};function u_(e){return c_[e]||l_}function d_(e,t){return t?e===0?`Seven orbs, gathered in perfect order. It has been a long while since anyone managed that. Speak three wishes.`:e<3?`In order again. You have the patience this valley asks for. Three wishes, then.`:e<7?`You keep returning, and you keep them in order. I know your step by now. Three wishes.`:`Again, and in order. I have granted you a great deal, seeker. Three wishes.`:e===0?`You have gathered all seven. They were not in order, and so there is one wish. Speak it.`:e<3?`All seven, though hurried. One wish.`:`Hurried again. You know what the order is worth, and still you rush. One wish.`}function f_(e,t){let n=`“${e}”`;return t<=0?`You asked for ${n} not long ago.`:t===1?`One gathering ago you asked for ${n}.`:`${t} gatherings ago you asked for ${n}.`}var p_=J(`duel`),m_=q.duel,Q={w:null,you:0,them:0,time:m_.seconds,ready:m_.countdown,waiting:!0,over:!1};function h_(e){Y.state=`duel`,Q.w=e,Q.you=0,Q.them=0,Q.time=m_.seconds,Q.ready=m_.countdown,Q.waiting=!0,Q.over=!1,Tg.active=!1,Tg.x=Tg.y=0,Cg.style.display=`none`;let t=[`a gentle`,`an easy`,`a steady`,`a quick`,`a fast`,`a fierce`,`a blistering`][e.tier-1];J(`duelWho`).textContent=`“${u_(e.short).challenge}”`,J(`duelRules`).textContent=`${e.name} keeps camp by orb ${e.tier}, so expect ${t} pace. Ten seconds: tap to fill your bar before theirs.`,J(`resultSay`).textContent=``,J(`themName`).textContent=e.short,J(`duelPlay`).style.display=`block`,J(`duelResult`).style.display=`none`,J(`duelStart`).style.display=`inline-block`,J(`tapzone`).style.display=`none`,J(`tapzone`).textContent=`Get ready…`,g_(),p_.classList.remove(`hidden`),navigator.vibrate&&navigator.vibrate(30)}J(`duelStart`).addEventListener(`click`,()=>{Q.waiting=!1,J(`duelStart`).style.display=`none`,J(`tapzone`).style.display=`flex`});function g_(){J(`timer`).textContent=Q.waiting?m_.seconds.toFixed(1):Q.ready>0?String(Math.ceil(Q.ready)):Math.max(0,Q.time).toFixed(1);let e=Math.min(100,Q.you*100),t=Math.min(100,Q.them*100);J(`youBar`).style.width=e+`%`,J(`youPct`).textContent=Math.round(e)+`%`,J(`themBar`).style.width=t+`%`,J(`themPct`).textContent=Math.round(t)+`%`}function __(){Y.state!==`duel`||Q.over||Q.waiting||Q.ready>0||(Q.you+=Cf(`grip`)?m_.tapValueWithGrip:m_.tapValue,navigator.vibrate&&navigator.vibrate(8),g_(),Q.you>=1&&y_(!0))}J(`tapzone`).addEventListener(`touchstart`,e=>{e.preventDefault(),__()},{passive:!1}),J(`tapzone`).addEventListener(`mousedown`,__),window.addEventListener(`keydown`,e=>{e.code===`Space`&&__()});function v_(e){if(!(Q.over||Q.waiting)){if(Q.ready>0){Q.ready-=e,Q.ready<=0&&(J(`tapzone`).textContent=`Tap!`,navigator.vibrate&&navigator.vibrate(25)),g_();return}Q.time-=e,Q.them+=e*r_(Q.w.tier),g_(),Q.them>=1?y_(!1):Q.time<=0&&y_(Q.you>Q.them)}}function y_(e){Q.over=!0;let t,n=Q.w.short;if(e){mf.wins++;let e=Math.random(),r=m_.lootBase+Q.w.tier+Math.floor(Math.random()*m_.lootVariance),i=e<m_.flawlessChance;t=i?r*m_.flawlessMultiplier:r,J(`resultBig`).textContent=i?`Flawless!`:`You win`,J(`resultSay`).textContent=`“${u_(Q.w.short).theyLose}”`,J(`resultLoot`).textContent=`${n} hands over ${t} fragments.`,navigator.vibrate&&navigator.vibrate([40,40,80])}else t=m_.consolation,J(`resultBig`).textContent=`Outpaced`,J(`resultSay`).textContent=`“${u_(Q.w.short).theyWin}”`,J(`resultLoot`).textContent=`${n} wins, but tosses you ${t} fragment for the effort.`;rg(t),Q.w.cooldown=q.wanderers.cooldown,a_(Q.w),setTimeout(()=>{J(`duelPlay`).style.display=`none`,J(`duelResult`).style.display=`block`},m_.resultDelay)}J(`duelDone`).addEventListener(`click`,()=>{p_.classList.add(`hidden`),Y.state=`play`}),yf(_f.DUEL_CHALLENGE,h_);function b_(e){return Zd.find(t=>t.id===e)}function x_(){let e=J(`shopItems`);e.innerHTML=``;for(let t of Zd){let n=document.createElement(`div`);n.className=`item`;let r=document.createElement(`div`);r.className=`row`;let i=document.createElement(`div`);i.className=`swatch`,i.style.background=Qd(t.color);let a=document.createElement(`div`);a.innerHTML=`<div class="name">${t.name}</div><div class="desc">${t.desc}</div>`,r.append(i,a),n.appendChild(r);let o=mf.items[t.id];if(o){let e=document.createElement(`span`);e.className=`owned`,e.textContent=o===`owned`?`Kept`:`Set down for you`,n.appendChild(e)}else{let e=document.createElement(`button`);e.textContent=`${t.cost} ◆`,e.disabled=mf.fragments<t.cost,e.addEventListener(`click`,()=>{mf.fragments-=t.cost,mf.items[t.id]=`bought`,hf(),tg(),x_(),xf(_f.ITEM_BOUGHT,t.id),og(`${t.name} set down beside you`)}),n.appendChild(e)}e.appendChild(n)}}$h.addEventListener(`click`,()=>{Y.state===`play`&&(Y.state=`shop`,x_(),J(`shop`).classList.remove(`hidden`))}),J(`shopClose`).addEventListener(`click`,()=>{J(`shop`).classList.add(`hidden`),Y.state=`play`});var S_=[];function C_(e,t,n){let r=new kn;if(e===`item`){let n=b_(t),i=new W(new Ea(.7,.45,.5),lf(9071162)),a=new W(new Ea(.74,.18,.54),lf(n.color,.35));a.position.y=.32;let o=new W(new Ea(.12,.14,.06),lf(13214042));o.position.set(0,.22,.28),r.add(i,a,o,df(n.color,.9,6)),r.userData={kind:e,id:t}}else{let n=new W(new Ko(.42,0),lf(16771504,.9));n.add(new W(new Xo(.7,12,10),uf(16773320,.2))),n.add(df(16771504,1.2,8)),r.add(n),r.userData={kind:e,text:t}}let i=n===void 0?Math.random()*Math.PI*2:n,a=Z.position.x+Math.cos(i)*3.2,o=Z.position.z+Math.sin(i)*3.2;r.position.set(a,hm(a,o)+.7,o),tf.add(r),S_.push({g:r,kind:e,phase:Math.random()*6})}function w_(e,t){if(tf.remove(e.g),S_.splice(t,1),e.kind===`item`){let t=e.g.userData.id;mf.items[t]=`owned`,hf();let n=kf(t);Qh(),og(n?`${b_(t).name} — worn`:`${b_(t).name} added. No room to wear it; open your satchel.`,n?2:3)}else mf.wishes.push({text:e.g.userData.text,cycle:mf.cycles}),hf(),og(`Wish kept: “${e.g.userData.text}”`,3);ng(J(`satchelBtn`)),navigator.vibrate&&navigator.vibrate([30,30,60]),Y.ceremony&&!S_.some(e=>e.kind===`wish`)&&xf(_f.WISHES_ALL_COLLECTED)}function T_(){let e=J(`satchelWishes`);e.innerHTML=``,mf.wishes.length||(e.innerHTML=`<div class="empty">No wishes yet. Gather the seven orbs.</div>`),mf.wishes.forEach(t=>{let n=document.createElement(`div`);n.className=`wishrow`,n.innerHTML=`<span class="star">✦</span><div><div>“${t.text.replace(/</g,`&lt;`)}”</div><div class="meta">Granted on your ${dg(t.cycle)} gathering</div></div>`,e.appendChild(n)});let t=J(`satchelItems`);t.innerHTML=``;let n=Zd.filter(e=>gf(e.id));n.length||(t.innerHTML=`<div class="empty">Nothing yet. Win duels and visit the trader.</div>`);let r=Sf();if(n.length&&r>0){let e=document.createElement(`div`);e.className=`slotline`,e.textContent=`Worn ${Tf()} of ${r}`,t.appendChild(e)}n.forEach(e=>{let n=Cf(e.id),r=document.createElement(`div`);r.className=`item`+(n?` isworn`:``),r.innerHTML=`<div class="row"><div class="swatch" style="background:${Qd(e.color)}"></div><div><div class="name">${e.name}</div><div class="desc">${e.desc}</div></div></div>`;let i=document.createElement(`button`);i.textContent=n?`Take off`:`Wear`,i.addEventListener(`click`,()=>{let t=Of(e.id);if(!t.ok){og(t.reason,3);return}T_(),ng(J(`satchelBtn`))}),r.appendChild(i),t.appendChild(r)})}yf(_f.ITEM_BOUGHT,e=>C_(`item`,e)),J(`satchelBtn`).addEventListener(`click`,()=>{Y.state===`play`&&(Y.state=`satchel`,T_(),J(`satchel`).classList.remove(`hidden`))}),J(`satchelClose`).addEventListener(`click`,()=>{J(`satchel`).classList.add(`hidden`),Y.state=`play`});var $=J(`rc`).getContext(`2d`),E_=J(`dist`),D_=0;function O_(e,t,n,r,i){let a=q.finder,o=Cf(`lens`)?a.rangeWithLens:a.range,s=a.revealDistance;D_+=e*a.sweepSpeed,$.clearRect(0,0,256,256),$.strokeStyle=`rgba(143,245,200,0.25)`,$.lineWidth=2,[.33,.66,1].forEach(e=>{$.beginPath(),$.arc(128,128,118*e,0,Math.PI*2),$.stroke()}),$.beginPath(),$.moveTo(128,10),$.lineTo(128,246),$.moveTo(10,128),$.lineTo(246,128),$.stroke(),$.save(),$.translate(128,128),$.rotate(D_);let c=$.createLinearGradient(0,0,118,0);c.addColorStop(0,`rgba(143,245,200,0.35)`),c.addColorStop(1,`rgba(143,245,200,0)`),$.fillStyle=c,$.beginPath(),$.moveTo(0,0),$.arc(0,0,118,-.9,0),$.closePath(),$.fill(),$.restore();let l=(e,a)=>{let s=e-Z.position.x,c=a-Z.position.z;return[(s*r+c*i)/o*118,-(s*t+c*n)/o*118,Math.hypot(s,c)]},u=1/0;for(let e of hg){if(e.found)continue;let[t,n,r]=l(e.x,e.z);u=Math.min(u,r);let i=Math.hypot(t,n),a=i<=118,o=r<=s;a||(t*=112/i,n*=112/i),$.fillStyle=o?Qd(e.color):`#f6efdf`,$.globalAlpha=a?.75+.25*Math.sin(performance.now()/250+e.phase):.4,$.beginPath(),$.arc(128+t,128+n,o?10:a?7:5,0,Math.PI*2),$.fill(),o&&($.fillStyle=`#1b1a17`,$.font=`bold 13px Trebuchet MS, sans-serif`,$.textAlign=`center`,$.textBaseline=`middle`,$.fillText(e.n,128+t,128+n+1)),$.globalAlpha=1}$.strokeStyle=`#f6efdf`,$.lineWidth=2.5;for(let e of n_){let[t,n,r]=l(e.g.position.x,e.g.position.z);Math.hypot(t,n)>110||($.globalAlpha=e.cooldown>0?.35:.9,$.strokeStyle=`#f6efdf`,$.beginPath(),$.moveTo(128+t,128+n-8),$.lineTo(128+t+8,128+n),$.lineTo(128+t,128+n+8),$.lineTo(128+t-8,128+n),$.closePath(),$.stroke(),r<=s&&($.fillStyle=`#f6efdf`,$.font=`bold 10px Trebuchet MS, sans-serif`,$.textAlign=`center`,$.textBaseline=`middle`,$.fillText(e.tier,128+t,128+n+1)),$.globalAlpha=1)}$.fillStyle=`#ffe9b0`;for(let e of S_){let[t,n]=l(e.g.position.x,e.g.position.z);Math.hypot(t,n)>110||$.fillRect(128+t-4,128+n-4,8,8)}$.fillStyle=`#f6efdf`,$.beginPath(),$.moveTo(128,119),$.lineTo(135,135),$.lineTo(121,135),$.closePath(),$.fill(),E_.textContent=u===1/0?``:`Nearest orb: ${Math.round(u)} m`}var k_=new kn,A_={wings:[],tail:[],neck:[],eyes:[],sparks:null,ring:null,built:!1},j_=[];function M_(){if(A_.built)return;A_.built=!0;let e=lf(15852213,.25),t=lf(16774616,.3),n=lf(13214042,.6),r=lf(2761504),i=new W(new Xo(1,20,16),e);i.scale.set(2.3,1.9,3),i.position.set(0,6,-1),k_.add(i);let a=new W(new Xo(1,16,12),t);a.scale.set(1.7,1.3,2.6),a.position.set(0,5.4,-.6),k_.add(a);for(let e=0;e<5;e++){let t=new W(new ka(.35,.9-e*.1,4),n);t.position.set(0,7.9-e*.15,.6-e*.9),t.rotation.x=-.4,k_.add(t)}for(let t=0;t<5;t++){let n=new W(new Xo(1-t*.11,14,10),e);n.position.set(0,6.8+t*.85,1.6+t*.75),k_.add(n),A_.neck.push(n)}let o=new kn;o.position.set(0,10.6,5.2);let s=new W(new Xo(.9,18,14),e);s.scale.set(1,.85,1.25),o.add(s);let c=new W(new Ea(1,.6,1.3),e);c.position.set(0,-.15,1.2),o.add(c);let l=new W(new Ea(.85,.28,1.1),t);l.position.set(0,-.55,1.05),l.rotation.x=.18,o.add(l);let u=new W(new Ea(.5,.15,.2),r);u.position.set(0,.05,1.85),o.add(u),[-1,1].forEach(t=>{let i=new W(new Xo(.17,10,8),uf(9434568));i.position.set(t*.5,.2,.75),o.add(i),A_.eyes.push(i);let a=new W(new Ea(.45,.12,.3),r);a.position.set(t*.5,.45,.7),a.rotation.z=-t*.3,o.add(a);let s=new W(new Oa(.06,.16,1.8,6),n);s.position.set(t*.55,.9,-.6),s.rotation.set(-.9,0,-t*.35),o.add(s);let c=new W(new Oa(.04,.09,.9,6),n);c.position.set(t*.9,1.4,-.9),c.rotation.set(-.5,0,-t*.9),o.add(c);let l=new W(new ka(.35,.9,4),e);l.position.set(t*.95,-.1,-.2),l.rotation.set(0,0,t*Math.PI/2+t*.4),o.add(l)}),k_.add(o),A_.head=o;let d=new so;d.moveTo(0,0),d.lineTo(3.2,2.4),d.lineTo(6.4,2),d.lineTo(5.6,.2),d.lineTo(6.2,-2),d.lineTo(3.4,-1.4),d.lineTo(0,-1.2),d.lineTo(0,0);let f=new Jo(d),p=new cs({color:15126421,emissive:15126421,emissiveIntensity:.3,roughness:.6,metalness:0,transparent:!0,opacity:.85,side:2});[[-1,0,6.9,-.4],[1,0,6.9,-.4],[-1,.7,6.4,-2.6],[1,.7,6.4,-2.6]].forEach(([e,t,r,i],a)=>{let o=new kn;o.position.set(e*1.6,r,i);let s=new W(f,p);s.scale.set(e*(1-t*.35),1-t*.3,1),s.rotation.x=-Math.PI/2;let c=new W(new Oa(.06,.1,6.4,6),n);c.rotation.set(0,e*.3,Math.PI/2),c.position.set(e*3,.03,1.1),o.add(s,c),k_.add(o),A_.wings.push({pivot:o,s:e,phase:a<2?0:.6})}),[[-1.3,1.2],[1.3,1.2],[-1.4,-2.4],[1.4,-2.4]].forEach(([t,r])=>{let i=new W(new Oa(.28,.36,1.6,8),e);i.position.set(t,4.4,r),i.rotation.x=.35,k_.add(i);for(let e=-1;e<=1;e++){let i=new W(new ka(.09,.4,5),n);i.position.set(t+e*.2,3.5,r+.5),i.rotation.x=Math.PI*.75,k_.add(i)}});for(let n=0;n<8;n++){let r=new W(new Xo(.75-n*.08,12,8),n%2?t:e);k_.add(r),A_.tail.push(r)}let m=new W(new ka(.4,1.2,4),n);k_.add(m),A_.tailTip=m;let h=new W(new Zo(5.5,.08,6,80),uf(9434568,.6));h.rotation.x=Math.PI/2,h.position.y=.15,k_.add(h),A_.ring=h;let g=new Float32Array(540);for(let e=0;e<180;e++){let t=Math.random()*Math.PI*2,n=2+Math.random()*5;g[e*3]=Math.cos(t)*n,g[e*3+1]=Math.random()*13,g[e*3+2]=Math.sin(t)*n}let _=new Mr;_.setAttribute(`position`,new _r(g,3)),A_.sparks=new ya(_,new ma({color:16774084,size:.16,transparent:!0,opacity:.9})),k_.add(A_.sparks);let v=df(16771504,3.5,50);v.position.y=8,k_.add(v);let y=df(9434568,1.5,12);y.position.set(0,10,7),k_.add(y)}function N_(e){let t=Y.t;k_.position.y=Math.sin(t*1.1)*.35+.4,A_.wings.forEach(e=>{e.pivot.rotation.z=e.s*(.25+Math.sin(t*2.2+e.phase)*.45)}),A_.head.position.y=10.6+Math.sin(t*1.6)*.15,A_.head.rotation.x=Math.sin(t*.9)*.08,A_.neck.forEach((e,n)=>{e.position.x=Math.sin(t*1.6+n*.5)*.15*n/4}),A_.tail.forEach((e,n)=>{let r=n+1;e.position.set(Math.sin(t*1.5-r*.5)*.35*r*.5,6-r*.45+Math.sin(t*1.2-r*.4)*.2,-3.6-r*.75)});let n=A_.tail[7];A_.tailTip.position.set(n.position.x,n.position.y,n.position.z-.8),A_.tailTip.rotation.x=-Math.PI/2;let r=.7+.3*Math.sin(t*4);A_.eyes.forEach(e=>e.material.opacity=r),A_.eyes.forEach(e=>e.material.transparent=!0),A_.ring.rotation.z+=e*.4,A_.ring.scale.setScalar(1+Math.sin(t*2)*.03);let i=A_.sparks.geometry.attributes.position;for(let t=0;t<i.count;t++){let n=i.getY(t)+e*1.6;n>13&&(n=0),i.setY(t,n)}i.needsUpdate=!0}function P_(){Y.state=`ending`,Y.ceremony=!0,Y.endT=0,Y.nightTarget=1,Y.camPitch=q.camera.cinematicPitch,J(`hint`).style.opacity=0,hg.forEach((e,t)=>{let n=new W(mg,lf(e.color,.9));n.add(df(e.color,1.5,12)),tf.add(n),j_.push({m:n,i:t})}),M_();let e=ff(),t=Z.position.x+e.x*q.ceremony.keeperDistance,n=Z.position.z+e.z*q.ceremony.keeperDistance;k_.position.set(t,hm(t,n),n),k_.lookAt(Z.position.x,0,Z.position.z),k_.scale.setScalar(.001),tf.add(k_);let r=Y.orderKept?q.ceremony.wishesInOrder:q.ceremony.wishesOutOfOrder;J(`wishIntro`).textContent=d_(mf.cycles,Y.orderKept),J(`wishBtn`).textContent=r===1?`Make the wish`:`Make the wishes`,J(`wishAsk`).style.display=`block`,J(`wishDone`).style.display=`none`,J(`wishInputs`).innerHTML=``;for(let e=0;e<r;e++){let t=document.createElement(`input`);t.type=`text`,t.maxLength=80,t.autocomplete=`off`,t.placeholder=r===1?`I wish for…`:`Wish ${e+1}…`,t.className=`wishInput`,t.addEventListener(`keydown`,e=>{e.key===`Enter`&&I_()}),J(`wishInputs`).appendChild(t)}}var F_=[];function I_(){let e=[...document.querySelectorAll(`.wishInput`)].map(e=>e.value.trim()).filter(Boolean);F_=e.length?e:[`A wish kept secret`];let t=J(`wishEcho`);t.innerHTML=``,F_.forEach(e=>{let n=document.createElement(`div`);n.textContent=`“${e}”`,t.appendChild(n)}),J(`wishAsk`).style.display=`none`,J(`wishDone`).style.display=`block`,navigator.vibrate&&navigator.vibrate([40,60,40,60,120])}J(`wishBtn`).addEventListener(`click`,I_),J(`claimBtn`).addEventListener(`click`,()=>{J(`wish`).classList.add(`hidden`),Y.state=`play`;let e=Math.atan2(k_.position.z-Z.position.z,k_.position.x-Z.position.x);F_.forEach((t,n)=>C_(`wish`,t,e+(n-(F_.length-1)/2)*.5)),j_.forEach(({m:e})=>tf.remove(e)),j_.length=0,mf.cycles++,hf(),og(`Walk over the tokens to keep your wishes`,3)});function L_(){Y.departT=0,og(`The Keeper rises and the valley sleeps. The orbs will scatter again soon.`,3.5)}yf(_f.ORBS_ALL_FOUND,P_),yf(_f.WISHES_ALL_COLLECTED,L_);var R_=q.map,z_=Xp*2,B_=new Uint8Array(R_.grid*R_.grid),V_=e=>Math.floor((e+Xp)/z_*R_.grid),H_=0;function U_(e){if(H_+=e,H_<.25)return;H_=0;let t=V_(Z.position.x),n=V_(Z.position.z),r=Math.ceil(R_.seeRadius/z_*R_.grid);for(let e=n-r;e<=n+r;e++)if(!(e<0||e>=R_.grid))for(let i=t-r;i<=t+r;i++){if(i<0||i>=R_.grid)continue;let a=i-t,o=e-n;a*a+o*o<=r*r&&(B_[e*R_.grid+i]=1)}}function W_(){B_.fill(0)}var G_=null,K_=-1;function q_(){let e=R_.resolution,t=document.createElement(`canvas`);t.width=t.height=e;let n=t.getContext(`2d`),r=n.createImageData(e,e),i=[63,143,191];for(let t=0;t<e;t++)for(let n=0;n<e;n++){let a=n/(e-1)*z_-Xp,o=t/(e-1)*z_-Xp,s=(t*e+n)*4;if(Math.hypot(a,o)>Xp){r.data[s]=24,r.data[s+1]=30,r.data[s+2]=26,r.data[s+3]=255;continue}let c,l,u;if(Fm(a,o))[c,l,u]=i;else{let{region:e,neighbour:t,blend:n}=im(a,o),r=e.ground[0],i=t.ground[0];c=(r>>16&255)*(1-n)+(i>>16&255)*n,l=(r>>8&255)*(1-n)+(i>>8&255)*n,u=(r&255)*(1-n)+(i&255)*n}let d=z_/e,f=lm(a+d,o)-lm(a-d,o)+(lm(a,o+d)-lm(a,o-d)),p=Math.max(.55,Math.min(1.45,1+f*.16));r.data[s]=Math.min(255,c*p),r.data[s+1]=Math.min(255,l*p),r.data[s+2]=Math.min(255,u*p),r.data[s+3]=255}n.putImageData(r,0,0),G_=t,K_=$p}var J_=J(`mapc`),Y_=J_.getContext(`2d`),X_=document.createElement(`canvas`);X_.width=X_.height=R_.grid;var Z_=X_.getContext(`2d`);function Q_(){(!G_||K_!==$p)&&q_();let e=J_.width;Y_.clearRect(0,0,e,e),Y_.imageSmoothingEnabled=!0,Y_.drawImage(G_,0,0,e,e);let t=Z_.createImageData(R_.grid,R_.grid);for(let e=0;e<B_.length;e++)t.data[e*4+3]=B_[e]?0:238;Z_.putImageData(t,0,0),Y_.drawImage(X_,0,0,e,e);let n=(t,n)=>[(t+Xp)/z_*e,(n+Xp)/z_*e],r=(e,t)=>{let n=V_(e),r=V_(t);return n>=0&&r>=0&&n<R_.grid&&r<R_.grid&&B_[r*R_.grid+n]};Y_.font=`bold 13px Trebuchet MS, sans-serif`,Y_.textAlign=`center`;for(let e of Qp){if(!r(e.x,e.z))continue;let[t,i]=n(e.x,e.z);Y_.fillStyle=`rgba(27,26,23,0.75)`,Y_.beginPath(),Y_.arc(t,i,5,0,Math.PI*2),Y_.fill(),Y_.fillStyle=`#f6efdf`,Y_.fillText(e.name,t,i-10)}for(let e of hg){if(!e.found)continue;let[t,r]=n(e.x,e.z);Y_.fillStyle=Qd(e.color),Y_.beginPath(),Y_.arc(t,r,6,0,Math.PI*2),Y_.fill(),Y_.fillStyle=`#1b1a17`,Y_.fillText(e.n,t,r+4)}let[i,a]=n(Z.position.x,Z.position.z);Y_.save(),Y_.translate(i,a),Y_.rotate(-Y.camYaw),Y_.fillStyle=`#8ff5c8`,Y_.beginPath(),Y_.moveTo(0,-9),Y_.lineTo(6,7),Y_.lineTo(0,3),Y_.lineTo(-6,7),Y_.closePath(),Y_.fill(),Y_.restore()}var $_=J(`map`);function ev(){Y.state===`play`&&(Y.state=`map`,$_.classList.remove(`hidden`),requestAnimationFrame(()=>requestAnimationFrame(Q_)))}function tv(){$_.classList.add(`hidden`),Y.state===`map`&&(Y.state=`play`)}J(`finder`).addEventListener(`click`,ev),J(`mapClose`).addEventListener(`click`,tv),window.addEventListener(`keydown`,e=>{e.repeat||e.key.toLowerCase()===`m`&&(Y.state===`map`?tv():ev())});var nv=`modulepreload`,rv=function(e,t){return new URL(e,t).href},iv={},av=function(e,t,n){let r=Promise.resolve();if(t&&t.length>0){let e=document.getElementsByTagName(`link`),i=document.querySelector(`meta[property=csp-nonce]`),a=i?.nonce||i?.getAttribute(`nonce`);function o(e){return Promise.all(e.map(e=>Promise.resolve(e).then(e=>({status:`fulfilled`,value:e}),e=>({status:`rejected`,reason:e}))))}function s(e){return import.meta.resolve?import.meta.resolve(e):new URL(e,import.meta.url).href}r=o(t.map(t=>{if(t=rv(t,n),t=s(t),t in iv)return;iv[t]=!0;let r=t.endsWith(`.css`);for(let n=e.length-1;n>=0;n--){let i=e[n];if(i.href===t&&(!r||i.rel===`stylesheet`))return}let i=document.createElement(`link`);if(i.rel=r?`stylesheet`:nv,r||(i.as=`script`),i.crossOrigin=``,i.href=t,a&&i.setAttribute(`nonce`,a),document.head.appendChild(i),r)return new Promise((e,n)=>{i.addEventListener(`load`,e),i.addEventListener(`error`,()=>n(Error(`Unable to preload CSS for ${t}`)))})}))}function i(e){let t=new Event(`vite:preloadError`,{cancelable:!0});if(t.payload=e,window.dispatchEvent(t),!t.defaultPrevented)throw e}return r.then(t=>{for(let e of t||[])e.status===`rejected`&&i(e.reason);return e().catch(i)})};for(let e in mf.items)mf.items[e]===`bought`&&C_(`item`,e);Qh();var ov=new _c,sv=new z,{player:cv,camera:lv,orbs:uv,ceremony:dv,dayNight:fv}=q;Y.camPitch=lv.pitch,Ng(mf.camDist??lv.distance);var pv=0;Yp().then(()=>{Lm(Y.worldSeed),xg(),i_()}).catch(e=>console.error(`the valley could not be built:`,e)),Zm(),Ym(),hh(),fg(ef),yf(_f.CRAWL_TOGGLE,()=>{Y.state===`play`&&(Y.crawling=!Y.crawling,Yh(Y.crawling),og(Y.crawling?`Crawling. Slower, and harder to hear.`:`Standing.`,1.6))}),yf(_f.WHISTLE,()=>{if(Y.state!==`play`||Y.whistleCd>0)return;let e=q.wanderers;Y.whistleT=e.whistleSeconds,Y.whistleCd=e.whistleCooldown,og(`You whistle. It carries.`,1.8),navigator.vibrate&&navigator.vibrate([15,40,15])}),new URLSearchParams(location.search).has(`tune`)&&av(()=>import(`./tuner-DF2bW4Bj.js`).then(e=>e.initTuner()),[],import.meta.url).catch(e=>console.error(`tuner failed to load:`,e));function mv(){if(!mf.wishes.length)return;let e=Math.min(...mf.wishes.map(e=>e.cycle)),t=mf.wishes.filter(t=>t.cycle===e),n=t[Math.random()*t.length|0];ug(f_(n.text,mf.cycles-n.cycle))}J(`startBtn`).addEventListener(`click`,()=>{J(`start`).classList.add(`hidden`),Y.state=`play`,setTimeout(mv,2200)});function hv(e,t,n,r,i){let a=Z.position.x,o=Z.position.z,s=n;for(let c of Zp){if(c.r<lv.blockRadius)continue;let l=c.x-a,u=c.z-o,d=l*e+u*t;if(d<=.5||d-c.r>s)continue;let f=c.r+lv.clearance,p=Math.abs(l*t-u*e);if(p>=f)continue;let m=n>.01?d/n:0;r+(i-r)*m>c.top+lv.overClearance||(s=Math.min(s,d-Math.sqrt(f*f-p*p)))}return Math.max(Math.min(lv.minClear,n),s)}function gv(){requestAnimationFrame(gv),ov.update();let e=Math.min(ov.getDelta(),q.loop.maxDelta);Y.t+=e;let t=Tg.x,n=Tg.y;if((Dg.w||Dg.arrowup)&&(n=-1),(Dg.s||Dg.arrowdown)&&(n=1),(Dg.a||Dg.arrowleft)&&(t=-1),(Dg.d||Dg.arrowright)&&(t=1),Dg.q&&(Y.camYaw+=lv.turnSpeed*e),Dg.e&&(Y.camYaw-=lv.turnSpeed*e),Dg.r||Dg.f){let t=+!!Dg.f-!!Dg.r;Y.camPitch=Math.max(lv.pitchMin,Math.min(lv.pitchMax,Y.camPitch+t*lv.pitchKeySpeed*e))}let r=ff(),i=-r.z,a=r.x,o=Y.night;if(Y.night+=(Y.nightTarget-Y.night)*Math.min(1,e*fv.easeRate),(Math.abs(Y.night-o)>.001||Y.t<.2)&&Jm(Y.night),tf.fog.color.copy(nf).lerp(rf,Y.night),$m(Y.night),Xh.lantern?.visible&&(Xh.lanternLight.intensity=fv.lanternBase+Y.night*fv.lanternNightBoost),Qm(Z.position.x,Z.position.y,Z.position.z),Y.whistleT>0&&(Y.whistleT=Math.max(0,Y.whistleT-e)),Y.whistleCd>0&&(Y.whistleCd=Math.max(0,Y.whistleCd-e)),Y.state===`play`){let o=Math.hypot(t,n),s=!1;if(o>.08){let c=Fm(Z.position.x,Z.position.z),l=Math.min(o,1)*(Cf(`boots`)?cv.bootsMultiplier:1)*(Y.crawling?cv.crawlSpeedMultiplier:1)*(c?q.water.wadeSpeed:1),u=r.x*-n+i*t,d=r.z*-n+a*t,f=Math.hypot(u,d)||1;Z.position.x+=u/f*cv.speed*l*e,Z.position.z+=d/f*cv.speed*l*e,Z.rotation.y=Math.atan2(u,d),pv+=e*cv.bobRate*l,s=!0}let c=Math.hypot(Z.position.x,Z.position.z);c>Xp&&(Z.position.x*=Xp/c,Z.position.z*=Xp/c);for(let e of Zp){let t=Z.position.x-e.x,n=Z.position.z-e.z,r=Math.hypot(t,n),i=e.r+cv.radius;r<i&&r>1e-4&&(Z.position.x=e.x+t/r*i,Z.position.z=e.z+n/r*i)}Z.position.y=hm(Z.position.x,Z.position.z)+Math.abs(Math.sin(pv))*cv.bobHeight,Bh.rotation.x=s?Math.sin(pv)*.6:0,Vh.rotation.x=s?-Math.sin(pv)*.6:0,Uh.position.z=Math.sin(Bh.rotation.x)*.3,Wh.position.z=Math.sin(Vh.rotation.x)*.3,qh.rotation.x=s?-Math.sin(pv)*.5:0,Jh.rotation.x=s?Math.sin(pv)*.5:0;for(let t of hg)t.found||(t.mesh.position.y=hm(t.x,t.z)+1.1+Math.sin(Y.t*2+t.phase)*.25,t.mesh.rotation.y+=e,Math.hypot(t.x-Z.position.x,t.z-Z.position.z)<uv.pickupRadius&&Sg(t));for(let t=S_.length-1;t>=0;t--){let n=S_[t];n.g.position.y=hm(n.g.position.x,n.g.position.z)+.7+Math.sin(Y.t*2.5+n.phase)*.15,n.g.rotation.y+=e*1.2,Math.hypot(n.g.position.x-Z.position.x,n.g.position.z-Z.position.z)<1.5&&w_(n,t)}s_(e)}if(vg(),Gh.forEach((e,t)=>{let n=t+1;e.position.set(Math.sin(Y.t*3-n*.6)*.06*n,.35+n*.06+Math.sin(Y.t*2+n)*.02,-.38-n*.09)}),Xh.charm&&(Xh.charm.rotation.z+=e*1.5),Y.state===`duel`){v_(e);let t=Q.w,n=t.g.position.x-Z.position.x,r=t.g.position.z-Z.position.z;Z.rotation.y=Math.atan2(n,r),t.g.rotation.y=Math.atan2(-n,-r),t.g.position.y=Q.over?0:Math.abs(Math.sin(Y.t*14))*.08}if(Y.state===`ending`){Y.endT+=e;let t=Math.min(Y.endT/dv.riseSeconds,1);if(j_.forEach(({m:e,i:n})=>{let r=n/7*Math.PI*2+Y.endT*1.2;e.position.set(Z.position.x+Math.cos(r)*(1.5+2*t),1.5+5*t+Math.sin(Y.endT*3+n)*.2,Z.position.z+Math.sin(r)*(1.5+2*t))}),Y.endT>dv.keeperGrowDelay&&k_.scale.setScalar(.001+Math.min((Y.endT-dv.keeperGrowDelay)/dv.keeperGrowSeconds,1)),Y.endT>dv.wishPromptAt){Y.state=`wish`,J(`wish`).classList.remove(`hidden`);let e=document.querySelector(`.wishInput`);e&&e.focus()}}if(Y.state===`wish`&&j_.forEach(({m:e,i:t})=>{let n=t/7*Math.PI*2+Y.t*1.2;e.position.set(Z.position.x+Math.cos(n)*3.5,6.5+Math.sin(Y.t*3+t)*.2,Z.position.z+Math.sin(n)*3.5)}),Y.ceremony&&A_.built&&N_(e),Y.departT>=0){Y.departT+=e;let t=Math.min(Y.departT/dv.departSeconds,1);k_.position.y+=e*6*t,k_.scale.setScalar(1-t*.9),Y.departT>=dv.departSeconds&&(tf.remove(k_),Y.departT=-1,Y.ceremony=!1,Y.nightTarget=0,Y.respawnT=dv.respawnSeconds,J(`hint`).style.opacity=.75)}Y.respawnT>0&&(Y.respawnT-=e,Y.respawnT<=0&&(Y.respawnT=-1,Y.worldSeed=Xd(),Lm(Y.worldSeed),W_(),xg(),i_(),og(`The valley has shifted, and the seven orbs are scattered again`,3.5),setTimeout(mv,3600)));let s=Y.state===`ending`||Y.state===`wish`,c=s?lv.cinematicDistance:Y.camDist,l=Y.camPitch,u=s?lv.cinematicLookAt:lv.lookAtHeight,d=Math.min(1,e*lv.ease),f=Math.cos(l)*c,p=hm(Z.position.x,Z.position.z),m=Math.sin(Y.camYaw),h=Math.cos(Y.camYaw),g=p+u,_=hv(m,h,f,g,g+Math.sin(l)*c),v=f>.01?_/f:1,y=Z.position.x+m*_,b=Z.position.z+h*_,x=hm(y,b),S=p+u+Math.sin(l)*c*v,C=Math.max(S,x+lv.minHeight),w=u+Math.max(0,-l)*c*lv.lookUpGain;af.position.x+=(y-af.position.x)*d,af.position.z+=(b-af.position.z)*d,af.position.y+=(C-af.position.y)*d,sv.set(Z.position.x,p+w,Z.position.z),af.lookAt(sv),U_(e),sg(e),O_(e,r.x,r.z,i,a),gh()}gv(),window.addEventListener(`resize`,()=>{ef.setSize(innerWidth,innerHeight),_h(innerWidth,innerHeight),af.aspect=innerWidth/innerHeight,af.updateProjectionMatrix()});export{q as t};